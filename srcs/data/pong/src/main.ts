...
document.querySelector<HTMLDivElement>('#app')!.innerHTML = `
  <div class="max-w-[1280px] mx-auto p-8 text-center font-sans text-[rgba(255,255,255,0.87)] dark:text-[rgba(255,255,255,0.87)] bg-white dark:bg-[#242424] min-h-screen flex flex-col items-center justify-center">
