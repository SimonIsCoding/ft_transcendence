var Ue=Object.defineProperty;var Ne=(t,e,n)=>e in t?Ue(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var l=(t,e,n)=>Ne(t,typeof e!="symbol"?e+"":e,n);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function n(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(i){if(i.ep)return;i.ep=!0;const o=n(i);fetch(i.href,o)}})();const qe=.02;class de{constructor(e){l(this,"paddleElem");l(this,"_position",50);this.paddleElem=e,this.reset()}get position(){return this._position}set position(e){this._position=e,this.updatePosition()}updatePosition(){const e=2+this._position*.96;this.paddleElem.style.top=`${e}vh`}rect(){return this.paddleElem.getBoundingClientRect()}reset(){this.position=50}update(e,n){this.position+=qe*e*(n-this.position);const s=5;this.position=Math.max(s,Math.min(100-s,this.position))}highlight(){this.paddleElem.style.backgroundColor="#EDD24E",setTimeout(()=>{this.paddleElem.style.backgroundColor="#D9D9D9"},150)}}const ce=.055,ze=1.1,We=.1;class Ye{constructor(e){l(this,"ballElem");l(this,"direction",{x:0,y:0});l(this,"velocity",ce);l(this,"_x",50);l(this,"_y",50);this.ballElem=e,this.reset()}get x(){return this._x}set x(e){this._x=e,this.updatePosition()}get y(){return this._y}set y(e){this._y=e,this.updatePosition()}updatePosition(){const e=(this._x-50)*.88,n=(this._y-50)*.96;this.ballElem.style.transform=`translate(${e}vw, ${n}vh)`}get directionX(){return this.direction.x}get directionY(){return this.direction.y}get ballVelocity(){return this.velocity}rect(){return this.ballElem.getBoundingClientRect()}reset(){for(this.x=50,this.y=50,this.direction={x:0,y:0};Math.abs(this.direction.x)<=.3||Math.abs(this.direction.x)>=.8;){const e=Ze(0,2*Math.PI);this.direction={x:Math.cos(e),y:Math.sin(e)}}this.velocity=ce}bounceVertical(){this.direction.y*=-1,this.direction.y<0?this.direction.y-=.1:this.direction.y+=.1}update(e,n,s){const i=[n.rect(),s.rect()];this.x+=this.direction.x*this.velocity*e,this.y+=this.direction.y*this.velocity*e;const o=this.rect(),a=window.innerHeight*.02,r=window.innerHeight*.98;(o.bottom>=r||o.top<=a)&&this.bounceVertical(),i.forEach(d=>{if(Xe(d,o)){const h=o.top+o.height/2,u=d.top+d.height/2,p=d.height,b=(h-(u-p/2))/p,x=Math.max(0,Math.min(1,b)),E=Math.PI/3,P=(x-.5)*2*E,L=Math.sqrt(this.direction.x*this.direction.x+this.direction.y*this.direction.y);d.left<window.innerWidth/2?(n.highlight(),this.direction.x=Math.cos(P)*L,this.direction.y=Math.sin(P)*L):(s.highlight(),this.direction.x=-Math.cos(P)*L,this.direction.y=Math.sin(P)*L);const B=Math.sqrt(this.direction.x*this.direction.x+this.direction.y*this.direction.y);this.direction.x/=B,this.direction.y/=B,this.velocity=Math.min(this.velocity*ze,We)}})}}function Ze(t,e){return Math.random()*(e-t)+t}function Xe(t,e){return t.left<=e.right&&t.right>=e.left&&t.top<=e.bottom&&t.bottom>=e.top}class c{}l(c,"MAX_SCORE",5),l(c,"PADDLE_SPEED",.08),l(c,"FRAME_RATE_LIMIT",8.33),l(c,"AI_UPDATE_COOLDOWN",1e3),l(c,"AI_TARGET_THRESHOLD",2),l(c,"AI_MOVEMENT_THRESHOLD",1),l(c,"AI_MAX_SIMULATION_STEPS",10),l(c,"GAME_AREA_TOP_PERCENT",2),l(c,"GAME_AREA_BOTTOM_PERCENT",98),l(c,"PADDLE_BOUNDARY_TOP",4),l(c,"PADDLE_BOUNDARY_BOTTOM",92),l(c,"SIDEBAR_WIDTH",64),l(c,"RIGHT_MARGIN_VW",.02),l(c,"PADDLE_X_OFFSET",30),l(c,"BALL_SCALING_FACTOR",.0088),l(c,"DEFAULT_LEFT_PLAYER","Erik"),l(c,"DEFAULT_RIGHT_PLAYER","Simon");var V=(t=>(t.MOVE_LEFT_UP="w",t.MOVE_LEFT_DOWN="s",t.MOVE_RIGHT_UP="ArrowUp",t.MOVE_RIGHT_DOWN="ArrowDown",t.PAUSE=" ",t))(V||{});class Je{constructor(e){l(this,"keys",{w:!1,s:!1,ArrowUp:!1,ArrowDown:!1," ":!1});l(this,"onPauseToggle");this.onPauseToggle=e,this.setupEventListeners()}setupEventListeners(){document.addEventListener("keydown",e=>{var s;const n=this.getKeyFromEvent(e);n&&(n===" "&&!this.keys[" "]&&((s=this.onPauseToggle)==null||s.call(this)),this.keys[n]=!0)}),document.addEventListener("keyup",e=>{const n=this.getKeyFromEvent(e);n&&(this.keys[n]=!1)})}getKeyFromEvent(e){const n=e.key.toLowerCase();return n==="w"||n==="s"?n:e.key==="ArrowUp"||e.key==="ArrowDown"?e.key:e.key===" "?" ":null}isPressed(e){return this.keys[e]}getKeyState(){return{...this.keys}}}var D=(t=>(t.LEFT="left",t.RIGHT="right",t))(D||{});class Ke{constructor(){l(this,"leftAI",{target:50,lastUpdate:0,isEnabled:!0});l(this,"rightAI",{target:50,lastUpdate:0,isEnabled:!0})}enableAI(e){e==="left"?this.leftAI.isEnabled=!0:this.rightAI.isEnabled=!0}disableAI(e){(e==="left"||!e)&&(this.leftAI.isEnabled=!1),(e==="right"||!e)&&(this.rightAI.isEnabled=!1)}isEnabled(e){return e==="left"?this.leftAI.isEnabled:this.rightAI.isEnabled}getTarget(e){return e==="left"?this.leftAI.target:this.rightAI.target}updateAI(e,n){const s=e.directionX;if(this.leftAI.isEnabled&&s<0&&n-this.leftAI.lastUpdate>=c.AI_UPDATE_COOLDOWN){const i=this.predictBallLanding(e,"left");Math.abs(i-this.leftAI.target)>c.AI_TARGET_THRESHOLD&&(this.leftAI.target=i,this.leftAI.lastUpdate=n)}if(this.rightAI.isEnabled&&s>0&&n-this.rightAI.lastUpdate>=c.AI_UPDATE_COOLDOWN){const i=this.predictBallLanding(e,"right");Math.abs(i-this.rightAI.target)>c.AI_TARGET_THRESHOLD&&(this.rightAI.target=i,this.rightAI.lastUpdate=n)}}predictBallLanding(e,n){const s=e.x*1e3,i=e.y*1e3,o=e.directionX*1e3,a=e.directionY*1e3,r=window.innerWidth-c.SIDEBAR_WIDTH-window.innerWidth*c.RIGHT_MARGIN_VW,d=c.PADDLE_X_OFFSET,h=r-c.PADDLE_X_OFFSET,u=r/2,p=window.innerWidth*c.BALL_SCALING_FACTOR,b=((d-u)/p+50)*1e3,x=((h-u)/p+50)*1e3,E=n==="left"?b:x;return n==="left"&&o>=0||n==="right"&&o<=0?50:this.simulateBallTrajectoryGeometric(s,i,o,a,E)/1e3}simulateBallTrajectoryGeometric(e,n,s,i,o){let a=e,r=n,d=s,h=i;const u=c.GAME_AREA_TOP_PERCENT*1e3,p=c.GAME_AREA_BOTTOM_PERCENT*1e3,b=c.PADDLE_BOUNDARY_TOP*1e3,x=c.PADDLE_BOUNDARY_BOTTOM*1e3;let E=0;for(;E<c.AI_MAX_SIMULATION_STEPS;){if(Math.abs(d)<1||(o-a)/d<=0)return Math.max(b,Math.min(x,r));const L=(o-a)*(h/d),B=r+L;if(B<u&&h<0){const y=u-r;a=a+y*(d/h),r=u,h*=-1,h<0?h-=100:h+=100}else if(B>p&&h>0){const y=p-r;a=a+y*(d/h),r=p,h*=-1,h<0?h-=100:h+=100}else return Math.max(b,Math.min(x,B));E++}return Math.max(b,Math.min(x,r))}}var Y=(t=>(t[t.CONTINUE=0]="CONTINUE",t[t.LEFT_WINS=1]="LEFT_WINS",t[t.RIGHT_WINS=2]="RIGHT_WINS",t[t.LEFT_SCORES=3]="LEFT_SCORES",t[t.RIGHT_SCORES=4]="RIGHT_SCORES",t))(Y||{});class Qe{constructor(e,n,s=c.MAX_SCORE){l(this,"leftPlayerScoreElem");l(this,"rightPlayerScoreElem");l(this,"scores",{left:0,right:0});l(this,"maxScore");this.leftPlayerScoreElem=e,this.rightPlayerScoreElem=n,this.maxScore=s,this.updateDisplay()}addScore(e){return e==="left"?this.scores.left++:this.scores.right++,this.updateDisplay(),this.scores.left>=this.maxScore?1:this.scores.right>=this.maxScore?2:e==="left"?3:4}reset(){this.scores={left:0,right:0},this.updateDisplay()}getScores(){return{...this.scores}}getScoreString(){return`${this.scores.left} - ${this.scores.right}`}updateDisplay(){this.leftPlayerScoreElem.textContent=this.scores.left.toString(),this.rightPlayerScoreElem.textContent=this.scores.right.toString()}}let k=class{constructor(e,n,s,i,o,a,r){l(this,"pauseOverlay");l(this,"pauseBtn");l(this,"playBtn");l(this,"gameArea");l(this,"leftPlayer");l(this,"rightPlayer");l(this,"onPauseToggle");this.pauseOverlay=e,this.pauseBtn=n,this.playBtn=s,this.gameArea=i,this.leftPlayer=o,this.rightPlayer=a,this.onPauseToggle=r,this.setupEventListeners()}setupEventListeners(){this.pauseBtn.addEventListener("click",()=>{var e;(e=this.onPauseToggle)==null||e.call(this)}),this.playBtn.addEventListener("click",()=>{var e;(e=this.onPauseToggle)==null||e.call(this)})}showPauseOverlay(){this.pauseOverlay.classList.remove("hidden"),this.gameArea.classList.add("blur-[9px]")}hidePauseOverlay(){this.pauseOverlay.classList.add("hidden"),this.gameArea.classList.remove("blur-[9px]")}setPlayerNames(e,n){this.leftPlayer.textContent=e,this.rightPlayer.textContent=n}static getElement(e){const n=document.getElementById(e);if(!n)throw new Error(`Required DOM element with id "${e}" not found`);return n}};class Ae{constructor(e){l(this,"options");l(this,"gameId");l(this,"isPaused",!1);l(this,"gameOn",!1);l(this,"lastTime");l(this,"isGameActive",!0);l(this,"animationFrameId",null);l(this,"ball");l(this,"leftPlayerPaddle");l(this,"rightPlayerPaddle");l(this,"inputManager");l(this,"aiManager");l(this,"scoreManager");l(this,"uiManager");l(this,"ballElement");l(this,"leftPaddleElement");l(this,"rightPaddleElement");l(this,"onFinishCallback");e!=null&&e.maxScore&&(c.MAX_SCORE=e.maxScore),e!=null&&e.aiDifficulty&&(c.AI_UPDATE_COOLDOWN=e.aiDifficulty),this.gameId=`game-${Date.now()}-${Math.random().toString(36).substr(2,9)}`,console.log(`🎮 Creating new Game instance: ${this.gameId}`),this.options={leftPlayer:(e==null?void 0:e.leftPlayer)||c.DEFAULT_LEFT_PLAYER,rightPlayer:(e==null?void 0:e.rightPlayer)||c.DEFAULT_RIGHT_PLAYER,maxScore:(e==null?void 0:e.maxScore)||c.MAX_SCORE,gameMode:(e==null?void 0:e.gameMode)||"p-vs-p",onFinish:(e==null?void 0:e.onFinish)||void 0,aiDifficulty:(e==null?void 0:e.aiDifficulty)||c.AI_UPDATE_COOLDOWN},this.onFinishCallback=(e==null?void 0:e.onFinish)||null,this.initializeDOM(),this.initializeManagers(),this.initializeGameObjects(),this.setupDebugFunctions()}initializeDOM(){this.ballElement=k.getElement("ball"),this.leftPaddleElement=k.getElement("left-paddle"),this.rightPaddleElement=k.getElement("right-paddle")}initializeManagers(){const e=k.getElement("left-score"),n=k.getElement("right-score"),s=k.getElement("left-player"),i=k.getElement("right-player"),o=k.getElement("pause-overlay"),a=k.getElement("pause-btn"),r=k.getElement("play-btn"),d=k.getElement("game-area");this.inputManager=new Je(()=>this.togglePause()),this.aiManager=new Ke,this.scoreManager=new Qe(e,n,this.options.maxScore),this.uiManager=new k(o,a,r,d,s,i,()=>this.togglePause()),this.configureGameMode(),this.uiManager.setPlayerNames(this.options.leftPlayer,this.options.rightPlayer)}configureGameMode(){switch(this.options.gameMode){case"p-vs-ai":this.options.rightPlayer="ChatGPT",this.options.leftPlayer=v.otherPlayer,this.aiManager.disableAI(D.LEFT);break;case"ai-vs-p":this.options.leftPlayer="Gemini",this.aiManager.disableAI(D.RIGHT);break;case"p-vs-p":this.aiManager.disableAI(D.LEFT),this.aiManager.disableAI(D.RIGHT);break;case"ai-vs-ai":this.options.leftPlayer="ChatGPT",this.options.rightPlayer="Gemini";break}}initializeGameObjects(){this.ball=new Ye(this.ballElement),this.leftPlayerPaddle=new de(this.leftPaddleElement),this.rightPlayerPaddle=new de(this.rightPaddleElement)}togglePause(){this.isPaused=!this.isPaused,this.isPaused?this.uiManager.showPauseOverlay():this.uiManager.hidePauseOverlay()}setGameOn(){this.gameOn=!0}enableAILeft(){this.aiManager.enableAI(D.LEFT)}enableAIRight(){this.aiManager.enableAI(D.RIGHT)}disableAI(){this.aiManager.disableAI()}resetGame(){this.scoreManager.reset(),this.leftPlayerPaddle.reset(),this.rightPlayerPaddle.reset(),this.ball.reset(),this.isPaused=!1,v.gameController=!1}stopGame(){console.log(`🛑 Stopping Game instance: ${this.gameId}`),this.isGameActive=!1,this.gameOn=!1,this.isPaused=!0,this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null,console.log(`🎬 Cancelled animation frame for Game: ${this.gameId}`)),this.lastTime=void 0,this.resetGame()}get gameAreaTop(){return c.GAME_AREA_TOP_PERCENT}get gameAreaBottom(){return c.GAME_AREA_BOTTOM_PERCENT}get getBall(){return this.ball}get getLeftPaddle(){return this.leftPlayerPaddle}get getRightPaddle(){return this.rightPlayerPaddle}setupDebugFunctions(){window.enableAILeft=()=>this.enableAILeft(),window.enableAIRight=()=>this.enableAIRight(),window.disableAI=()=>this.disableAI()}start(){console.log(`▶️ Starting Game instance: ${this.gameId}`);const e=n=>{if(!this.isGameActive||!v.noWinner||!this.gameOn){console.log(`⏹️ Game loop stopping for Game: ${this.gameId} (isActive: ${this.isGameActive}, noWinner: ${v.noWinner}, gameOn: ${this.gameOn})`),this.resetGame(),this.animationFrameId=null;return}if(this.lastTime!=null){const s=n-this.lastTime;if(s<c.FRAME_RATE_LIMIT){this.animationFrameId=window.requestAnimationFrame(e);return}this.isPaused||(this.ball.update(s,this.leftPlayerPaddle,this.rightPlayerPaddle),this.aiManager.updateAI(this.ball,n),this.updateLeftPlayerPaddle(s),this.updateRightPlayerPaddle(s),this.isLose()&&(console.log(`⚽ Ball lost in Game: ${this.gameId}`),this.handleLose()))}this.lastTime=n,this.animationFrameId=window.requestAnimationFrame(e)};this.animationFrameId=window.requestAnimationFrame(e)}updateLeftPlayerPaddle(e){if(this.aiManager.isEnabled(D.LEFT)){const n=this.leftPlayerPaddle.position,i=this.aiManager.getTarget(D.LEFT)-n;if(Math.abs(i)>c.AI_MOVEMENT_THRESHOLD){const o=i>0?1:-1,a=n+o*c.PADDLE_SPEED*e;this.leftPlayerPaddle.position=Math.max(c.PADDLE_BOUNDARY_TOP,Math.min(c.PADDLE_BOUNDARY_BOTTOM,a))}return}this.inputManager.isPressed(V.MOVE_LEFT_UP)?this.leftPlayerPaddle.position=Math.max(c.PADDLE_BOUNDARY_TOP,this.leftPlayerPaddle.position-c.PADDLE_SPEED*e):this.inputManager.isPressed(V.MOVE_LEFT_DOWN)&&(this.leftPlayerPaddle.position=Math.min(c.PADDLE_BOUNDARY_BOTTOM,this.leftPlayerPaddle.position+c.PADDLE_SPEED*e))}updateRightPlayerPaddle(e){if(this.aiManager.isEnabled(D.RIGHT)){const n=this.rightPlayerPaddle.position,i=this.aiManager.getTarget(D.RIGHT)-n;if(Math.abs(i)>c.AI_MOVEMENT_THRESHOLD){const o=i>0?1:-1,a=n+o*c.PADDLE_SPEED*e;this.rightPlayerPaddle.position=Math.max(c.PADDLE_BOUNDARY_TOP,Math.min(c.PADDLE_BOUNDARY_BOTTOM,a))}return}this.inputManager.isPressed(V.MOVE_RIGHT_UP)?this.rightPlayerPaddle.position=Math.max(c.PADDLE_BOUNDARY_TOP,this.rightPlayerPaddle.position-c.PADDLE_SPEED*e):this.inputManager.isPressed(V.MOVE_RIGHT_DOWN)&&(this.rightPlayerPaddle.position=Math.min(c.PADDLE_BOUNDARY_BOTTOM,this.rightPlayerPaddle.position+c.PADDLE_SPEED*e))}isLose(){const e=this.ball.rect(),n=c.SIDEBAR_WIDTH,s=window.innerWidth-window.innerWidth*c.RIGHT_MARGIN_VW;return e.right>=s||e.left<=n}handleLose(){const e=this.ball.rect(),n=window.innerWidth-window.innerWidth*c.RIGHT_MARGIN_VW;let s;if(e.right>=n?s=this.scoreManager.addScore("left"):s=this.scoreManager.addScore("right"),s===Y.LEFT_WINS||s===Y.RIGHT_WINS){this.isPaused=!0;const i=s===Y.LEFT_WINS?this.options.leftPlayer:this.options.rightPlayer;if(this.onFinishCallback){const o=this.scoreManager.getScores();this.isGameActive=!1,this.gameOn=!1,this.resetGame(),this.onFinishCallback(i,o.left,o.right)}}this.ball.reset()}}class U{render(){return`
  ...
  <div class="flex-1 h-screen flex flex-col" style="background-color: #EDD24E;">
    ...
    <div class="h-[2vh]" style="background-color: #EDD24E;"></div>
      ...
      `}}const et=()=>C.iaDifficulty==="Easy"?1e3:C.iaDifficulty==="Medium"?100:1,C={iaDifficulty:"Easy",scoreLimit:"5"};function tt(){const t=document.getElementById("iaDifficultySliderInput"),e=document.getElementById("iaDifficultyValue"),n=document.getElementById("scoreLimitSliderInput"),s=document.getElementById("scoreLimitValue");C.iaDifficulty=ge(parseInt(t.value)),e.textContent=C.iaDifficulty,C.scoreLimit=ue(parseInt(n.value)),s.textContent=C.scoreLimit,t.addEventListener("input",i=>{const o=parseInt(i.target.value);C.iaDifficulty=ge(o),e.textContent=C.iaDifficulty}),n.addEventListener("input",i=>{const o=parseInt(i.target.value);C.scoreLimit=ue(o),s.textContent=C.scoreLimit})}function ue(t){return t==1?"3":t==2?"5":"11"}function ge(t){return t==1?"Easy":t==2?"Medium":"Hard"}function nt(t){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t)}function K(t,e,n,s){const i=document.getElementById(t),o=document.getElementById(e),a=document.getElementById(n),r=document.getElementById(s);if(!i||!o||!r||!a)return;let d=!1;o.addEventListener("click",()=>{d=!d,i.type=d?"text":"password",r.classList.toggle("hidden",!d),a.classList.toggle("hidden",d)})}async function q(t,e=3500,n){const s=document.getElementById(n);s&&(s.classList.remove("bg-red-600"),s.classList.add("bg-green-600"),s.textContent=t,s.classList.remove("hidden"),setTimeout(()=>{s.classList.add("hidden")},e))}function m(t,e){const n=document.getElementById(e);n&&(n.classList.remove("bg-green-600"),n.classList.add("bg-red-600"),n.textContent=t,n.classList.remove("hidden"),setTimeout(()=>n.classList.add("hidden"),3500))}async function st(t){const e=new FormData;e.append("file",t);const n=await fetch("api/auth/uploadProfilePicture",{method:"POST",body:e,credentials:"include"}),s=await n.json();if(!n.ok||!s.success){console.error("Error on upload:",s),alert(`Error: ${s.error||"failed to store the picture."}`);return}}async function it(){return(await(await fetch("/api/auth/me",{credentials:"include"})).json()).user}async function ot(){const e=await(await fetch("/api/auth/me/status",{method:"GET",credentials:"include"})).json();return console.log("data.authenticated = ",e.authenticated),e.authenticated===!0}async function at(){const e=await(await fetch("/api/auth/me",{method:"GET",credentials:"include"})).json();z(e.user);const n=document.getElementById("profileName");n&&(n.textContent=e.user.login||"Profile Name");const s=document.getElementById("mailInProfileSubmenu");s&&(s.textContent=e.user.mail||"contact@mail.com");const i=document.getElementById("playerNameDashboard");i&&(i.textContent=e.user.login||"Username")}class rt{constructor(){l(this,"players",[]);l(this,"semifinal1",null);l(this,"semifinal2",null);l(this,"finalMatch",null);l(this,"winner",null)}addPlayer(e){this.players.push({alias:e})}isReady(){return this.players.length===4}generateMatches(){this.semifinal1={player1:{...this.players[0]},player2:{...this.players[1]},winner:null},this.semifinal2={player1:{...this.players[2]},player2:{...this.players[3]},winner:null}}generateFinal(){var e,n;(e=this.semifinal1)!=null&&e.winner&&((n=this.semifinal2)!=null&&n.winner)&&(this.finalMatch={player1:this.semifinal1.winner,player2:this.semifinal2.winner,winner:null})}setWinner(e){this.winner=e}saveToLocalStorage(){var n;const e=JSON.parse(localStorage.getItem("torneos")||"[]");e.push({jugadores:this.players.map(s=>s.alias),ganador:(n=this.winner)==null?void 0:n.alias,fecha:new Date().toISOString()}),localStorage.setItem("torneos",JSON.stringify(e))}}let g=null;function lt(t){g=t}function he(){g=null}function Me(){return g}let F=null;function dt(t){F=t}function ct(){return F}class ut{showPreGame(e,n){return new Promise(s=>{const i=document.getElementById("game-overlay"),o=document.getElementById("pre-game-screen"),a=document.getElementById("player-vs-player"),r=document.getElementById("countdown-text");r.textContent="",a.textContent=`${e} vs ${n}`,o==null||o.classList.remove("hidden"),i==null||i.classList.remove("hidden"),i==null||i.classList.add("flex"),setTimeout(()=>{o==null||o.classList.add("hidden"),s()},3e3)})}startCountdown(){return new Promise(e=>{const n=document.getElementById("game-overlay"),s=document.getElementById("pre-game-screen"),i=document.getElementById("countdown-screen"),o=document.getElementById("countdown-text");s==null||s.classList.add("hidden"),i==null||i.classList.remove("hidden");let a=3;o.textContent=String(a);const r=setInterval(()=>{a--,a>0?o.textContent=String(a):a===0?o.textContent="GO!":(clearInterval(r),n==null||n.classList.add("hidden"),n==null||n.classList.remove("flex"),e())},1e3)})}updateBracket(e){var n,s,i,o,a,r,d,h,u,p,b,x,E,P,L,B;if(e.semifinal1){const y=e.semifinal1,I=document.querySelector("#alias1"),A=document.querySelector("#alias1-point"),S=document.querySelector("#alias2"),H=document.querySelector("#alias2-point");if(console.log(y),I.value=y.player1.alias,S.value=y.player2.alias,I.disabled=!0,S.disabled=!0,A.textContent=((n=y.player1.score)==null?void 0:n.toString())??"0",H.textContent=((s=y.player2.score)==null?void 0:s.toString())??"0",y.winner){const G=document.querySelector("#final2");G&&(G.textContent=y.winner.alias),y.winner.alias===y.player1.alias?(i=I.closest(".flex"))==null||i.classList.add("winner-bg"):(o=S.closest(".flex"))==null||o.classList.add("winner-bg")}}if(e.semifinal2){const y=e.semifinal2;console.log(y);const I=document.querySelector("#alias3"),A=document.querySelector("#alias4"),S=document.querySelector("#alias3-point"),H=document.querySelector("#alias4-point");if(I.value=y.player1.alias,A.value=y.player2.alias,I.disabled=!0,A.disabled=!0,S.textContent=((a=y.player1.score)==null?void 0:a.toString())??"0",H.textContent=((r=y.player2.score)==null?void 0:r.toString())??"0",(d=I.closest(".flex"))==null||d.classList.remove("winner-bg"),(h=A.closest(".flex"))==null||h.classList.remove("winner-bg"),y.winner){const G=document.querySelector("#final1");G&&(G.textContent=y.winner.alias),y.winner.alias===y.player1.alias?(u=I.closest(".flex"))==null||u.classList.add("winner-bg"):(p=A.closest(".flex"))==null||p.classList.add("winner-bg")}}if(e.finalMatch){const y=e.finalMatch,I=document.querySelector("#final1"),A=document.querySelector("#final2"),S=document.querySelector("#final1-point"),H=document.querySelector("#final2-point");I.textContent=y.player1.alias,A.textContent=y.player2.alias,S.textContent=((b=y.player1.score)==null?void 0:b.toString())??"0",H.textContent=((x=y.player2.score)==null?void 0:x.toString())??"0",(E=I.closest(".flex"))==null||E.classList.remove("winner-bg"),(P=A.closest(".flex"))==null||P.classList.remove("winner-bg"),y.winner&&(y.winner.alias===y.player1.alias?(L=I.closest(".flex"))==null||L.classList.add("winner-bg"):(B=A.closest(".flex"))==null||B.classList.add("winner-bg"))}}showTournamentWinner(e){const n=document.getElementById("game-overlay"),s=document.getElementById("winner-screen"),i=document.getElementById("winner-name"),o=document.getElementById("countdown-screen");i.textContent=e,s==null||s.classList.remove("hidden"),n==null||n.classList.remove("hidden"),n==null||n.classList.add("flex"),o==null||o.classList.add("hidden"),document.getElementById("showResumBtn").onclick=()=>{let a=document.getElementById("game-overlay");a==null||a.classList.add("hidden");let r=document.getElementById("nextMatchBtn");r==null||r.classList.add("hidden");let d=document.getElementById("resetTournamentBtn");d&&d.classList.remove("hidden")},document.getElementById("resetTournamentBtn").onclick=()=>{let a=document.getElementById("game-overlay");a==null||a.classList.add("hidden");let r=document.getElementById("nextMatchBtn");r==null||r.classList.add("hidden"),w.navigate("home")}}}const _=new ut;async function j(t,e){const n={service:"tournament-service",level:"INFO",event_type:t,timestamp:new Date().toISOString(),...e};try{await fetch("http://localhost:5051",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})}catch{console.log("LOG (fallback):",n)}}class gt{async iniciarTorneo(){var e,n,s,i,o,a,r,d,h,u,p,b;if(g!=null&&g.isReady()&&(g==null||g.generateMatches(),await this.jugarPartido(g.semifinal1,"semifinal"),_.updateBracket(g),this.mostrarVistaTorneo(),j("Semifinal",{tournament_id:"tourn-"+Date.now(),player1:(e=g==null?void 0:g.semifinal1)==null?void 0:e.player1.alias,player2:(n=g==null?void 0:g.semifinal1)==null?void 0:n.player2.alias,score1:(s=g==null?void 0:g.semifinal1)==null?void 0:s.player1.score,score2:(i=g==null?void 0:g.semifinal1)==null?void 0:i.player2.score}),await this.esperarClickDelUsuario(),await this.jugarPartido(g.semifinal2,"semifinal"),_.updateBracket(g),this.mostrarVistaTorneo(),j("Semifinal",{tournament_id:"tourn-"+Date.now(),player1:(o=g==null?void 0:g.semifinal2)==null?void 0:o.player1.alias,player2:(a=g==null?void 0:g.semifinal2)==null?void 0:a.player2.alias,score1:(r=g==null?void 0:g.semifinal2)==null?void 0:r.player1.score,score2:(d=g==null?void 0:g.semifinal2)==null?void 0:d.player2.score}),await this.esperarClickDelUsuario(),(h=g.semifinal1)!=null&&h.winner&&((u=g.semifinal2)!=null&&u.winner))){g.generateFinal(),await this.jugarPartido(g.finalMatch,"final");const x=g.finalMatch.winner;j("Final",{tournament_id:"tourn-"+Date.now(),player1:(p=g==null?void 0:g.finalMatch)==null?void 0:p.player1,player2:(b=g==null?void 0:g.finalMatch)==null?void 0:b.player2,winner:x.alias,scores:x.score}),g.setWinner(x),_.updateBracket(g),this.mostrarVistaTorneo(),_.showTournamentWinner(x.alias),he()}}async esperarClickDelUsuario(){let e=document.getElementById("nextMatchBtn");e&&e.classList.remove("hidden");let n=document.getElementById("playtournamentBtn");return n&&n.classList.remove("inline-block"),new Promise(s=>{const i=document.getElementById("nextMatchBtn");if(!i){console.warn('Botón "Siguiente" no encontrado.'),s();return}const o=()=>{const a=document.querySelectorAll(".submenu");R(a),i.removeEventListener("click",o),s()};i.addEventListener("click",o)})}mostrarVistaTorneo(){const e=document.getElementById("esquemaTorneo"),n=document.getElementById("gameCanvasContainer");e&&(e.style.display="block"),n&&(n.style.display="none")}mostrarVistaJuego(){const e=document.getElementById("esquemaTorneo"),n=document.getElementById("gameCanvasContainer");e&&(e.style.display="none"),n&&(n.style.display="block")}jugarPartido(e,n){return new Promise(async s=>{if(!v.isCreatingGame){v.isCreatingGame=!0;try{v.currentGame&&(v.currentGame.stopGame(),v.currentGame=null,await new Promise(o=>setTimeout(o,50))),await _.showPreGame(e.player1.alias,e.player2.alias),await _.startCountdown(),this.mostrarVistaJuego(),await new Promise(o=>setTimeout(o,100));const i=new Ae({leftPlayer:e.player1.alias,rightPlayer:e.player2.alias,maxScore:3,gameMode:"p-vs-p",onFinish:(o,a,r)=>{console.log(a,r),e.player1.score=a,e.player2.score=r,e.winner=e.player1.alias===o?e.player1:e.player2,Ve(n,e);const d=Me();e.winner.alias&&e.winner.alias!==void 0?d&&_.updateBracket(d):(he(),w.navigate("home")),s()}});i.resetGame(),i.setGameOn(),i.start()}finally{v.isCreatingGame=!1}}})}}function ht(){return`
...
<div id="game-overlay" class="absolute inset-0 bg-black/80 flex-col items-center justify-center hidden z-50">
      ...
      `},init(){const t=document.getElementById("playtournamentBtn");let e=localStorage.getItem("login");const n=document.querySelector("#alias1");n&&(n.value=e||""),t==null||t.addEventListener("click",()=>{let s=document.getElementById("alias1").value,i=document.getElementById("alias2").value,o=document.getElementById("alias3").value,a=document.getElementById("alias4").value;i.trim()||(i="user2"),o.trim()||(o="user3"),a.trim()||(a="user4");const r=document.getElementById("alias2"),d=document.getElementById("alias3"),h=document.getElementById("alias4");if(r&&(r.value=i),d&&(d.value=o),h&&(h.value=a),!Me()){const L=new rt;L.addPlayer(s),L.addPlayer(i),L.addPlayer(o),L.addPlayer(a),lt(L)}ct()||dt({player1:s,player2:i,partidoActivo:!0,onMatchEnd:(L,B,y)=>{console.log(`Match ended. Winner: ${L}, Scores: ${B} - ${y}`)}}),t.classList.add("hidden"),new gt().iniciarTorneo();const x=document.getElementById("tournamentArea");let E=document.getElementById("gameCanvasContainer");if(!E&&(x!=null&&x.parentNode)&&(E=document.createElement("div"),E.id="gameCanvasContainer",E.className="hidden content bg-[#fbd11b] h-full",x.appendChild(E)),E&&F&&F.partidoActivo){const L=document.getElementById("gameArea");L==null||L.classList.add("hidden");const B=new U().render();E.innerHTML=B}const P=document.querySelectorAll(".submenu");R(P)})}};function pt(t,e){const n=document.getElementById(t),s=document.getElementById(e);if(n&&s){const i=n.value;n.value=s.value,s.value=i}}function ft(t,e){const n=document.getElementById(t),s=document.getElementById(e);if(!n||!s)return;const i=n.parentNode,o=n.nextSibling,a=s.nextSibling;o===s?i.insertBefore(s,n):a===n?i.insertBefore(n,s):(i.insertBefore(n,a),i.insertBefore(s,o))}function bt(){var e;(e=document.getElementById("swapBtn"))==null||e.addEventListener("click",()=>{pt("player1","player2")}),document.getElementById("playOneVsOneBtn").addEventListener("click",()=>{console.log("clic 1");const n=document.getElementById("player1"),s=document.getElementById("player2");if(!n.value.trim()||!s.value.trim()){m("You need 2 players to play.","oneVsOneAreaPopup");return}console.log("clic 2"),new v().initGame({player1:{alias:n.value},player2:{alias:s.value},winner:null})})}function yt(){var e;(e=document.getElementById("swapAIBtn"))==null||e.addEventListener("click",()=>{ft("player1VSAI","AIPlayer")}),document.getElementById("playOneVsAIBtn").addEventListener("click",()=>{const n=document.getElementById("player1"),s=document.getElementById("player1VSAI");if(!s.value.trim()){m("You need 1 player to play.","oneVsAIAreaPopup");return}new v().initGame({player1:{alias:n.value},player2:{alias:s.value},winner:null})})}function vt(){const t=document.querySelectorAll(".submenu"),e=document.getElementById("playSidebarBtn");e==null||e.addEventListener("click",()=>{N("playSubmenu",t)})}function wt(){return`
  ...
  `},async init(t){const e=document.getElementById(`othersUsersUsername_${t.id}`);e&&(e.textContent=t.login);const n=document.getElementById(`othersUsersPhoto_${t.id}`);t.profile_picture&&t.profile_picture.startsWith("https://lh3.googleusercontent.com")?await Q(n,t.profile_picture):n.src=`https://localhost:4443/${t.profile_picture}`;const s=document.getElementById(`addFriendBtn_${t.id}`),i=document.getElementById(`othersUsers_${t.id}_card`);s==null||s.addEventListener("click",async()=>{ee(i),q("Invitation sent",3500,"popup"),Mt(t)})}};function Ft(){return`
	...
	${jt()}
  `},init(){sn();const t=document.getElementById("tournamentBtn");t==null||t.addEventListener("click",()=>{w.navigate("tournament")});const e=document.getElementById("oneVsOneBtn");e==null||e.addEventListener("click",()=>{v.inGame=!0,w.navigate("game")});const n=document.getElementById("oneVsAIBtn");n==null||n.addEventListener("click",()=>{v.inGame=!0,w.navigate("gameai")})}};async function $(){const t=await ot(),e=document.getElementById("sidebar");t?(console.log("✅ Connected"),e.innerHTML=we.render(),we.init(),Gt(),_t(),Ot()):(e.innerHTML=ve.render(),ve.init(),console.log("❌ Not connected"))}function zt(){const t=document.getElementById("saveBtnEditProfile");t==null||t.addEventListener("click",()=>{Ct()}),Wt(),Yt(),Zt()}function Wt(){const t=document.getElementById("2FAtoggleSwitch"),e=t.querySelector("span");t.addEventListener("click",()=>{const s=!t.classList.contains("bg-green-500");He(t,e,s)})}function Yt(){const t=document.getElementById("anonymousToggleSwitch"),e=t.querySelector("span");t.addEventListener("click",async()=>{const s=!t.classList.contains("bg-green-500");He(t,e,s)})}function He(t,e,n){n?(t.classList.remove("bg-gray-400"),t.classList.add("bg-green-500"),e.classList.add("translate-x-6")):(t.classList.remove("bg-green-500"),t.classList.add("bg-gray-400"),e.classList.remove("translate-x-6"))}function Zt(){const t=document.getElementById("eraseAccountBtn"),e=document.getElementById("confirmPopup");t==null||t.addEventListener("click",()=>{e==null||e.classList.remove("hidden")});const n=document.getElementById("popupNo");n==null||n.addEventListener("click",()=>{e==null||e.classList.add("hidden")});const s=document.getElementById("popupYes");s==null||s.addEventListener("click",async()=>{await Ht(),await $(),w.navigate("home"),q("You have been disconnected and your account has been deleted",3500,"popup")})}function Xt(t){const e=document.getElementById("dashboard-container");if(e){if(e.innerHTML=`
  ...
  `}async function Ve(t,e){var n,s,i;console.log(`
			...
			`),t=="p-vs-ai"&&e.player1.alias==""&&(e.player1.alias=e.player2.alias,e.player2.alias="AI");try{console.log(`
				...
				gameMode: ${t},
			`),fetch("/api/auth/games/matches",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({player1:e.player1.alias,player2:e.player2.alias,scorePlayer1:e.player1.score??0,scorePlayer2:e.player2.score??0,winner:(i=e.winner)==null?void 0:i.alias,gameMode:t})})}catch(o){console.error("Game Fetch error:",o),m("Error with storing the game in historial.","popup"),w.navigate("home")}}async function rn(){try{const t=await fetch("/api/auth/games/nbMatchesPlayed",{credentials:"include"}).then(n=>n.json()),e={count:t.length,data:t};return console.log(e),e}catch(t){console.error("gameCurrentUserHasPlayedService error:",t),m("Error with storing the game in historial.","popup"),w.navigate("home")}}const le=(()=>{let t=[];async function e(){console.log("entered in manageGameHistorial");const s=await rn();t=(s==null?void 0:s.data)??[];const i=document.getElementById("gameHistoryContainer");i&&(i.innerHTML=t.map(o=>an(o)).join(""))}function n(){const s=document.getElementById("gameHistoryContainer");s&&(s.innerHTML=""),t=[]}return{main:e,reset:n}})(),f=class f{renderGameCanvas(){console.log("render 1");let e=document.getElementById("gamesArea"),n=document.getElementById("oneVsOneArea"),s=document.getElementById("oneVsAIArea");const i=new U().render();e&&(console.log("render 2"),e.innerHTML=i,s==null||s.classList.add("hidden"),n==null||n.classList.add("hidden"),e.classList.remove("hidden"))}async initGame(e){await f.cleanup();const n=document.getElementById("gameArea");n==null||n.classList.add("hidden"),f.noWinner=!0,await this.playGame(e)}showWinner(e,n){const s=document.getElementById("gamesArea");let i=e.winner?e.winner.alias:"";if(f.gameType==="p-vs-ai"&&n&&(i="ChatGPT"),console.log("type is=== ",n,`
winner is===`,i),s&&e.winner){s.innerHTML=`            
                ...
                `,s.classList.remove("hidden"),s.style.display="block";const o=document.getElementById("reset-btn");o==null||o.addEventListener("click",()=>{w.navigate("home")})}}playGame(e){return new Promise(async()=>{if(!f.isCreatingGame){f.isCreatingGame=!0;try{f.currentGame&&(f.currentGame.stopGame(),f.currentGame=null,await new Promise(s=>setTimeout(s,50))),this.renderGameCanvas(),await new Promise(s=>setTimeout(s,100)),f.gameType==="p-vs-ai"&&(f.otherPlayer=e.player2.alias);const n=new Ae({leftPlayer:e.player1.alias,rightPlayer:e.player2.alias,maxScore:parseInt(C.scoreLimit),gameMode:f.gameType,aiDifficulty:et(),onFinish:(s,i,o)=>{if(console.log(i,o),e.player1.score=i,e.player2.score=o,e.winner=e.player1.alias===s?e.player1:e.player2,console.log("entra en onMatchEnd"),Ve(f.gameType,e),f.noWinner&&(window.location.pathname.includes("/game")||window.location.pathname.includes("/gameai")))if(e.winner.alias&&e.winner.alias!==void 0){this.showWinner(e,o>i);let a=document.getElementById("winner-screen");a==null||a.classList.remove("hidden"),f.noWinner=!1}else(window.location.pathname.includes("/game")||window.location.pathname.includes("/gameai"))&&w.navigate("home");else(window.location.pathname.includes("/game")||window.location.pathname.includes("/gameai"))&&w.navigate("home");f.currentGame=null,n.resetGame()}});f.currentGame=n,n.resetGame(),n.setGameOn(),n.start()}finally{f.isCreatingGame=!1}}})}static async cleanup(){for(;f.isCreatingGame;)await new Promise(e=>setTimeout(e,10));f.currentGame&&(f.currentGame.stopGame(),f.currentGame=null),f.noWinner=!0,f.inGame=!1}};l(f,"gameType","p-vs-p"),l(f,"getAIDifficulty"),l(f,"getMaxScore"),l(f,"inGame",!1),l(f,"noWinner",!0),l(f,"gameController",!0),l(f,"otherPlayer","Erik"),l(f,"currentGame",null),l(f,"isCreatingGame",!1);let v=f;const Ee={currentUser:null,isLogin:!0,render(){return`
  ...
  `},async init(){await $(),Ee.init()}};async function ln(){if(console.log("1 - Login service initialized"),(await fetch("/api/auth/me/status",{credentials:"include"}).then(n=>n.json())).authenticated){w.navigate("home"),m("You are already connected. You can't access the login page.","popup");return}const e=document.getElementById("connectionBtn");e.addEventListener("click",async()=>{const n=document.getElementById("login").value.trim(),s=document.getElementById("password").value;e.disabled=!0;try{const i=await fetch("/api/auth/users/check",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({login:n,password:s}),credentials:"include"}),o=await i.json();if(console.log("login info:",{loginData:o}),!i.ok||o.success===!1){m(o.error||"Login failed","popup");return}if(o.requires2FA){const a=document.getElementById("loginCredentials"),r=document.getElementById("twofa-container");if(a&&r&&(r.innerHTML="",a.classList.add("hidden"),r.classList.remove("hidden"),r.querySelector("*")===null)){console.log("Attempting TwoFAController creation");const h=new ne(o.mail,async()=>{console.log("2FA Success callback triggered"),a.classList.add("hidden"),r.classList.add("hidden"),te(o.login,o.userId)},r,(u,p)=>{console.log(`2FA Error: ${u}`,p),m(u,"popup"),p&&(document.cookie="auth_phase=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;",document.cookie="auth_token=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;",sessionStorage.setItem("loginError",u),document.getElementById("password").value="",a&&a.classList.remove("hidden"),r&&r.classList.add("hidden"))}).init();r.appendChild(h)}}else te(n,o.userId)}catch(i){m("Network error during login","popup"),console.error("Login error:",i)}finally{e.disabled=!1}})}async function te(t,e){try{const n=await fetch("/api/auth/users/sessions",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({userId:e})});if(!n.ok)throw new Error("Token generation failed");localStorage.setItem("login",t),console.log(`in loginService tokenRes = ${n}`),j("login_initiated",{login_id:"login-"+Date.now(),player_username:t}),w.navigate("home"),q("You are logged in",3500,"popup")}catch(n){console.error("Login completion error:",n),m("Login complete but couldn't load session","popup"),w.navigate("home")}}const Pe={render:()=>`
  	<div class="w-screen h-screen flex bg-[#fbd11b] overflow-hidden">
  ...
  `,async init(){await $(),K("newPassword","togglePassword","eyeIconClosed","eyeIconOpened"),K("confirmPassword","toggleConfirmPassword","confirmEyeIconClosed","confirmEyeIconOpened"),gn(),document.body.insertAdjacentHTML("beforeend",hn()),mn(),document.getElementById("backToLogin").addEventListener("click",()=>{w.navigate("login")})}};function hn(){return`
  ...
  `},async init(){console.log("t view 1"),await $();const t=document.getElementById("tournamentArea"),e=document.getElementById("esquemaTorneo");let n=document.getElementById("gameCanvasContainer");if(!n&&(t!=null&&t.parentNode)&&(console.log("t view 2"),n=document.createElement("div"),n.id="gameCanvasContainer",n.className="hidden content bg-[#fbd11b] h-full",t.appendChild(n)),n&&F&&F.partidoActivo){console.log("t view 3");const s=document.getElementById("gameArea");s==null||s.classList.add("hidden");const i=new U().render();n.innerHTML=i}t==null||t.classList.remove("hidden"),e==null||e.classList.remove("hidden"),me.init()}};function je(){return`
