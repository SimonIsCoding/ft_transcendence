...
<div id="game-overlay" class="absolute inset-0 bg-black/80 flex-col items-center justify-center hidden z-50">
  ...
  `},async init(){if(await H(),!z()){m("Not logged. You can't access this game.","popup"),v.navigate("home");return}const e=document.getElementById("tournamentArea"),n=document.getElementById("esquemaTorneo");let s=document.getElementById("gameCanvasContainer");if(!s&&(e!=null&&e.parentNode)&&(console.log("t view 2"),s=document.createElement("div"),s.id="gameCanvasContainer",s.className="hidden content bg-[#fbd11b] h-full",e.appendChild(s)),s&&F&&F.partidoActivo){console.log("t view 3");const i=document.getElementById("gameArea");i==null||i.classList.add("hidden");const a=new N().render();s.innerHTML=a}e==null||e.classList.remove("hidden"),n==null||n.classList.remove("hidden"),he.init()}};function je(){return`
