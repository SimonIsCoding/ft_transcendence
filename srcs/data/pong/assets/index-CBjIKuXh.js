...
winner is===`,i),s&&e.winner){s.innerHTML=`            
  ...
  `,async init(){await $(),Q("newPassword","togglePassword","eyeIconClosed","eyeIconOpened"),Q("confirmPassword","toggleConfirmPassword","confirmEyeIconClosed","confirmEyeIconOpened"),gn(),document.body.insertAdjacentHTML("beforeend",hn()),mn(),document.getElementById("backToLogin").addEventListener("click",()=>{w.navigate("login")})}};function hn(){return`
