var Ne=Object.defineProperty;var qe=(t,e,n)=>e in t?Ne(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var l=(t,e,n)=>qe(t,typeof e!="symbol"?e+"":e,n);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function n(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(i){if(i.ep)return;i.ep=!0;const o=n(i);fetch(i.href,o)}})();function ze(t){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t)}function Q(t,e,n,s){const i=document.getElementById(t),o=document.getElementById(e),a=document.getElementById(n),r=document.getElementById(s);if(!i||!o||!r||!a)return;let d=!1;o.addEventListener("click",()=>{d=!d,i.type=d?"text":"password",r.classList.toggle("hidden",!d),a.classList.toggle("hidden",d)})}async function z(t,e=3500,n){const s=document.getElementById(n);s&&(s.classList.remove("bg-red-600"),s.classList.add("bg-green-600"),s.textContent=t,s.classList.remove("hidden"),setTimeout(()=>{s.classList.add("hidden")},e))}function m(t,e){const n=document.getElementById(e);n&&(n.classList.remove("bg-green-600"),n.classList.add("bg-red-600"),n.textContent=t,n.classList.remove("hidden"),setTimeout(()=>n.classList.add("hidden"),3500))}async function We(t){const e=new FormData;e.append("file",t);const n=await fetch("api/auth/uploadProfilePicture",{method:"POST",body:e,credentials:"include"}),s=await n.json();if(!n.ok||!s.success){console.error("Error on upload:",s),alert(`Error: ${s.error||"failed to store the picture."}`);return}}async function Ye(){return(await(await fetch("/api/auth/me",{credentials:"include"})).json()).user}class Ze{constructor(){l(this,"players",[]);l(this,"semifinal1",null);l(this,"semifinal2",null);l(this,"finalMatch",null);l(this,"winner",null)}addPlayer(e){this.players.push({alias:e})}isReady(){return this.players.length===4}generateMatches(){this.semifinal1={player1:{...this.players[0]},player2:{...this.players[1]},winner:null},this.semifinal2={player1:{...this.players[2]},player2:{...this.players[3]},winner:null}}generateFinal(){var e,n;(e=this.semifinal1)!=null&&e.winner&&((n=this.semifinal2)!=null&&n.winner)&&(this.finalMatch={player1:this.semifinal1.winner,player2:this.semifinal2.winner,winner:null})}setWinner(e){this.winner=e}saveToLocalStorage(){var n;const e=JSON.parse(localStorage.getItem("torneos")||"[]");e.push({jugadores:this.players.map(s=>s.alias),ganador:(n=this.winner)==null?void 0:n.alias,fecha:new Date().toISOString()}),localStorage.setItem("torneos",JSON.stringify(e))}}let g=null;function Xe(t){g=t}function ee(){g=null}function Me(){return g}let R=null;function Je(t){R=t}function Ke(){return R}let Qe=class{showPreGame(e,n){return new Promise(s=>{const i=document.getElementById("game-overlay"),o=document.getElementById("pre-game-screen"),a=document.getElementById("player-vs-player"),r=document.getElementById("countdown-text");r.textContent="",a.textContent=`${e} vs ${n}`,o==null||o.classList.remove("hidden"),i==null||i.classList.remove("hidden"),i==null||i.classList.add("flex"),setTimeout(()=>{o==null||o.classList.add("hidden"),s()},3e3)})}startCountdown(){return new Promise(e=>{const n=document.getElementById("game-overlay"),s=document.getElementById("pre-game-screen"),i=document.getElementById("countdown-screen"),o=document.getElementById("countdown-text");s==null||s.classList.add("hidden"),i==null||i.classList.remove("hidden");let a=3;o.textContent=String(a);const r=setInterval(()=>{a--,a>0?o.textContent=String(a):a===0?o.textContent="GO!":(clearInterval(r),n==null||n.classList.add("hidden"),n==null||n.classList.remove("flex"),e())},1e3)})}updateBracket(e){var n,s,i,o,a,r,d,h,u,p,f,x,E,P,L,B;if(e.semifinal1){const b=e.semifinal1,I=document.querySelector("#alias1"),A=document.querySelector("#alias1-point"),S=document.querySelector("#alias2"),H=document.querySelector("#alias2-point");if(console.log(b),I.value=b.player1.alias,S.value=b.player2.alias,I.disabled=!0,S.disabled=!0,A.textContent=((n=b.player1.score)==null?void 0:n.toString())??"0",H.textContent=((s=b.player2.score)==null?void 0:s.toString())??"0",b.winner){const V=document.querySelector("#final2");V&&(V.textContent=b.winner.alias),b.winner.alias===b.player1.alias?(i=I.closest(".flex"))==null||i.classList.add("winner-bg"):(o=S.closest(".flex"))==null||o.classList.add("winner-bg")}}if(e.semifinal2){const b=e.semifinal2;console.log(b);const I=document.querySelector("#alias3"),A=document.querySelector("#alias4"),S=document.querySelector("#alias3-point"),H=document.querySelector("#alias4-point");if(I.value=b.player1.alias,A.value=b.player2.alias,I.disabled=!0,A.disabled=!0,S.textContent=((a=b.player1.score)==null?void 0:a.toString())??"0",H.textContent=((r=b.player2.score)==null?void 0:r.toString())??"0",(d=I.closest(".flex"))==null||d.classList.remove("winner-bg"),(h=A.closest(".flex"))==null||h.classList.remove("winner-bg"),b.winner){const V=document.querySelector("#final1");V&&(V.textContent=b.winner.alias),b.winner.alias===b.player1.alias?(u=I.closest(".flex"))==null||u.classList.add("winner-bg"):(p=A.closest(".flex"))==null||p.classList.add("winner-bg")}}if(e.finalMatch){const b=e.finalMatch,I=document.querySelector("#final1"),A=document.querySelector("#final2"),S=document.querySelector("#final1-point"),H=document.querySelector("#final2-point");I.textContent=b.player1.alias,A.textContent=b.player2.alias,S.textContent=((f=b.player1.score)==null?void 0:f.toString())??"0",H.textContent=((x=b.player2.score)==null?void 0:x.toString())??"0",(E=I.closest(".flex"))==null||E.classList.remove("winner-bg"),(P=A.closest(".flex"))==null||P.classList.remove("winner-bg"),b.winner&&(b.winner.alias===b.player1.alias?(L=I.closest(".flex"))==null||L.classList.add("winner-bg"):(B=A.closest(".flex"))==null||B.classList.add("winner-bg"))}}showTournamentWinner(e){const n=document.getElementById("game-overlay"),s=document.getElementById("winner-screen"),i=document.getElementById("winner-name"),o=document.getElementById("countdown-screen");i.textContent=e,s==null||s.classList.remove("hidden"),n==null||n.classList.remove("hidden"),n==null||n.classList.add("flex"),o==null||o.classList.add("hidden"),document.getElementById("showResumBtn").onclick=()=>{let a=document.getElementById("game-overlay");a==null||a.classList.add("hidden");let r=document.getElementById("nextMatchBtn");r==null||r.classList.add("hidden");let d=document.getElementById("resetTournamentBtn");d&&d.classList.remove("hidden")},document.getElementById("resetTournamentBtn").onclick=()=>{let a=document.getElementById("game-overlay");a==null||a.classList.add("hidden");let r=document.getElementById("nextMatchBtn");r==null||r.classList.add("hidden"),w.navigate("home")}}};const _=new Qe,et=.02;class me{constructor(e){l(this,"paddleElem");l(this,"_position",50);this.paddleElem=e,this.reset()}get position(){return this._position}set position(e){this._position=e,this.updatePosition()}updatePosition(){const e=2+this._position*.96;this.paddleElem.style.top=`${e}vh`}rect(){return this.paddleElem.getBoundingClientRect()}reset(){this.position=50}update(e,n){this.position+=et*e*(n-this.position);const s=5;this.position=Math.max(s,Math.min(100-s,this.position))}highlight(){this.paddleElem.style.backgroundColor="#EDD24E",setTimeout(()=>{this.paddleElem.style.backgroundColor="#D9D9D9"},150)}}const pe=.055,tt=1.1,nt=.1;class st{constructor(e){l(this,"ballElem");l(this,"direction",{x:0,y:0});l(this,"velocity",pe);l(this,"_x",50);l(this,"_y",50);this.ballElem=e,this.reset()}get x(){return this._x}set x(e){this._x=e,this.updatePosition()}get y(){return this._y}set y(e){this._y=e,this.updatePosition()}updatePosition(){const e=(this._x-50)*.88,n=(this._y-50)*.96;this.ballElem.style.transform=`translate(${e}vw, ${n}vh)`}get directionX(){return this.direction.x}get directionY(){return this.direction.y}get ballVelocity(){return this.velocity}rect(){return this.ballElem.getBoundingClientRect()}reset(){for(this.x=50,this.y=50,this.direction={x:0,y:0};Math.abs(this.direction.x)<=.3||Math.abs(this.direction.x)>=.8;){const e=it(0,2*Math.PI);this.direction={x:Math.cos(e),y:Math.sin(e)}}this.velocity=pe}bounceVertical(){this.direction.y*=-1,this.direction.y<0?this.direction.y-=.1:this.direction.y+=.1}update(e,n,s){const i=[n.rect(),s.rect()];this.x+=this.direction.x*this.velocity*e,this.y+=this.direction.y*this.velocity*e;const o=this.rect(),a=window.innerHeight*.02,r=window.innerHeight*.98;(o.bottom>=r||o.top<=a)&&this.bounceVertical(),i.forEach(d=>{if(ot(d,o)){const h=o.top+o.height/2,u=d.top+d.height/2,p=d.height,f=(h-(u-p/2))/p,x=Math.max(0,Math.min(1,f)),E=Math.PI/3,P=(x-.5)*2*E,L=Math.sqrt(this.direction.x*this.direction.x+this.direction.y*this.direction.y);d.left<window.innerWidth/2?(n.highlight(),this.direction.x=Math.cos(P)*L,this.direction.y=Math.sin(P)*L):(s.highlight(),this.direction.x=-Math.cos(P)*L,this.direction.y=Math.sin(P)*L);const B=Math.sqrt(this.direction.x*this.direction.x+this.direction.y*this.direction.y);this.direction.x/=B,this.direction.y/=B,this.velocity=Math.min(this.velocity*tt,nt)}})}}function it(t,e){return Math.random()*(e-t)+t}function ot(t,e){return t.left<=e.right&&t.right>=e.left&&t.top<=e.bottom&&t.bottom>=e.top}class c{}l(c,"MAX_SCORE",5),l(c,"PADDLE_SPEED",.08),l(c,"FRAME_RATE_LIMIT",8.33),l(c,"AI_UPDATE_COOLDOWN",1e3),l(c,"AI_TARGET_THRESHOLD",2),l(c,"AI_MOVEMENT_THRESHOLD",1),l(c,"AI_MAX_SIMULATION_STEPS",10),l(c,"GAME_AREA_TOP_PERCENT",2),l(c,"GAME_AREA_BOTTOM_PERCENT",98),l(c,"PADDLE_BOUNDARY_TOP",4),l(c,"PADDLE_BOUNDARY_BOTTOM",92),l(c,"SIDEBAR_WIDTH",64),l(c,"RIGHT_MARGIN_VW",.02),l(c,"PADDLE_X_OFFSET",30),l(c,"BALL_SCALING_FACTOR",.0088),l(c,"DEFAULT_LEFT_PLAYER","Erik"),l(c,"DEFAULT_RIGHT_PLAYER","Simon");var j=(t=>(t.MOVE_LEFT_UP="w",t.MOVE_LEFT_DOWN="s",t.MOVE_RIGHT_UP="ArrowUp",t.MOVE_RIGHT_DOWN="ArrowDown",t.PAUSE=" ",t))(j||{});class at{constructor(e){l(this,"keys",{w:!1,s:!1,ArrowUp:!1,ArrowDown:!1," ":!1});l(this,"onPauseToggle");this.onPauseToggle=e,this.setupEventListeners()}setupEventListeners(){document.addEventListener("keydown",e=>{var s;const n=this.getKeyFromEvent(e);n&&(n===" "&&!this.keys[" "]&&((s=this.onPauseToggle)==null||s.call(this)),this.keys[n]=!0)}),document.addEventListener("keyup",e=>{const n=this.getKeyFromEvent(e);n&&(this.keys[n]=!1)})}getKeyFromEvent(e){const n=e.key.toLowerCase();return n==="w"||n==="s"?n:e.key==="ArrowUp"||e.key==="ArrowDown"?e.key:e.key===" "?" ":null}isPressed(e){return this.keys[e]}getKeyState(){return{...this.keys}}}var D=(t=>(t.LEFT="left",t.RIGHT="right",t))(D||{});class rt{constructor(){l(this,"leftAI",{target:50,lastUpdate:0,isEnabled:!0});l(this,"rightAI",{target:50,lastUpdate:0,isEnabled:!0})}enableAI(e){e==="left"?this.leftAI.isEnabled=!0:this.rightAI.isEnabled=!0}disableAI(e){(e==="left"||!e)&&(this.leftAI.isEnabled=!1),(e==="right"||!e)&&(this.rightAI.isEnabled=!1)}isEnabled(e){return e==="left"?this.leftAI.isEnabled:this.rightAI.isEnabled}getTarget(e){return e==="left"?this.leftAI.target:this.rightAI.target}updateAI(e,n){const s=e.directionX;if(this.leftAI.isEnabled&&s<0&&n-this.leftAI.lastUpdate>=c.AI_UPDATE_COOLDOWN){const i=this.predictBallLanding(e,"left");Math.abs(i-this.leftAI.target)>c.AI_TARGET_THRESHOLD&&(this.leftAI.target=i,this.leftAI.lastUpdate=n)}if(this.rightAI.isEnabled&&s>0&&n-this.rightAI.lastUpdate>=c.AI_UPDATE_COOLDOWN){const i=this.predictBallLanding(e,"right");Math.abs(i-this.rightAI.target)>c.AI_TARGET_THRESHOLD&&(this.rightAI.target=i,this.rightAI.lastUpdate=n)}}predictBallLanding(e,n){const s=e.x*1e3,i=e.y*1e3,o=e.directionX*1e3,a=e.directionY*1e3,r=window.innerWidth-c.SIDEBAR_WIDTH-window.innerWidth*c.RIGHT_MARGIN_VW,d=c.PADDLE_X_OFFSET,h=r-c.PADDLE_X_OFFSET,u=r/2,p=window.innerWidth*c.BALL_SCALING_FACTOR,f=((d-u)/p+50)*1e3,x=((h-u)/p+50)*1e3,E=n==="left"?f:x;return n==="left"&&o>=0||n==="right"&&o<=0?50:this.simulateBallTrajectoryGeometric(s,i,o,a,E)/1e3}simulateBallTrajectoryGeometric(e,n,s,i,o){let a=e,r=n,d=s,h=i;const u=c.GAME_AREA_TOP_PERCENT*1e3,p=c.GAME_AREA_BOTTOM_PERCENT*1e3,f=c.PADDLE_BOUNDARY_TOP*1e3,x=c.PADDLE_BOUNDARY_BOTTOM*1e3;let E=0;for(;E<c.AI_MAX_SIMULATION_STEPS;){if(Math.abs(d)<1||(o-a)/d<=0)return Math.max(f,Math.min(x,r));const L=(o-a)*(h/d),B=r+L;if(B<u&&h<0){const b=u-r;a=a+b*(d/h),r=u,h*=-1,h<0?h-=100:h+=100}else if(B>p&&h>0){const b=p-r;a=a+b*(d/h),r=p,h*=-1,h<0?h-=100:h+=100}else return Math.max(f,Math.min(x,B));E++}return Math.max(f,Math.min(x,r))}}var Z=(t=>(t[t.CONTINUE=0]="CONTINUE",t[t.LEFT_WINS=1]="LEFT_WINS",t[t.RIGHT_WINS=2]="RIGHT_WINS",t[t.LEFT_SCORES=3]="LEFT_SCORES",t[t.RIGHT_SCORES=4]="RIGHT_SCORES",t))(Z||{});class lt{constructor(e,n,s=c.MAX_SCORE){l(this,"leftPlayerScoreElem");l(this,"rightPlayerScoreElem");l(this,"scores",{left:0,right:0});l(this,"maxScore");this.leftPlayerScoreElem=e,this.rightPlayerScoreElem=n,this.maxScore=s,this.updateDisplay()}addScore(e){return e==="left"?this.scores.left++:this.scores.right++,this.updateDisplay(),this.scores.left>=this.maxScore?1:this.scores.right>=this.maxScore?2:e==="left"?3:4}reset(){this.scores={left:0,right:0},this.updateDisplay()}getScores(){return{...this.scores}}getScoreString(){return`${this.scores.left} - ${this.scores.right}`}updateDisplay(){this.leftPlayerScoreElem.textContent=this.scores.left.toString(),this.rightPlayerScoreElem.textContent=this.scores.right.toString()}}class k{constructor(e,n,s,i,o,a,r){l(this,"pauseOverlay");l(this,"pauseBtn");l(this,"playBtn");l(this,"gameArea");l(this,"leftPlayer");l(this,"rightPlayer");l(this,"onPauseToggle");this.pauseOverlay=e,this.pauseBtn=n,this.playBtn=s,this.gameArea=i,this.leftPlayer=o,this.rightPlayer=a,this.onPauseToggle=r,this.setupEventListeners()}setupEventListeners(){this.pauseBtn.addEventListener("click",()=>{var e;(e=this.onPauseToggle)==null||e.call(this)}),this.playBtn.addEventListener("click",()=>{var e;(e=this.onPauseToggle)==null||e.call(this)})}showPauseOverlay(){this.pauseOverlay.classList.remove("hidden"),this.gameArea.classList.add("blur-[9px]")}hidePauseOverlay(){this.pauseOverlay.classList.add("hidden"),this.gameArea.classList.remove("blur-[9px]")}setPlayerNames(e,n){this.leftPlayer.textContent=e,this.rightPlayer.textContent=n}static getElement(e){const n=document.getElementById(e);if(!n)throw new Error(`Required DOM element with id "${e}" not found`);return n}}class Te{constructor(e){l(this,"options");l(this,"gameId");l(this,"isPaused",!1);l(this,"gameOn",!1);l(this,"lastTime");l(this,"isGameActive",!0);l(this,"animationFrameId",null);l(this,"ball");l(this,"leftPlayerPaddle");l(this,"rightPlayerPaddle");l(this,"inputManager");l(this,"aiManager");l(this,"scoreManager");l(this,"uiManager");l(this,"ballElement");l(this,"leftPaddleElement");l(this,"rightPaddleElement");l(this,"onFinishCallback");e!=null&&e.maxScore&&(c.MAX_SCORE=e.maxScore),e!=null&&e.aiDifficulty&&(c.AI_UPDATE_COOLDOWN=e.aiDifficulty),this.gameId=`game-${Date.now()}-${Math.random().toString(36).substr(2,9)}`,console.log(`🎮 Creating new Game instance: ${this.gameId}`),this.options={leftPlayer:(e==null?void 0:e.leftPlayer)||c.DEFAULT_LEFT_PLAYER,rightPlayer:(e==null?void 0:e.rightPlayer)||c.DEFAULT_RIGHT_PLAYER,maxScore:(e==null?void 0:e.maxScore)||c.MAX_SCORE,gameMode:(e==null?void 0:e.gameMode)||"p-vs-p",onFinish:(e==null?void 0:e.onFinish)||void 0,aiDifficulty:(e==null?void 0:e.aiDifficulty)||c.AI_UPDATE_COOLDOWN},this.onFinishCallback=(e==null?void 0:e.onFinish)||null,this.initializeDOM(),this.initializeManagers(),this.initializeGameObjects(),this.setupDebugFunctions()}initializeDOM(){this.ballElement=k.getElement("ball"),this.leftPaddleElement=k.getElement("left-paddle"),this.rightPaddleElement=k.getElement("right-paddle")}initializeManagers(){const e=k.getElement("left-score"),n=k.getElement("right-score"),s=k.getElement("left-player"),i=k.getElement("right-player"),o=k.getElement("pause-overlay"),a=k.getElement("pause-btn"),r=k.getElement("play-btn"),d=k.getElement("game-area");this.inputManager=new at(()=>this.togglePause()),this.aiManager=new rt,this.scoreManager=new lt(e,n,this.options.maxScore),this.uiManager=new k(o,a,r,d,s,i,()=>this.togglePause()),this.configureGameMode(),this.uiManager.setPlayerNames(this.options.leftPlayer,this.options.rightPlayer)}configureGameMode(){switch(this.options.gameMode){case"p-vs-ai":this.options.rightPlayer="ChatGPT",this.options.leftPlayer=v.otherPlayer,this.aiManager.disableAI(D.LEFT);break;case"ai-vs-p":this.options.leftPlayer="Gemini",this.aiManager.disableAI(D.RIGHT);break;case"p-vs-p":this.aiManager.disableAI(D.LEFT),this.aiManager.disableAI(D.RIGHT);break;case"ai-vs-ai":this.options.leftPlayer="ChatGPT",this.options.rightPlayer="Gemini";break}}initializeGameObjects(){this.ball=new st(this.ballElement),this.leftPlayerPaddle=new me(this.leftPaddleElement),this.rightPlayerPaddle=new me(this.rightPaddleElement)}togglePause(){this.isPaused=!this.isPaused,this.isPaused?this.uiManager.showPauseOverlay():this.uiManager.hidePauseOverlay()}setGameOn(){this.gameOn=!0}enableAILeft(){this.aiManager.enableAI(D.LEFT)}enableAIRight(){this.aiManager.enableAI(D.RIGHT)}disableAI(){this.aiManager.disableAI()}resetGame(){this.scoreManager.reset(),this.leftPlayerPaddle.reset(),this.rightPlayerPaddle.reset(),this.ball.reset(),this.isPaused=!1,v.gameController=!1}stopGame(){console.log(`🛑 Stopping Game instance: ${this.gameId}`),this.isGameActive=!1,this.gameOn=!1,this.isPaused=!0,this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null,console.log(`🎬 Cancelled animation frame for Game: ${this.gameId}`)),this.lastTime=void 0,this.resetGame()}get gameAreaTop(){return c.GAME_AREA_TOP_PERCENT}get gameAreaBottom(){return c.GAME_AREA_BOTTOM_PERCENT}get getBall(){return this.ball}get getLeftPaddle(){return this.leftPlayerPaddle}get getRightPaddle(){return this.rightPlayerPaddle}setupDebugFunctions(){window.enableAILeft=()=>this.enableAILeft(),window.enableAIRight=()=>this.enableAIRight(),window.disableAI=()=>this.disableAI()}start(){console.log(`▶️ Starting Game instance: ${this.gameId}`);const e=n=>{if(!this.isGameActive||!v.noWinner||!this.gameOn){console.log(`⏹️ Game loop stopping for Game: ${this.gameId} (isActive: ${this.isGameActive}, noWinner: ${v.noWinner}, gameOn: ${this.gameOn})`),window.addEventListener("popstate",s=>{ee(),w.navigate("home"),console.log("History changed:",s.state)}),this.resetGame(),this.animationFrameId=null;return}if(this.lastTime!=null){const s=n-this.lastTime;if(s<c.FRAME_RATE_LIMIT){this.animationFrameId=window.requestAnimationFrame(e);return}this.isPaused||(this.ball.update(s,this.leftPlayerPaddle,this.rightPlayerPaddle),this.aiManager.updateAI(this.ball,n),this.updateLeftPlayerPaddle(s),this.updateRightPlayerPaddle(s),this.isLose()&&(console.log(`⚽ Ball lost in Game: ${this.gameId}`),this.handleLose()))}this.lastTime=n,this.animationFrameId=window.requestAnimationFrame(e)};this.animationFrameId=window.requestAnimationFrame(e)}updateLeftPlayerPaddle(e){if(this.aiManager.isEnabled(D.LEFT)){const n=this.leftPlayerPaddle.position,i=this.aiManager.getTarget(D.LEFT)-n;if(Math.abs(i)>c.AI_MOVEMENT_THRESHOLD){const o=i>0?1:-1,a=n+o*c.PADDLE_SPEED*e;this.leftPlayerPaddle.position=Math.max(c.PADDLE_BOUNDARY_TOP,Math.min(c.PADDLE_BOUNDARY_BOTTOM,a))}return}this.inputManager.isPressed(j.MOVE_LEFT_UP)?this.leftPlayerPaddle.position=Math.max(c.PADDLE_BOUNDARY_TOP,this.leftPlayerPaddle.position-c.PADDLE_SPEED*e):this.inputManager.isPressed(j.MOVE_LEFT_DOWN)&&(this.leftPlayerPaddle.position=Math.min(c.PADDLE_BOUNDARY_BOTTOM,this.leftPlayerPaddle.position+c.PADDLE_SPEED*e))}updateRightPlayerPaddle(e){if(this.aiManager.isEnabled(D.RIGHT)){const n=this.rightPlayerPaddle.position,i=this.aiManager.getTarget(D.RIGHT)-n;if(Math.abs(i)>c.AI_MOVEMENT_THRESHOLD){const o=i>0?1:-1,a=n+o*c.PADDLE_SPEED*e;this.rightPlayerPaddle.position=Math.max(c.PADDLE_BOUNDARY_TOP,Math.min(c.PADDLE_BOUNDARY_BOTTOM,a))}return}this.inputManager.isPressed(j.MOVE_RIGHT_UP)?this.rightPlayerPaddle.position=Math.max(c.PADDLE_BOUNDARY_TOP,this.rightPlayerPaddle.position-c.PADDLE_SPEED*e):this.inputManager.isPressed(j.MOVE_RIGHT_DOWN)&&(this.rightPlayerPaddle.position=Math.min(c.PADDLE_BOUNDARY_BOTTOM,this.rightPlayerPaddle.position+c.PADDLE_SPEED*e))}isLose(){const e=this.ball.rect(),n=c.SIDEBAR_WIDTH,s=window.innerWidth-window.innerWidth*c.RIGHT_MARGIN_VW;return e.right>=s||e.left<=n}handleLose(){const e=this.ball.rect(),n=window.innerWidth-window.innerWidth*c.RIGHT_MARGIN_VW;let s;if(e.right>=n?s=this.scoreManager.addScore("left"):s=this.scoreManager.addScore("right"),s===Z.LEFT_WINS||s===Z.RIGHT_WINS){this.isPaused=!0;const i=s===Z.LEFT_WINS?this.options.leftPlayer:this.options.rightPlayer;if(this.onFinishCallback){const o=this.scoreManager.getScores();this.isGameActive=!1,this.gameOn=!1,this.resetGame(),this.onFinishCallback(i,o.left,o.right)}}this.ball.reset()}}async function U(t,e){const n={service:"tournament-service",level:"INFO",event_type:t,timestamp:new Date().toISOString(),...e};try{await fetch("http://localhost:5051",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})}catch{console.log("LOG (fallback):",n)}}function dt(){return`
  ...
  `}async function Se(t,e){var n,s,i;console.log(`
			...
			`),t=="p-vs-ai"&&e.player1.alias==""&&(e.player1.alias=e.player2.alias,e.player2.alias="AI");try{console.log(`
				...
				gameMode: ${t},
			`),fetch("/api/auth/games/matches",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({player1:e.player1.alias,player2:e.player2.alias,scorePlayer1:e.player1.score??0,scorePlayer2:e.player2.score??0,winner:(i=e.winner)==null?void 0:i.alias,gameMode:t})})}catch(o){console.error("Game Fetch error:",o),m("Error with storing the game in historial.","popup"),w.navigate("home")}}async function ut(){try{const t=await fetch("/api/auth/games/nbMatchesPlayed",{credentials:"include"}).then(n=>n.json()),e={count:t.length,data:t};return console.log(e),e}catch(t){console.error("gameCurrentUserHasPlayedService error:",t),m("Error with storing the game in historial.","popup"),w.navigate("home")}}const re=(()=>{let t=[];async function e(){console.log("entered in manageGameHistorial");const s=await ut();t=(s==null?void 0:s.data)??[];const i=document.getElementById("gameHistoryContainer");i&&(i.innerHTML=t.map(o=>ct(o)).join(""))}function n(){const s=document.getElementById("gameHistoryContainer");s&&(s.innerHTML=""),t=[]}return{main:e,reset:n}})();class gt{async iniciarTorneo(){var e,n,s,i,o,a,r,d,h,u,p,f;if(g!=null&&g.isReady()&&(g==null||g.generateMatches(),await this.jugarPartido(g.semifinal1,"semifinal"),_.updateBracket(g),this.mostrarVistaTorneo(),U("Semifinal",{tournament_id:"tourn-"+Date.now(),player1:(e=g==null?void 0:g.semifinal1)==null?void 0:e.player1.alias,player2:(n=g==null?void 0:g.semifinal1)==null?void 0:n.player2.alias,score1:(s=g==null?void 0:g.semifinal1)==null?void 0:s.player1.score,score2:(i=g==null?void 0:g.semifinal1)==null?void 0:i.player2.score}),await this.esperarClickDelUsuario(),await this.jugarPartido(g.semifinal2,"semifinal"),_.updateBracket(g),this.mostrarVistaTorneo(),U("Semifinal",{tournament_id:"tourn-"+Date.now(),player1:(o=g==null?void 0:g.semifinal2)==null?void 0:o.player1.alias,player2:(a=g==null?void 0:g.semifinal2)==null?void 0:a.player2.alias,score1:(r=g==null?void 0:g.semifinal2)==null?void 0:r.player1.score,score2:(d=g==null?void 0:g.semifinal2)==null?void 0:d.player2.score}),await this.esperarClickDelUsuario(),(h=g.semifinal1)!=null&&h.winner&&((u=g.semifinal2)!=null&&u.winner))){g.generateFinal(),await this.jugarPartido(g.finalMatch,"final");const x=g.finalMatch.winner;U("Final",{tournament_id:"tourn-"+Date.now(),player1:(p=g==null?void 0:g.finalMatch)==null?void 0:p.player1,player2:(f=g==null?void 0:g.finalMatch)==null?void 0:f.player2,winner:x.alias,scores:x.score}),g.setWinner(x),_.updateBracket(g),this.mostrarVistaTorneo(),_.showTournamentWinner(x.alias),ee()}}async esperarClickDelUsuario(){let e=document.getElementById("nextMatchBtn");e&&e.classList.remove("hidden");let n=document.getElementById("playtournamentBtn");return n&&n.classList.remove("inline-block"),new Promise(s=>{const i=document.getElementById("nextMatchBtn");if(!i){console.warn('Botón "Siguiente" no encontrado.'),s();return}const o=()=>{const a=document.querySelectorAll(".submenu");G(a),i.removeEventListener("click",o),s()};i.addEventListener("click",o)})}mostrarVistaTorneo(){const e=document.getElementById("esquemaTorneo"),n=document.getElementById("gameCanvasContainer");e&&(e.style.display="block"),n&&(n.style.display="none")}mostrarVistaJuego(){const e=document.getElementById("esquemaTorneo"),n=document.getElementById("gameCanvasContainer");e&&(e.style.display="none"),n&&(n.style.display="block")}jugarPartido(e,n){return new Promise(async s=>{if(!v.isCreatingGame){v.isCreatingGame=!0;try{v.currentGame&&(v.currentGame.stopGame(),v.currentGame=null,await new Promise(o=>setTimeout(o,50))),await _.showPreGame(e.player1.alias,e.player2.alias),await _.startCountdown(),this.mostrarVistaJuego(),await new Promise(o=>setTimeout(o,100));const i=new Te({leftPlayer:e.player1.alias,rightPlayer:e.player2.alias,maxScore:3,gameMode:"p-vs-p",onFinish:(o,a,r)=>{console.log(a,r),e.player1.score=a,e.player2.score=r,e.winner=e.player1.alias===o?e.player1:e.player2,Se(n,e);const d=Me();e.winner.alias&&e.winner.alias!==void 0?d&&_.updateBracket(d):(ee(),w.navigate("home")),s()}});i.resetGame(),i.setGameOn(),i.start()}finally{v.isCreatingGame=!1}}})}}class ${render(){return`
...
<div id="game-overlay" class="absolute inset-0 bg-black/80 flex-col items-center justify-center hidden z-50">
      ...
      `},init(){const t=document.getElementById("playtournamentBtn");let e=localStorage.getItem("login");const n=document.querySelector("#alias1");n&&(n.value=e||""),t==null||t.addEventListener("click",()=>{let s=document.getElementById("alias1").value,i=document.getElementById("alias2").value,o=document.getElementById("alias3").value,a=document.getElementById("alias4").value;i.trim()||(i="user2"),o.trim()||(o="user3"),a.trim()||(a="user4");const r=document.getElementById("alias2"),d=document.getElementById("alias3"),h=document.getElementById("alias4");if(r&&(r.value=i),d&&(d.value=o),h&&(h.value=a),!Me()){const L=new Ze;L.addPlayer(s),L.addPlayer(i),L.addPlayer(o),L.addPlayer(a),Xe(L)}Ke()||Je({player1:s,player2:i,partidoActivo:!0,onMatchEnd:(L,B,b)=>{console.log(`Match ended. Winner: ${L}, Scores: ${B} - ${b}`)}}),t.classList.add("hidden"),new gt().iniciarTorneo();const x=document.getElementById("tournamentArea");let E=document.getElementById("gameCanvasContainer");if(!E&&(x!=null&&x.parentNode)&&(E=document.createElement("div"),E.id="gameCanvasContainer",E.className="hidden content bg-[#fbd11b] h-full",x.appendChild(E)),E&&R&&R.partidoActivo){const L=document.getElementById("gameArea");L==null||L.classList.add("hidden");const B=new $().render();E.innerHTML=B}const P=document.querySelectorAll(".submenu");G(P)})}};function pt(t,e){const n=document.getElementById(t),s=document.getElementById(e);if(n&&s){const i=n.value;n.value=s.value,s.value=i}}function ft(t,e){const n=document.getElementById(t),s=document.getElementById(e);if(!n||!s)return;const i=n.parentNode,o=n.nextSibling,a=s.nextSibling;o===s?i.insertBefore(s,n):a===n?i.insertBefore(n,s):(i.insertBefore(n,a),i.insertBefore(s,o))}function bt(){var e;(e=document.getElementById("swapBtn"))==null||e.addEventListener("click",()=>{pt("player1","player2")}),document.getElementById("playOneVsOneBtn").addEventListener("click",()=>{console.log("clic 1");const n=document.getElementById("player1"),s=document.getElementById("player2");if(!n.value.trim()||!s.value.trim()){m("You need 2 players to play.","oneVsOneAreaPopup");return}console.log("clic 2"),new v().initGame({player1:{alias:n.value},player2:{alias:s.value},winner:null})})}function yt(){var e;(e=document.getElementById("swapAIBtn"))==null||e.addEventListener("click",()=>{ft("player1VSAI","AIPlayer")}),document.getElementById("playOneVsAIBtn").addEventListener("click",()=>{const n=document.getElementById("player1"),s=document.getElementById("player1VSAI");if(!s.value.trim()){m("You need 1 player to play.","oneVsAIAreaPopup");return}new v().initGame({player1:{alias:n.value},player2:{alias:s.value},winner:null})})}function vt(){const t=document.querySelectorAll(".submenu"),e=document.getElementById("playSidebarBtn");e==null||e.addEventListener("click",()=>{q("playSubmenu",t)})}function wt(){return`
  ...
  `},async init(t){const e=document.getElementById(`othersUsersUsername_${t.id}`);e&&(e.textContent=t.login);const n=document.getElementById(`othersUsersPhoto_${t.id}`);t.profile_picture&&t.profile_picture.startsWith("https://lh3.googleusercontent.com")?await ne(n,t.profile_picture):n.src=`https://localhost:4443/${t.profile_picture}`;const s=document.getElementById(`addFriendBtn_${t.id}`),i=document.getElementById(`othersUsers_${t.id}_card`);s==null||s.addEventListener("click",async()=>{se(i),z("Invitation sent",3500,"popup"),Mt(t)})}};function Ft(){return`
	...
	`}function se(t,e="duration-750"){if(!t)return;t.classList.remove("hidden","opacity-0"),t.classList.add("opacity-100","transition-opacity","duration-1000","ease-out"),t.offsetWidth,t.classList.remove("opacity-100"),t.classList.add("opacity-0"),setTimeout(()=>t.remove(),(e==="duration-1000"?1e3:300)+20)}async function Ge(t){var s;const e=document.getElementById("friendRequestDiv"),n=document.getElementById(`newRequestsFrom_${t.id}`);if(t)e==null||e.classList.remove("hidden"),n?await J.init(t):((s=document.getElementById("friendRequestCard"))==null||s.insertAdjacentHTML("beforeend",J.render(t)),await J.init(t));else{e==null||e.classList.remove("hidden");const i=document.getElementById("friendRequest");i.textContent="No Friend Request"}}const de=(()=>{let t=0;async function e(){const s=await Fe();for(;t<s;){const i=await Re(t);await Ge(i),t++}}function n(){t=0}return{main:e,reset:n}})();async function He(t){var s;const e=document.getElementById("friendsListDiv"),n=await Tt(t);e&&(e.classList.remove("hidden"),document.getElementById(`friendBox_${n.id}`)?await K.init(n):((s=document.getElementById("friendsCard"))==null||s.insertAdjacentHTML("beforeend",K.render(n)),await K.init(n)))}const ce=(()=>{let t=0;async function e(){const s=await $e();for(;t<s;)He(t),t++}function n(){t=0}return{main:e,reset:n}})(),ue=(()=>{let t=0,e=0;async function n(){const i=document.getElementById("othersUsersDiv");i==null||i.classList.remove("hidden");const o=await At();if(o>1){let a=o-1>2?2:o-1;console.log(`max user is ${a}`);let r,d=[],h=0;for(;t<a;){if(r=await fe(),r&&d.push(r),t>0)for(;r&&d[0].id===d[1].id;)d.pop(),r=await fe(),r&&d.push(r),e>=o&&(r=null),e++;const u=document.getElementById("othersUsersCard"),p=document.getElementById("othersUsersP");if(r&&u){let f=`othersUsers_${r.id}_card`,x=r.id.toString();u.insertAdjacentHTML("beforeend",ve.render(f,x)),ve.init(r),p.textContent="Others Users",h++}else h==0&&(p.textContent="No others users to connect with");t++}}else{const a=document.getElementById("othersUsersP");a.textContent="You are the only player registered in the database. You can't connect with no one."}}function s(){t=0,e=0}return{main:n,reset:s}})();async function Rt(){de.main(),ce.main(),ue.main()}function $t(t,e,n,s){const i=document.getElementById("backBtnFriendsSubmenu");i==null||i.addEventListener("click",()=>{G(t),q("profileSubmenu",t)}),e==null||e.classList.add("hidden"),n==null||n.classList.add("hidden"),s==null||s.classList.remove("hidden"),T("largeSubmenu"),T("friendsSubmenu"),Rt()}async function Gt(){de.reset(),ce.reset(),ue.reset(),re.reset(),await fetch("/api/auth/me",{method:"DELETE",credentials:"include"})}function Ht(){const t=document.getElementById("saveBtnEditProfile");t==null||t.addEventListener("click",()=>{Ct()}),Vt(),jt(),Ut()}function Vt(){const t=document.getElementById("2FAtoggleSwitch"),e=t.querySelector("span");t.addEventListener("click",()=>{const s=!t.classList.contains("bg-green-500");Ve(t,e,s)})}function jt(){const t=document.getElementById("anonymousToggleSwitch"),e=t.querySelector("span");t.addEventListener("click",async()=>{const s=!t.classList.contains("bg-green-500");Ve(t,e,s)})}function Ve(t,e,n){n?(t.classList.remove("bg-gray-400"),t.classList.add("bg-green-500"),e.classList.add("translate-x-6")):(t.classList.remove("bg-green-500"),t.classList.add("bg-gray-400"),e.classList.remove("translate-x-6"))}function Ut(){const t=document.getElementById("eraseAccountBtn"),e=document.getElementById("confirmPopup");t==null||t.addEventListener("click",()=>{e==null||e.classList.remove("hidden")});const n=document.getElementById("popupNo");n==null||n.addEventListener("click",()=>{e==null||e.classList.add("hidden")});const s=document.getElementById("popupYes");s==null||s.addEventListener("click",async()=>{await Gt(),await O(),w.navigate("home"),z("You have been disconnected and your account has been deleted",3500,"popup")})}const Nt=()=>C.iaDifficulty==="Easy"?1e3:C.iaDifficulty==="Medium"?100:1,C={iaDifficulty:"Easy",scoreLimit:"5"};function qt(){const t=document.getElementById("iaDifficultySliderInput"),e=document.getElementById("iaDifficultyValue"),n=document.getElementById("scoreLimitSliderInput"),s=document.getElementById("scoreLimitValue");C.iaDifficulty=xe(parseInt(t.value)),e.textContent=C.iaDifficulty,C.scoreLimit=we(parseInt(n.value)),s.textContent=C.scoreLimit,t.addEventListener("input",i=>{const o=parseInt(i.target.value);C.iaDifficulty=xe(o),e.textContent=C.iaDifficulty}),n.addEventListener("input",i=>{const o=parseInt(i.target.value);C.scoreLimit=we(o),s.textContent=C.scoreLimit})}function we(t){return t==1?"3":t==2?"5":"11"}function xe(t){return t==1?"Easy":t==2?"Medium":"Hard"}function zt(t){const e=document.getElementById("dashboard-container");if(e){if(e.innerHTML=`
    ...
    `,!document.getElementById("dashboard-custom-style")){const n=document.createElement("style");n.id="dashboard-custom-style",n.innerHTML=`
      ...
      `,document.head.appendChild(n)}if(window.d3)Ee(t);else{const n=document.createElement("script");n.src="https://d3js.org/d3.v7.min.js",n.onload=()=>Ee(t),document.head.appendChild(n)}}}function Ee(t){document.getElementById("username").textContent=t.username,document.getElementById("total-won").textContent=String(t.stats.won),document.getElementById("total-lost").textContent=String(t.stats.lost),document.getElementById("total-scores").textContent=String(t.stats.scores),document.getElementById("total-friends").textContent=String(t.stats.friends);const e=[{label:"Received",value:t.points.received},{label:"Scored",value:t.points.scored}];Wt(e);const n=t.stats.won+t.stats.lost,s=n>0?Math.round(t.stats.won/n*100):0,i=100-s;Yt([{label:"Won",value:s},{label:"Lost",value:i}]),document.getElementById("won-percentage").textContent=`Won ${s}%`,document.getElementById("lost-percentage").textContent=`Lost ${i}%`}function Wt(t){const e=window.d3;e.select("#bar-chart").html("");const n={top:20,right:20,bottom:20,left:40},s=300-n.left-n.right,i=150-n.top-n.bottom,o=e.select("#bar-chart").append("svg").attr("viewBox",`0 0 ${s+n.left+n.right} ${i+n.top+n.bottom}`).append("g").attr("transform",`translate(${n.left},${n.top})`),a=e.scaleLinear().domain([0,e.max(t,u=>u.value)*1.1]).range([i,0]),r=e.scaleBand().domain(t.map(u=>u.label)).range([0,s]).padding(.5),d=e.axisLeft(a).tickSize(-s).tickFormat(()=>"").ticks(3);o.append("g").attr("class","y-axis-grid").call(d).selectAll("line").attr("stroke","#4A5568"),o.selectAll(".domain").remove();const h=e.axisLeft(a).ticks(3);o.append("g").call(h).attr("color","#A0AEC0").selectAll(".domain, .tick line").remove(),o.selectAll(".bar").data(t).enter().append("rect").attr("class","bar").attr("x",u=>r(u.label)).attr("y",u=>a(u.value)).attr("width",r.bandwidth()).attr("height",u=>i-a(u.value)).attr("fill",u=>u.label==="Scored"?"#EDD24E":"#D9D9D9").attr("rx",6).attr("ry",6)}function Yt(t){const e=window.d3;e.select("#donut-chart").html("");const n=200,s=200,i=Math.min(n,s)/2,o=30,a=e.scaleOrdinal().domain(t.map(u=>u.label)).range(["#EDD24E","#D9D9D9"]),r=e.select("#donut-chart").append("svg").attr("viewBox",`0 0 ${n} ${s}`).append("g").attr("transform",`translate(${n/2},${s/2})`),d=e.arc().innerRadius(i-o).outerRadius(i).cornerRadius(10),h=e.pie().value(u=>u.value).sort(null);r.selectAll("path").data(h(t)).enter().append("path").attr("d",d).attr("fill",u=>a(u.data.label))}let je=null;function W(t){je={...t}}function ge(){return je}function he(t){return`
  ...
  `}function q(t,e){e.forEach(n=>{n.id===t?(n.classList.toggle("max-h-0"),n.classList.toggle("max-h-screen")):(n.classList.add("max-h-0"),n.classList.remove("max-h-screen"))})}function T(t){const e=document.getElementById(t);e&&(e.classList.remove("max-h-0"),e.classList.add("max-h-screen"))}function G(t){t.forEach(e=>{e.classList.add("max-h-0"),e.classList.remove("max-h-screen")})}const Zt={username:"PlayerOne",stats:{won:12,lost:8,scores:230,friends:5},points:{scored:150,received:180}};function Xt(){tn();const t=document.querySelectorAll(".submenu"),e=document.getElementById("friendsSubmenu"),n=document.getElementById("dashboardSubmenu"),s=document.getElementById("gameHistorySubmenu"),i=document.getElementById("DashboardBtn");i==null||i.addEventListener("click",()=>{e==null||e.classList.add("hidden"),s==null||s.classList.add("hidden"),n==null||n.classList.remove("hidden"),T("largeSubmenu"),T("dashboardSubmenu"),zt(Zt);const d=document.getElementById("backBtnDasboardSubmenu");d==null||d.addEventListener("click",()=>{G(t),q("profileSubmenu",t)})});const o=document.getElementById("friendsListBtn");o==null||o.addEventListener("click",()=>{$t(t,n,s,e)});const a=document.getElementById("gameHistoryBtn"),r=document.getElementById("backBtnGameHistorySubmenu");r==null||r.addEventListener("click",()=>{console.log("clicked"),G(t),q("profileSubmenu",t)}),a==null||a.addEventListener("click",()=>{n==null||n.classList.add("hidden"),e==null||e.classList.add("hidden"),s==null||s.classList.remove("hidden"),T("largeSubmenu"),T("gameHistorySubmenu"),re.main()}),Jt(),Ht()}function Jt(){const t=document.getElementById("profileSubmenu"),e=document.getElementById("editProfileSubmenu"),n=document.getElementById("profileSidebarBtn"),s=document.getElementById("editProfileBtn"),i=document.querySelectorAll(".submenu"),o=document.getElementById("backBtnEditProfileSubmenu");s==null||s.addEventListener("click",()=>{Et(),e==null||e.classList.add("max-h-screen"),e==null||e.classList.remove("max-h-0"),e==null||e.classList.remove("hidden"),o==null||o.addEventListener("click",()=>{e==null||e.classList.add("max-h-0"),e==null||e.classList.remove("max-h-screen")})}),n==null||n.addEventListener("click",()=>{const a=t==null?void 0:t.classList.contains("max-h-screen"),r=e==null?void 0:e.classList.contains("max-h-screen");a||r?i.forEach(d=>{d.classList.remove("max-h-screen"),d.classList.add("max-h-0")}):(q("profileSubmenu",i),e==null||e.classList.add("max-h-0"),e==null||e.classList.remove("max-h-screen"))})}function Kt(){const t=document.querySelectorAll(".submenu"),e=document.getElementById("settingsSidebarBtn"),n=document.getElementById("largeSubmenu"),s=document.getElementById("settingsSubmenu");e==null||e.addEventListener("click",()=>{s!=null&&s.classList.contains("max-h-screen")?(n==null||n.classList.add("max-h-0"),n==null||n.classList.remove("max-h-screen"),s.classList.add("max-h-0"),s.classList.remove("max-h-screen")):(G(t),T("largeSubmenu"),T("settingsSubmenu"))})}function Qt(){vt(),Xt(),Kt(),qt()}async function en(){const e=await(await fetch("/api/auth/me/status",{method:"GET",credentials:"include"})).json();return console.log("data.authenticated = ",e.authenticated),e.authenticated===!0}async function tn(){const e=await(await fetch("/api/auth/me",{method:"GET",credentials:"include"})).json();W(e.user);const n=document.getElementById("profileName");n&&(n.textContent=e.user.login||"Profile Name");const s=document.getElementById("mailInProfileSubmenu");s&&(s.textContent=e.user.mail||"contact@mail.com");const i=document.getElementById("playerNameDashboard");i&&(i.textContent=e.user.login||"Username")}function nn(){const t=document.getElementById("logoutSidebarBtn");if(!t){console.error("Logout button not found");return}t.addEventListener("click",async e=>{e.preventDefault();try{const n=await fetch("/api/auth/me/sessions",{method:"DELETE",credentials:"include"});if(!n.ok)throw new Error(`Logout failed: ${n.statusText}`);localStorage.removeItem("userState"),sessionStorage.clear(),de.reset(),ce.reset(),ue.reset(),re.reset(),w.navigate("home"),m("You have been disconnected","popup")}catch(n){console.error("Logout error:",n),w.navigate("home")}})}function sn(){return`
	...
	<div id="dashboardSubmenu" class="submenu h-screen w-full top-0 bg-[#fbd11b] flex flex-col overflow-auto">
		${he("backBtnDasboardSubmenu")}
		<div id="dashboard-container" class="flex-1"></div>
	</div>
	`}const Le={currentUser:null,render(){return`
	...
	<div class="flex flex-col mt-auto items-center space-y-2 pb-6">
	 ...
	 `},init(){document.getElementById("loginBtn").addEventListener("click",()=>{w.navigate("login")}),document.getElementById("registerBtn").addEventListener("click",()=>{w.navigate("register")})}},Pe={currentUser:null,isLogin:!0,render(){return`
	<img src="/pong-logo.png" alt="PONG Logo" class="h-auto w-auto pl-2 pr-2 pt-2"/>
	...
	${on()}
  `},init(){Qt();const t=document.getElementById("tournamentBtn");t==null||t.addEventListener("click",()=>{w.navigate("tournament")});const e=document.getElementById("oneVsOneBtn");e==null||e.addEventListener("click",()=>{v.inGame=!0,w.navigate("game")});const n=document.getElementById("oneVsAIBtn");n==null||n.addEventListener("click",()=>{v.inGame=!0,w.navigate("gameai")})}};async function O(){const t=await en(),e=document.getElementById("sidebar");t?(console.log("✅ Connected"),e.innerHTML=Pe.render(),Pe.init(),nn(),_t(),Ot()):(e.innerHTML=Le.render(),Le.init(),console.log("❌ Not connected"))}const y=class y{renderGameCanvas(){let e=document.getElementById("gamesArea"),n=document.getElementById("oneVsOneArea"),s=document.getElementById("oneVsAIArea");const i=new $().render();e&&(e.innerHTML=i,s==null||s.classList.add("hidden"),n==null||n.classList.add("hidden"),e.classList.remove("hidden"))}async initGame(e){await y.cleanup();const n=document.getElementById("gameArea");n==null||n.classList.add("hidden"),y.noWinner=!0,await this.playGame(e)}showWinner(e,n){const s=document.getElementById("gamesArea");let i=e.winner?e.winner.alias:"";if(y.gameType==="p-vs-ai"&&n&&(i="ChatGPT"),console.log("type is=== ",n,`
winner is===`,i),s&&e.winner){s.innerHTML=`            
                ...
                `,s.classList.remove("hidden"),s.style.display="block";const o=document.getElementById("reset-btn");o==null||o.addEventListener("click",()=>{w.navigate("home")})}}playGame(e){return new Promise(async()=>{if(!y.isCreatingGame){y.isCreatingGame=!0;try{y.currentGame&&(y.currentGame.stopGame(),y.currentGame=null,await new Promise(s=>setTimeout(s,50))),await O(),this.renderGameCanvas(),await new Promise(s=>setTimeout(s,100));const n=new Te({leftPlayer:e.player1.alias,rightPlayer:e.player2.alias,maxScore:parseInt(C.scoreLimit),gameMode:y.gameType,aiDifficulty:Nt(),onFinish:(s,i,o)=>{if(console.log(i,o),e.player1.score=i,e.player2.score=o,e.winner=e.player1.alias===s?e.player1:e.player2,console.log("entra en onMatchEnd"),Se(y.gameType,e),y.noWinner&&window.location.pathname==="/game")if(e.winner.alias&&e.winner.alias!==void 0){this.showWinner(e,o>i);let a=document.getElementById("winner-screen");a==null||a.classList.remove("hidden"),y.noWinner=!1}else window.location.pathname==="/game"&&w.navigate("home");else window.location.pathname==="/game"&&w.navigate("home");y.currentGame=null,n.resetGame()}});y.currentGame=n,n.resetGame(),n.setGameOn(),n.start()}finally{y.isCreatingGame=!1}}})}static async cleanup(){for(;y.isCreatingGame;)await new Promise(e=>setTimeout(e,10));y.currentGame&&(y.currentGame.stopGame(),y.currentGame=null),y.noWinner=!0,y.inGame=!1}};l(y,"gameType","p-vs-p"),l(y,"getAIDifficulty"),l(y,"getMaxScore"),l(y,"inGame",!1),l(y,"noWinner",!0),l(y,"gameController",!0),l(y,"otherPlayer","Erik"),l(y,"currentGame",null),l(y,"isCreatingGame",!1);let v=y;const Ie={currentUser:null,isLogin:!0,render(){return`
	...
	`},async init(){const t=document.getElementById("playBtn");t==null||t.addEventListener("click",()=>{v.gameType="p-vs-p",v.inGame=!0,w.navigate("game")})}};function Ue(){return`
	...
	`}const ie={currentUser:null,isLogin:!0,render(){return`
	...
	`}const oe={currentUser:null,isLogin:!0,render(){return`
	...
	`},init(){yt()}},Be={currentUser:null,isLogin:!0,render(){return`
  ...
  `},async init(){await O(),Ie.init()}};async function cn(){if(console.log("1 - Login service initialized"),(await fetch("/api/auth/me/status",{credentials:"include"}).then(n=>n.json())).authenticated){w.navigate("home"),m("You are already connected. You can't access the login page.","popup");return}const e=document.getElementById("connectionBtn");e.addEventListener("click",async()=>{const n=document.getElementById("login").value.trim(),s=document.getElementById("password").value;e.disabled=!0;try{const i=await fetch("/api/auth/users/check",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({login:n,password:s}),credentials:"include"}),o=await i.json();if(console.log("login info:",{loginData:o}),!i.ok||o.success===!1){m(o.error||"Login failed","popup");return}if(o.requires2FA){const a=document.getElementById("loginCredentials"),r=document.getElementById("twofa-container");if(a&&r&&(r.innerHTML="",a.classList.add("hidden"),r.classList.remove("hidden"),r.querySelector("*")===null)){console.log("Attempting TwoFAController creation");const h=new le(o.mail,async()=>{console.log("2FA Success callback triggered"),a.classList.add("hidden"),r.classList.add("hidden"),ae(o.login,o.userId)},r,(u,p)=>{console.log(`2FA Error: ${u}`,p),m(u,"popup"),p&&(document.cookie="auth_phase=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;",document.cookie="auth_token=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;",sessionStorage.setItem("loginError",u),document.getElementById("password").value="",a&&a.classList.remove("hidden"),r&&r.classList.add("hidden"))}).init();r.appendChild(h)}}else ae(n,o.userId)}catch(i){m("Network error during login","popup"),console.error("Login error:",i)}finally{e.disabled=!1}})}async function ae(t,e){try{const n=await fetch("/api/auth/users/sessions",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({userId:e})});if(!n.ok)throw new Error("Token generation failed");localStorage.setItem("login",t),console.log(`in loginService tokenRes = ${n}`),U("login_initiated",{login_id:"login-"+Date.now(),player_username:t}),w.navigate("home"),z("You are logged in",3500,"popup")}catch(n){console.error("Login completion error:",n),m("Login complete but couldn't load session","popup"),w.navigate("home")}}const Ce={render:()=>`
  	<div class="w-screen h-screen flex bg-[#fbd11b] overflow-hidden">
  ...
  `,async init(){await O(),Q("password","togglePasswordLogin","eyeIconClosedLogin","eyeIconOpenedLogin"),cn(),un(),document.getElementById("backToRegister").addEventListener("click",()=>w.navigate("register"))}};function un(){google.accounts.id.initialize({client_id:"11816073281-ka847kttjiaqlci012l9p7kpip87kocr.apps.googleusercontent.com",callback:gn}),google.accounts.id.renderButton(document.getElementById("googleConnectionBtn"),{theme:"outline",size:"large",text:"signin_with",shape:"rectangular",width:315})}async function gn(t){console.log("ID Google Token:",t.credential);const n=await(await fetch("/api/auth/google",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({id_token:t.credential})})).json();console.log("Internal JWT:",n.success),console.log(`Gprovider = ${n.provider}`),n.success||m("Google SignIn failed","popup"),hn()}async function hn(){const t=await fetch("/api/auth/googleSession",{method:"POST",credentials:"include"});if(t.status===401){console.log("Not authenticated");return}const e=await t.json();console.log(`data = ${e}`),console.log(`data.provider = ${e.provider}`),t.status===201&&(console.log(`data.name = ${e.login}, data.userId = ${e.userId}`),ae(e.login,e.userId)),console.log("Protected data:",e)}async function mn(){if(console.log("1 - Registration service initialized"),(await fetch("/api/auth/me/status",{credentials:"include"}).then(i=>i.json())).authenticated){w.navigate("home"),m("You are already connected. You can't access the register page.","popup");return}const e=document.getElementById("anonymizedCheckbox");let n=!1;e.addEventListener("change",()=>{n=e.checked,console.log("Anonymisation enabled:",n)});const s=document.getElementById("createAccountBtn");s.addEventListener("click",async()=>{const i=document.getElementById("newUsername").value.trim(),o=document.getElementById("newMail").value,a=document.getElementById("newPassword").value,r=document.getElementById("confirmPassword").value;if(!i){m("Username is required","popup");return}if(!o){m("Email is required","popup");return}if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(o)){m("Please enter a valid email address","popup");return}if(!a){m("Password is required","popup");return}if(!r){m("Please confirm your password","popup");return}if(a!==r){m("Passwords do not match","popup");return}if(i.length>40||a.length>40||o.length>40){m("Inputs should contain no more than 40 caracters","popup");return}s.disabled=!0,console.log(`in initRegistrationService => anonymisationEnabled = ${n}`);try{const h=await fetch("/api/auth/users/verify",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({login:i,mail:o,anonymisationEnabled:n}),credentials:"include"}),u=await h.json();if(!h.ok||u.success===!1){m(u.error||"Registration failed","popup");return}if(u.requires2FA){const p=document.getElementById("registerForm"),f=document.getElementById("twofa-container");if(console.log("Pre-Check:",{regFormExists:!!p,twofaContainerExists:!!f,regData:u}),!p||!f){m(u.error||"Registration form problem","popup");return}if(f.innerHTML="",p.classList.add("hidden"),f.classList.remove("hidden"),f.querySelector("*")===null){const E=new le(o,async()=>{p.classList.add("hidden"),f.classList.add("hidden"),ke(i,o,a,n)},f,(P,L)=>{m(P,"popup"),L&&(document.cookie="auth_phase=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;",document.cookie="auth_token=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;",sessionStorage.setItem("registerError",P),document.getElementById("newPassword").value="",p&&p.classList.remove("hidden"),f&&f.classList.add("hidden"))}).init();f.appendChild(E)}}else ke(i,o,a,n)}catch(h){m("Network error during registration","popup"),console.error("Registration error:",h)}finally{s.disabled=!1}})}async function ke(t,e,n,s){try{if(!(await fetch("/api/auth/users",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({password:n,anonymisationEnabled:s})})).ok)throw new Error("Token generation failed");localStorage.setItem("login",t),U("new_account_created",{register_id:"new_account_created-"+Date.now(),player_username:t,mail_user:e,GDPR_user:s}),z("Account created successfully",3500,"popup"),w.navigate("login")}catch(i){console.error("Registration completion error:",i),m("Account created but session could not be loaded","popup"),w.navigate("home")}}const De={render:()=>`
    <div class="w-screen h-screen flex bg-[#fbd11b] overflow-hidden">
  ...
  `,async init(){await O(),Q("newPassword","togglePassword","eyeIconClosed","eyeIconOpened"),Q("confirmPassword","toggleConfirmPassword","confirmEyeIconClosed","confirmEyeIconOpened"),mn(),document.body.insertAdjacentHTML("beforeend",pn()),fn(),document.getElementById("backToLogin").addEventListener("click",()=>{w.navigate("login")})}};function pn(){return`
	...
	`}function fn(){const t=document.getElementById("policiesPopup"),e=document.getElementById("showPoliciesBtn"),n=document.getElementById("closePoliciesBtn");!t||!e||!n||(e.addEventListener("click",()=>t.classList.remove("hidden")),n.addEventListener("click",()=>t.classList.add("hidden")),t.addEventListener("click",s=>{s.target===t&&t.classList.add("hidden")}))}const Ae={render(){return`
	<div class="w-screen h-screen flex bg-[#fbd11b] overflow-hidden">
  ...
  `},async init(){await O(),ie.init(),oe.init();const t=document.getElementById("gameArea"),e=document.getElementById("oneVsOneArea"),n=document.getElementById("oneVsAIArea"),s=document.getElementById("player1"),i=document.getElementById("player2"),o=document.getElementById("player1VSAI");let a=i;console.log(v.gameType),t==null||t.classList.add("hidden"),v.gameType==="p-vs-p"?(e==null||e.classList.remove("hidden"),n==null||n.classList.add("hidden")):v.gameType==="p-vs-ai"&&(a=o,v.otherPlayer=a.value,e==null||e.classList.add("hidden"),n==null||n.classList.remove("hidden")),!a&&!s&&new v().initGame({player1:{alias:"User 1"},player2:{alias:"User 2"},winner:null})}},N=class N{static navigate(e,n=!0){if(!this.app){console.error("App container not found");return}switch(e){case"home":v.cleanup(),v.gameController=!1,this.app.innerHTML=Be.render(),Be.init();break;case"login":v.cleanup(),this.app.innerHTML=Ce.render(),Ce.init();break;case"register":v.cleanup(),this.app.innerHTML=De.render(),De.init();break;case"game":if(!v.inGame){N.navigate("home"),v.inGame=!1;return}v.gameType="p-vs-p",this.app.innerHTML=Y.render(),Y.init();break;case"gameai":v.inGame=!0,v.gameType="p-vs-ai",this.app.innerHTML=Y.render(),Y.init();break;case"tournament":console.log("router"),this.app.innerHTML=Ae.render(),Ae.init();break}n&&history.pushState({},"",e==="home"?"/":`/${e}`)}static resolveRoute(e){return e.includes("login")?"login":e.includes("register")?"register":e.includes("gameai")?"gameai":e.includes("game")?"game":e.includes("tournament")?"tournament":"home"}static init(){window.addEventListener("load",()=>{const e=this.resolveRoute(window.location.pathname);this.navigate(e,!1)}),window.addEventListener("popstate",()=>{const e=this.resolveRoute(window.location.pathname);this.navigate(e,!1)}),window.addEventListener("popstate",e=>{console.log("History changed:",e.state)})}};l(N,"app",document.getElementById("app")),l(N,"currentUser");let w=N;w.init();window.addEventListener("load",()=>{const t=window.location.pathname;w.navigate(t.includes("login")?"login":t.includes("register")?"register":t.includes("game")?"game":t.includes("tournament")?"tournament":"home",!1)});window.addEventListener("popstate",()=>{const t=window.location.pathname;w.navigate(t.includes("login")?"login":t.includes("register")?"register":t.includes("game")?"game":t.includes("tournament")?"tournament":"home",!1)});
