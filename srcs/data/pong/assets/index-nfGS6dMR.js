var $e=Object.defineProperty;var He=(t,e,n)=>e in t?$e(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n;var l=(t,e,n)=>He(t,typeof e!="symbol"?e+"":e,n);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function n(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(i){if(i.ep)return;i.ep=!0;const o=n(i);fetch(i.href,o)}})();function Ve(t){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t)}function X(t,e,n,s){const i=document.getElementById(t),o=document.getElementById(e),a=document.getElementById(n),r=document.getElementById(s);if(!i||!o||!r||!a)return;let d=!1;o.addEventListener("click",()=>{d=!d,i.type=d?"text":"password",r.classList.toggle("hidden",!d),a.classList.toggle("hidden",d)})}async function j(t,e=3500,n){const s=document.getElementById(n);s&&(s.classList.remove("bg-red-600"),s.classList.add("bg-green-600"),s.textContent=t,s.classList.remove("hidden"),setTimeout(()=>{s.classList.add("hidden")},e))}function g(t,e){const n=document.getElementById(e);n&&(n.classList.remove("bg-green-600"),n.classList.add("bg-red-600"),n.textContent=t,n.classList.remove("hidden"),setTimeout(()=>n.classList.add("hidden"),3500))}async function je(t){const e=new FormData;e.append("file",t);const n=await fetch("api/auth/uploadProfilePicture",{method:"POST",body:e,credentials:"include"}),s=await n.json();if(!n.ok||!s.success){console.error("Error on upload:",s),alert(`Error: ${s.error||"failed to store the picture."}`);return}}async function Ue(){return(await(await fetch("/api/auth/me",{credentials:"include"})).json()).user}class Ne{constructor(){l(this,"players",[]);l(this,"semifinal1",null);l(this,"semifinal2",null);l(this,"finalMatch",null);l(this,"winner",null)}addPlayer(e){this.players.push({alias:e})}isReady(){return this.players.length===4}generateMatches(){this.semifinal1={player1:{...this.players[0]},player2:{...this.players[1]},winner:null},this.semifinal2={player1:{...this.players[2]},player2:{...this.players[3]},winner:null}}generateFinal(){var e,n;(e=this.semifinal1)!=null&&e.winner&&((n=this.semifinal2)!=null&&n.winner)&&(this.finalMatch={player1:this.semifinal1.winner,player2:this.semifinal2.winner,winner:null})}setWinner(e){this.winner=e}saveToLocalStorage(){var n;const e=JSON.parse(localStorage.getItem("torneos")||"[]");e.push({jugadores:this.players.map(s=>s.alias),ganador:(n=this.winner)==null?void 0:n.alias,fecha:new Date().toISOString()}),localStorage.setItem("torneos",JSON.stringify(e))}}let L=null;function qe(t){L=t}function J(){L=null}function Pe(){return L}let z=null;function ze(t){z=t}function We(){return z}let Ye=class{showPreGame(e,n){return new Promise(s=>{const i=document.getElementById("game-overlay"),o=document.getElementById("pre-game-screen"),a=document.getElementById("player-vs-player"),r=document.getElementById("countdown-text");r.textContent="",a.textContent=`${e} vs ${n}`,o==null||o.classList.remove("hidden"),i==null||i.classList.remove("hidden"),i==null||i.classList.add("flex"),setTimeout(()=>{o==null||o.classList.add("hidden"),s()},3e3)})}startCountdown(){return new Promise(e=>{const n=document.getElementById("game-overlay"),s=document.getElementById("pre-game-screen"),i=document.getElementById("countdown-screen"),o=document.getElementById("countdown-text");s==null||s.classList.add("hidden"),i==null||i.classList.remove("hidden");let a=3;o.textContent=String(a);const r=setInterval(()=>{a--,a>0?o.textContent=String(a):a===0?o.textContent="GO!":(clearInterval(r),n==null||n.classList.add("hidden"),n==null||n.classList.remove("flex"),e())},1e3)})}updateBracket(e){var n,s,i,o,a,r,d,m,u,p,v,E,w,x,I,T;if(e.semifinal1){const f=e.semifinal1,P=document.querySelector("#alias1"),D=document.querySelector("#alias1-point"),S=document.querySelector("#alias2"),G=document.querySelector("#alias2-point");if(console.log(f),P.value=f.player1.alias,S.value=f.player2.alias,P.disabled=!0,S.disabled=!0,D.textContent=((n=f.player1.score)==null?void 0:n.toString())??"0",G.textContent=((s=f.player2.score)==null?void 0:s.toString())??"0",f.winner){const $=document.querySelector("#final2");$&&($.textContent=f.winner.alias),f.winner.alias===f.player1.alias?(i=P.closest(".flex"))==null||i.classList.add("winner-bg"):(o=S.closest(".flex"))==null||o.classList.add("winner-bg")}}if(e.semifinal2){const f=e.semifinal2;console.log(f);const P=document.querySelector("#alias3"),D=document.querySelector("#alias4"),S=document.querySelector("#alias3-point"),G=document.querySelector("#alias4-point");if(P.value=f.player1.alias,D.value=f.player2.alias,P.disabled=!0,D.disabled=!0,S.textContent=((a=f.player1.score)==null?void 0:a.toString())??"0",G.textContent=((r=f.player2.score)==null?void 0:r.toString())??"0",(d=P.closest(".flex"))==null||d.classList.remove("winner-bg"),(m=D.closest(".flex"))==null||m.classList.remove("winner-bg"),f.winner){const $=document.querySelector("#final1");$&&($.textContent=f.winner.alias),f.winner.alias===f.player1.alias?(u=P.closest(".flex"))==null||u.classList.add("winner-bg"):(p=D.closest(".flex"))==null||p.classList.add("winner-bg")}}if(e.finalMatch){const f=e.finalMatch,P=document.querySelector("#final1"),D=document.querySelector("#final2"),S=document.querySelector("#final1-point"),G=document.querySelector("#final2-point");P.textContent=f.player1.alias,D.textContent=f.player2.alias,S.textContent=((v=f.player1.score)==null?void 0:v.toString())??"0",G.textContent=((E=f.player2.score)==null?void 0:E.toString())??"0",(w=P.closest(".flex"))==null||w.classList.remove("winner-bg"),(x=D.closest(".flex"))==null||x.classList.remove("winner-bg"),f.winner&&(f.winner.alias===f.player1.alias?(I=P.closest(".flex"))==null||I.classList.add("winner-bg"):(T=D.closest(".flex"))==null||T.classList.add("winner-bg"))}}showTournamentWinner(e){const n=document.getElementById("game-overlay"),s=document.getElementById("winner-screen"),i=document.getElementById("winner-name"),o=document.getElementById("countdown-screen");i.textContent=e,s==null||s.classList.remove("hidden"),n==null||n.classList.remove("hidden"),n==null||n.classList.add("flex"),o==null||o.classList.add("hidden"),document.getElementById("showResumBtn").onclick=()=>{let a=document.getElementById("game-overlay");a==null||a.classList.add("hidden");let r=document.getElementById("nextMatchBtn");r==null||r.classList.add("hidden");let d=document.getElementById("resetTournamentBtn");d&&d.classList.remove("hidden")},document.getElementById("resetTournamentBtn").onclick=()=>{let a=document.getElementById("game-overlay");a==null||a.classList.add("hidden");let r=document.getElementById("nextMatchBtn");r==null||r.classList.add("hidden"),y.navigate("home")}}};const _=new Ye,Ze=.02;class le{constructor(e){l(this,"paddleElem");l(this,"_position",50);this.paddleElem=e,this.reset()}get position(){return this._position}set position(e){this._position=e,this.updatePosition()}updatePosition(){const e=2+this._position*.96;this.paddleElem.style.top=`${e}vh`}rect(){return this.paddleElem.getBoundingClientRect()}reset(){this.position=50}update(e,n){this.position+=Ze*e*(n-this.position);const s=5;this.position=Math.max(s,Math.min(100-s,this.position))}highlight(){this.paddleElem.style.backgroundColor="#EDD24E",setTimeout(()=>{this.paddleElem.style.backgroundColor="#D9D9D9"},150)}}const de=.055,Xe=1.1,Je=.1;class Ke{constructor(e){l(this,"ballElem");l(this,"direction",{x:0,y:0});l(this,"velocity",de);l(this,"_x",50);l(this,"_y",50);this.ballElem=e,this.reset()}get x(){return this._x}set x(e){this._x=e,this.updatePosition()}get y(){return this._y}set y(e){this._y=e,this.updatePosition()}updatePosition(){const e=(this._x-50)*.88,n=(this._y-50)*.96;this.ballElem.style.transform=`translate(${e}vw, ${n}vh)`}get directionX(){return this.direction.x}get directionY(){return this.direction.y}get ballVelocity(){return this.velocity}rect(){return this.ballElem.getBoundingClientRect()}reset(){for(this.x=50,this.y=50,this.direction={x:0,y:0};Math.abs(this.direction.x)<=.3||Math.abs(this.direction.x)>=.8;){const e=Qe(0,2*Math.PI);this.direction={x:Math.cos(e),y:Math.sin(e)}}this.velocity=de}bounceVertical(){this.direction.y*=-1,this.direction.y<0?this.direction.y-=.1:this.direction.y+=.1}update(e,n,s){const i=[n.rect(),s.rect()];this.x+=this.direction.x*this.velocity*e,this.y+=this.direction.y*this.velocity*e;const o=this.rect(),a=window.innerHeight*.02,r=window.innerHeight*.98;(o.bottom>=r||o.top<=a)&&this.bounceVertical(),i.forEach(d=>{if(et(d,o)){const m=o.top+o.height/2,u=d.top+d.height/2,p=d.height,v=(m-(u-p/2))/p,E=Math.max(0,Math.min(1,v)),w=Math.PI/3,x=(E-.5)*2*w,I=Math.sqrt(this.direction.x*this.direction.x+this.direction.y*this.direction.y);d.left<window.innerWidth/2?(n.highlight(),this.direction.x=Math.cos(x)*I,this.direction.y=Math.sin(x)*I):(s.highlight(),this.direction.x=-Math.cos(x)*I,this.direction.y=Math.sin(x)*I);const T=Math.sqrt(this.direction.x*this.direction.x+this.direction.y*this.direction.y);this.direction.x/=T,this.direction.y/=T,this.velocity=Math.min(this.velocity*Xe,Je)}})}}function Qe(t,e){return Math.random()*(e-t)+t}function et(t,e){return t.left<=e.right&&t.right>=e.left&&t.top<=e.bottom&&t.bottom>=e.top}class c{}l(c,"MAX_SCORE",5),l(c,"PADDLE_SPEED",.08),l(c,"FRAME_RATE_LIMIT",8.33),l(c,"AI_UPDATE_COOLDOWN",1e3),l(c,"AI_TARGET_THRESHOLD",2),l(c,"AI_MOVEMENT_THRESHOLD",1),l(c,"AI_MAX_SIMULATION_STEPS",10),l(c,"GAME_AREA_TOP_PERCENT",2),l(c,"GAME_AREA_BOTTOM_PERCENT",98),l(c,"PADDLE_BOUNDARY_TOP",4),l(c,"PADDLE_BOUNDARY_BOTTOM",92),l(c,"SIDEBAR_WIDTH",64),l(c,"RIGHT_MARGIN_VW",.02),l(c,"PADDLE_X_OFFSET",30),l(c,"BALL_SCALING_FACTOR",.0088),l(c,"DEFAULT_LEFT_PLAYER","Erik"),l(c,"DEFAULT_RIGHT_PLAYER","Simon");var H=(t=>(t.MOVE_LEFT_UP="w",t.MOVE_LEFT_DOWN="s",t.MOVE_RIGHT_UP="ArrowUp",t.MOVE_RIGHT_DOWN="ArrowDown",t.PAUSE=" ",t))(H||{});class tt{constructor(e){l(this,"keys",{w:!1,s:!1,ArrowUp:!1,ArrowDown:!1," ":!1});l(this,"onPauseToggle");this.onPauseToggle=e,this.setupEventListeners()}setupEventListeners(){document.addEventListener("keydown",e=>{var s;const n=this.getKeyFromEvent(e);n&&(n===" "&&!this.keys[" "]&&((s=this.onPauseToggle)==null||s.call(this)),this.keys[n]=!0)}),document.addEventListener("keyup",e=>{const n=this.getKeyFromEvent(e);n&&(this.keys[n]=!1)})}getKeyFromEvent(e){const n=e.key.toLowerCase();return n==="w"||n==="s"?n:e.key==="ArrowUp"||e.key==="ArrowDown"?e.key:e.key===" "?" ":null}isPressed(e){return this.keys[e]}getKeyState(){return{...this.keys}}}var C=(t=>(t.LEFT="left",t.RIGHT="right",t))(C||{});class nt{constructor(){l(this,"leftAI",{target:50,lastUpdate:0,isEnabled:!0});l(this,"rightAI",{target:50,lastUpdate:0,isEnabled:!0})}enableAI(e){e==="left"?this.leftAI.isEnabled=!0:this.rightAI.isEnabled=!0}disableAI(e){(e==="left"||!e)&&(this.leftAI.isEnabled=!1),(e==="right"||!e)&&(this.rightAI.isEnabled=!1)}isEnabled(e){return e==="left"?this.leftAI.isEnabled:this.rightAI.isEnabled}getTarget(e){return e==="left"?this.leftAI.target:this.rightAI.target}updateAI(e,n){const s=e.directionX;if(this.leftAI.isEnabled&&s<0&&n-this.leftAI.lastUpdate>=c.AI_UPDATE_COOLDOWN){const i=this.predictBallLanding(e,"left");Math.abs(i-this.leftAI.target)>c.AI_TARGET_THRESHOLD&&(this.leftAI.target=i,this.leftAI.lastUpdate=n)}if(this.rightAI.isEnabled&&s>0&&n-this.rightAI.lastUpdate>=c.AI_UPDATE_COOLDOWN){const i=this.predictBallLanding(e,"right");Math.abs(i-this.rightAI.target)>c.AI_TARGET_THRESHOLD&&(this.rightAI.target=i,this.rightAI.lastUpdate=n)}}predictBallLanding(e,n){const s=e.x*1e3,i=e.y*1e3,o=e.directionX*1e3,a=e.directionY*1e3,r=window.innerWidth-c.SIDEBAR_WIDTH-window.innerWidth*c.RIGHT_MARGIN_VW,d=c.PADDLE_X_OFFSET,m=r-c.PADDLE_X_OFFSET,u=r/2,p=window.innerWidth*c.BALL_SCALING_FACTOR,v=((d-u)/p+50)*1e3,E=((m-u)/p+50)*1e3,w=n==="left"?v:E;return n==="left"&&o>=0||n==="right"&&o<=0?50:this.simulateBallTrajectoryGeometric(s,i,o,a,w)/1e3}simulateBallTrajectoryGeometric(e,n,s,i,o){let a=e,r=n,d=s,m=i;const u=c.GAME_AREA_TOP_PERCENT*1e3,p=c.GAME_AREA_BOTTOM_PERCENT*1e3,v=c.PADDLE_BOUNDARY_TOP*1e3,E=c.PADDLE_BOUNDARY_BOTTOM*1e3;let w=0;for(;w<c.AI_MAX_SIMULATION_STEPS;){if(Math.abs(d)<1||(o-a)/d<=0)return Math.max(v,Math.min(E,r));const I=(o-a)*(m/d),T=r+I;if(T<u&&m<0){const f=u-r;a=a+f*(d/m),r=u,m*=-1,m<0?m-=100:m+=100}else if(T>p&&m>0){const f=p-r;a=a+f*(d/m),r=p,m*=-1,m<0?m-=100:m+=100}else return Math.max(v,Math.min(E,T));w++}return Math.max(v,Math.min(E,r))}}var q=(t=>(t[t.CONTINUE=0]="CONTINUE",t[t.LEFT_WINS=1]="LEFT_WINS",t[t.RIGHT_WINS=2]="RIGHT_WINS",t[t.LEFT_SCORES=3]="LEFT_SCORES",t[t.RIGHT_SCORES=4]="RIGHT_SCORES",t))(q||{});class st{constructor(e,n,s=c.MAX_SCORE){l(this,"leftPlayerScoreElem");l(this,"rightPlayerScoreElem");l(this,"scores",{left:0,right:0});l(this,"maxScore");this.leftPlayerScoreElem=e,this.rightPlayerScoreElem=n,this.maxScore=s,this.updateDisplay()}addScore(e){return e==="left"?this.scores.left++:this.scores.right++,this.updateDisplay(),this.scores.left>=this.maxScore?1:this.scores.right>=this.maxScore?2:e==="left"?3:4}reset(){this.scores={left:0,right:0},this.updateDisplay()}getScores(){return{...this.scores}}getScoreString(){return`${this.scores.left} - ${this.scores.right}`}updateDisplay(){this.leftPlayerScoreElem.textContent=this.scores.left.toString(),this.rightPlayerScoreElem.textContent=this.scores.right.toString()}}class k{constructor(e,n,s,i,o,a,r){l(this,"pauseOverlay");l(this,"pauseBtn");l(this,"playBtn");l(this,"gameArea");l(this,"leftPlayer");l(this,"rightPlayer");l(this,"onPauseToggle");this.pauseOverlay=e,this.pauseBtn=n,this.playBtn=s,this.gameArea=i,this.leftPlayer=o,this.rightPlayer=a,this.onPauseToggle=r,this.setupEventListeners()}setupEventListeners(){this.pauseBtn.addEventListener("click",()=>{var e;(e=this.onPauseToggle)==null||e.call(this)}),this.playBtn.addEventListener("click",()=>{var e;(e=this.onPauseToggle)==null||e.call(this)})}showPauseOverlay(){this.pauseOverlay.classList.remove("hidden"),this.gameArea.classList.add("blur-[9px]")}hidePauseOverlay(){this.pauseOverlay.classList.add("hidden"),this.gameArea.classList.remove("blur-[9px]")}setPlayerNames(e,n){this.leftPlayer.textContent=e,this.rightPlayer.textContent=n}static getElement(e){const n=document.getElementById(e);if(!n)throw new Error(`Required DOM element with id "${e}" not found`);return n}}class Ie{constructor(e){l(this,"options");l(this,"gameId");l(this,"isPaused",!1);l(this,"gameOn",!1);l(this,"lastTime");l(this,"isGameActive",!0);l(this,"animationFrameId",null);l(this,"ball");l(this,"leftPlayerPaddle");l(this,"rightPlayerPaddle");l(this,"inputManager");l(this,"aiManager");l(this,"scoreManager");l(this,"uiManager");l(this,"ballElement");l(this,"leftPaddleElement");l(this,"rightPaddleElement");l(this,"onFinishCallback");e!=null&&e.maxScore&&(c.MAX_SCORE=e.maxScore),e!=null&&e.aiDifficulty&&(c.AI_UPDATE_COOLDOWN=e.aiDifficulty),this.gameId=`game-${Date.now()}-${Math.random().toString(36).substr(2,9)}`,console.log(`🎮 Creating new Game instance: ${this.gameId}`),this.options={leftPlayer:(e==null?void 0:e.leftPlayer)||c.DEFAULT_LEFT_PLAYER,rightPlayer:(e==null?void 0:e.rightPlayer)||c.DEFAULT_RIGHT_PLAYER,maxScore:(e==null?void 0:e.maxScore)||c.MAX_SCORE,gameMode:(e==null?void 0:e.gameMode)||"p-vs-p",onFinish:(e==null?void 0:e.onFinish)||void 0,aiDifficulty:(e==null?void 0:e.aiDifficulty)||c.AI_UPDATE_COOLDOWN},this.onFinishCallback=(e==null?void 0:e.onFinish)||null,this.initializeDOM(),this.initializeManagers(),this.initializeGameObjects(),this.setupDebugFunctions()}initializeDOM(){this.ballElement=k.getElement("ball"),this.leftPaddleElement=k.getElement("left-paddle"),this.rightPaddleElement=k.getElement("right-paddle")}initializeManagers(){const e=k.getElement("left-score"),n=k.getElement("right-score"),s=k.getElement("left-player"),i=k.getElement("right-player"),o=k.getElement("pause-overlay"),a=k.getElement("pause-btn"),r=k.getElement("play-btn"),d=k.getElement("game-area");this.inputManager=new tt(()=>this.togglePause()),this.aiManager=new nt,this.scoreManager=new st(e,n,this.options.maxScore),this.uiManager=new k(o,a,r,d,s,i,()=>this.togglePause()),this.configureGameMode(),this.uiManager.setPlayerNames(this.options.leftPlayer,this.options.rightPlayer)}configureGameMode(){switch(this.options.gameMode){case"p-vs-ai":this.options.rightPlayer="ChatGPT",this.options.leftPlayer=h.otherPlayer,this.aiManager.disableAI(C.LEFT);break;case"ai-vs-p":this.options.leftPlayer="Gemini",this.aiManager.disableAI(C.RIGHT);break;case"p-vs-p":this.aiManager.disableAI(C.LEFT),this.aiManager.disableAI(C.RIGHT);break;case"ai-vs-ai":this.options.leftPlayer="ChatGPT",this.options.rightPlayer="Gemini";break}}initializeGameObjects(){this.ball=new Ke(this.ballElement),this.leftPlayerPaddle=new le(this.leftPaddleElement),this.rightPlayerPaddle=new le(this.rightPaddleElement)}togglePause(){this.isPaused=!this.isPaused,this.isPaused?this.uiManager.showPauseOverlay():this.uiManager.hidePauseOverlay()}setGameOn(){this.gameOn=!0}enableAILeft(){this.aiManager.enableAI(C.LEFT)}enableAIRight(){this.aiManager.enableAI(C.RIGHT)}disableAI(){this.aiManager.disableAI()}resetGame(){this.scoreManager.reset(),this.leftPlayerPaddle.reset(),this.rightPlayerPaddle.reset(),this.ball.reset(),this.isPaused=!1,h.gameController=!1}stopGame(){console.log(`🛑 Stopping Game instance: ${this.gameId}`),this.isGameActive=!1,this.gameOn=!1,this.isPaused=!0,this.animationFrameId!==null&&(cancelAnimationFrame(this.animationFrameId),this.animationFrameId=null,console.log(`🎬 Cancelled animation frame for Game: ${this.gameId}`)),this.lastTime=void 0,this.resetGame()}get gameAreaTop(){return c.GAME_AREA_TOP_PERCENT}get gameAreaBottom(){return c.GAME_AREA_BOTTOM_PERCENT}get getBall(){return this.ball}get getLeftPaddle(){return this.leftPlayerPaddle}get getRightPaddle(){return this.rightPlayerPaddle}setupDebugFunctions(){window.enableAILeft=()=>this.enableAILeft(),window.enableAIRight=()=>this.enableAIRight(),window.disableAI=()=>this.disableAI()}start(){console.log(`▶️ Starting Game instance: ${this.gameId}`);const e=n=>{if(!this.isGameActive||!h.noWinner||!this.gameOn){console.log(`⏹️ Game loop stopping for Game: ${this.gameId} (isActive: ${this.isGameActive}, noWinner: ${h.noWinner}, gameOn: ${this.gameOn})`),window.addEventListener("popstate",s=>{J(),y.navigate("home"),console.log("History changed:",s.state)}),this.resetGame(),this.animationFrameId=null;return}if(this.lastTime!=null){const s=n-this.lastTime;if(s<c.FRAME_RATE_LIMIT){this.animationFrameId=window.requestAnimationFrame(e);return}this.isPaused||(this.ball.update(s,this.leftPlayerPaddle,this.rightPlayerPaddle),this.aiManager.updateAI(this.ball,n),this.updateLeftPlayerPaddle(s),this.updateRightPlayerPaddle(s),this.isLose()&&(console.log(`⚽ Ball lost in Game: ${this.gameId}`),this.handleLose()))}this.lastTime=n,this.animationFrameId=window.requestAnimationFrame(e)};this.animationFrameId=window.requestAnimationFrame(e)}updateLeftPlayerPaddle(e){if(this.aiManager.isEnabled(C.LEFT)){const n=this.leftPlayerPaddle.position,i=this.aiManager.getTarget(C.LEFT)-n;if(Math.abs(i)>c.AI_MOVEMENT_THRESHOLD){const o=i>0?1:-1,a=n+o*c.PADDLE_SPEED*e;this.leftPlayerPaddle.position=Math.max(c.PADDLE_BOUNDARY_TOP,Math.min(c.PADDLE_BOUNDARY_BOTTOM,a))}return}this.inputManager.isPressed(H.MOVE_LEFT_UP)?this.leftPlayerPaddle.position=Math.max(c.PADDLE_BOUNDARY_TOP,this.leftPlayerPaddle.position-c.PADDLE_SPEED*e):this.inputManager.isPressed(H.MOVE_LEFT_DOWN)&&(this.leftPlayerPaddle.position=Math.min(c.PADDLE_BOUNDARY_BOTTOM,this.leftPlayerPaddle.position+c.PADDLE_SPEED*e))}updateRightPlayerPaddle(e){if(this.aiManager.isEnabled(C.RIGHT)){const n=this.rightPlayerPaddle.position,i=this.aiManager.getTarget(C.RIGHT)-n;if(Math.abs(i)>c.AI_MOVEMENT_THRESHOLD){const o=i>0?1:-1,a=n+o*c.PADDLE_SPEED*e;this.rightPlayerPaddle.position=Math.max(c.PADDLE_BOUNDARY_TOP,Math.min(c.PADDLE_BOUNDARY_BOTTOM,a))}return}this.inputManager.isPressed(H.MOVE_RIGHT_UP)?this.rightPlayerPaddle.position=Math.max(c.PADDLE_BOUNDARY_TOP,this.rightPlayerPaddle.position-c.PADDLE_SPEED*e):this.inputManager.isPressed(H.MOVE_RIGHT_DOWN)&&(this.rightPlayerPaddle.position=Math.min(c.PADDLE_BOUNDARY_BOTTOM,this.rightPlayerPaddle.position+c.PADDLE_SPEED*e))}isLose(){const e=this.ball.rect(),n=c.SIDEBAR_WIDTH,s=window.innerWidth-window.innerWidth*c.RIGHT_MARGIN_VW;return e.right>=s||e.left<=n}handleLose(){const e=this.ball.rect(),n=window.innerWidth-window.innerWidth*c.RIGHT_MARGIN_VW;let s;if(e.right>=n?s=this.scoreManager.addScore("left"):s=this.scoreManager.addScore("right"),s===q.LEFT_WINS||s===q.RIGHT_WINS){this.isPaused=!0;const i=s===q.LEFT_WINS?this.options.leftPlayer:this.options.rightPlayer;if(this.onFinishCallback){const o=this.scoreManager.getScores();this.isGameActive=!1,this.gameOn=!1,this.resetGame(),this.onFinishCallback(i,o.left,o.right)}}this.ball.reset()}}async function it(t,e){const n={service:"tournament-service",level:"INFO",event_type:t,timestamp:new Date().toISOString(),...e};try{await fetch("http://localhost:5051",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})}catch{console.log("LOG (fallback):",n)}}class ot{async iniciarTorneo(){var e,n;if(L!=null&&L.isReady()&&(it("tournament_created",{tournament_id:"tourn-"+Date.now(),players_count:4,player_aliases:"test"}),L==null||L.generateMatches(),await this.jugarPartido(L.semifinal1),_.updateBracket(L),this.mostrarVistaTorneo(),await this.esperarClickDelUsuario(),await this.jugarPartido(L.semifinal2),_.updateBracket(L),this.mostrarVistaTorneo(),await this.esperarClickDelUsuario(),(e=L.semifinal1)!=null&&e.winner&&((n=L.semifinal2)!=null&&n.winner))){L.generateFinal(),await this.jugarPartido(L.finalMatch);const s=L.finalMatch.winner;L.setWinner(s),_.updateBracket(L),this.mostrarVistaTorneo(),_.showTournamentWinner(s.alias),J()}}async esperarClickDelUsuario(){let e=document.getElementById("nextMatchBtn");e&&e.classList.remove("hidden");let n=document.getElementById("playtournamentBtn");return n&&n.classList.remove("inline-block"),new Promise(s=>{const i=document.getElementById("nextMatchBtn");if(!i){console.warn('Botón "Siguiente" no encontrado.'),s();return}const o=()=>{const a=document.querySelectorAll(".submenu");R(a),i.removeEventListener("click",o),s()};i.addEventListener("click",o)})}mostrarVistaTorneo(){const e=document.getElementById("esquemaTorneo"),n=document.getElementById("gameCanvasContainer");e&&(e.style.display="block"),n&&(n.style.display="none")}mostrarVistaJuego(){const e=document.getElementById("esquemaTorneo"),n=document.getElementById("gameCanvasContainer");e&&(e.style.display="none"),n&&(n.style.display="block")}jugarPartido(e){return new Promise(async n=>{if(!h.isCreatingGame){h.isCreatingGame=!0;try{h.currentGame&&(h.currentGame.stopGame(),h.currentGame=null,await new Promise(i=>setTimeout(i,50))),await _.showPreGame(e.player1.alias,e.player2.alias),await _.startCountdown(),this.mostrarVistaJuego(),y.navigate("tournament"),await new Promise(i=>setTimeout(i,100));const s=new Ie({leftPlayer:e.player1.alias,rightPlayer:e.player2.alias,maxScore:3,gameMode:"p-vs-p",onFinish:(i,o,a)=>{console.log(o,a),e.player1.score=o,e.player2.score=a,e.winner=e.player1.alias===i?e.player1:e.player2;const r=Pe();h.noWinner&&e.winner.alias&&e.winner.alias!==void 0?(r&&_.updateBracket(r),h.noWinner=!1):(J(),y.navigate("home")),n()}});h.currentGame=s,s.resetGame(),s.setGameOn(),s.start()}finally{h.isCreatingGame=!1}}})}}function at(){return`
...
<div id="game-overlay" class="absolute inset-0 bg-black/80 flex-col items-center justify-center hidden z-50">
      ...
      `},init(){const t=document.getElementById("playtournamentBtn");let e=localStorage.getItem("login");const n=document.querySelector("#alias1");n&&(n.value=e||""),t==null||t.addEventListener("click",()=>{let s=document.getElementById("alias1").value,i=document.getElementById("alias2").value,o=document.getElementById("alias3").value,a=document.getElementById("alias4").value;i.trim()||(i="user2"),o.trim()||(o="user3"),a.trim()||(a="user4");const r=document.getElementById("alias2"),d=document.getElementById("alias3"),m=document.getElementById("alias4");if(r&&(r.value=i),d&&(d.value=o),m&&(m.value=a),!Pe()){const w=new Ne;w.addPlayer(s),w.addPlayer(i),w.addPlayer(o),w.addPlayer(a),qe(w)}We()||ze({player1:s,player2:i,partidoActivo:!0,onMatchEnd:(w,x,I)=>{console.log(`Match ended. Winner: ${w}, Scores: ${x} - ${I}`)}}),t.classList.add("hidden"),new ot().iniciarTorneo(),y.navigate("tournament");const E=document.querySelectorAll(".submenu");R(E)})}};function lt(t,e){const n=document.getElementById(t),s=document.getElementById(e);if(n&&s){const i=n.value;n.value=s.value,s.value=i}}function dt(t,e){const n=document.getElementById(t),s=document.getElementById(e);if(!n||!s)return;const i=n.parentNode,o=n.nextSibling,a=s.nextSibling;o===s?i.insertBefore(s,n):a===n?i.insertBefore(n,s):(i.insertBefore(n,a),i.insertBefore(s,o))}function ke(){var a;const t=document.getElementById("oneVsOneBtn"),e=document.getElementById("gameArea"),n=document.getElementById("oneVsOneArea"),s=document.getElementById("oneVsAIArea"),i=document.getElementById("tournamentArea");t==null||t.addEventListener("click",()=>{e==null||e.classList.add("hidden"),n==null||n.classList.remove("hidden"),s==null||s.classList.add("hidden"),i==null||i.classList.add("hidden")}),(a=document.getElementById("swapBtn"))==null||a.addEventListener("click",()=>{lt("player1","player2")}),document.getElementById("playOneVsOneBtn").addEventListener("click",()=>{const r=document.getElementById("player1"),d=document.getElementById("player2");if(!r.value.trim()||!d.value.trim()){g("You need 2 players to play.","oneVsOneAreaPopup");return}h.gameType="p-vs-p",h.inGame=!0,y.navigate("game")})}function ct(){const t=document.getElementById("tournamentBtn"),e=document.getElementById("gameArea"),n=document.getElementById("tournamentArea"),s=document.getElementById("oneVsOneArea"),i=document.getElementById("oneVsAIArea"),o=document.getElementById("esquemaTorneo");t==null||t.addEventListener("click",()=>{e==null||e.classList.add("hidden"),s==null||s.classList.add("hidden"),i==null||i.classList.add("hidden"),n==null||n.classList.remove("hidden"),o==null||o.classList.remove("hidden"),Be.init()})}function Ce(){var r;const t=document.getElementById("oneVsAIBtn"),e=document.getElementById("gameArea"),n=document.getElementById("oneVsAIArea"),s=document.getElementById("oneVsOneArea"),i=document.getElementById("tournamentArea"),o=document.getElementById("esquemaTorneo");t==null||t.addEventListener("click",()=>{e==null||e.classList.add("hidden"),s==null||s.classList.add("hidden"),n==null||n.classList.remove("hidden"),i==null||i.classList.add("hidden"),o==null||o.classList.add("hidden")}),(r=document.getElementById("swapAIBtn"))==null||r.addEventListener("click",()=>{dt("player1VSAI","AIPlayer")}),document.getElementById("playOneVsAIBtn").addEventListener("click",()=>{if(!document.getElementById("player1VSAI").value.trim()){g("You need 1 player to play.","oneVsAIAreaPopup");return}h.gameType="p-vs-ai",h.inGame=!0,y.navigate("game")})}function ut(){const t=document.querySelectorAll(".submenu"),e=document.getElementById("playSidebarBtn");e==null||e.addEventListener("click",()=>{if(window.location.pathname==="/game"){const s=document.getElementById("gamesArea");s==null||s.classList.add("hidden"),h.noWinner=!1,y.navigate("home")}else V("playSubmenu",t),ke(),Ce(),ct()})}function mt(){return`
	...
	`}async function ht(){var t,e,n,s,i,o;try{const a=await fetch("/api/auth/me",{credentials:"include"});if(!a.ok)throw new Error("Failed to load profile");const r=await a.json(),d=r.user;U(r.user);const m=document.getElementById("loginEditProfile");m&&(m.value=d.login??"");const u=document.getElementById("changeMailEditProfile"),p=document.getElementById("mailLabel");u&&(u.value=d.mail??"",d.provider==="google"&&(u.readOnly=!0,u.classList.add("bg-gray-200","cursor-not-allowed","text-gray-500"),p&&(p.textContent="Mail (Google-managed)")));const v=document.getElementById("previewProfilePictureEditProfile"),E=document.getElementById("uploadIconEditProfile");v&&E&&(d.profile_picture?(v.src=d.profile_picture,v.classList.remove("hidden"),E.classList.add("hidden")):(v.classList.add("hidden"),E.classList.remove("hidden")));const w=document.getElementById("2FAtoggleSwitch");w&&(d.is_2fa_activated?(w.classList.remove("bg-gray-400"),w.classList.add("bg-green-500"),(t=w.querySelector("span"))==null||t.classList.add("translate-x-6")):(w.classList.add("bg-gray-400"),w.classList.remove("bg-green-500"),(e=w.querySelector("span"))==null||e.classList.remove("translate-x-6")));const x=document.getElementById("anonymousToggleSwitch");x&&(d.GDPR_activated?(x.classList.remove("bg-gray-400"),x.classList.add("bg-green-500"),(n=x.querySelector("span"))==null||n.classList.add("translate-x-6")):(x.classList.add("bg-gray-400"),x.classList.remove("bg-green-500"),(s=x.querySelector("span"))==null||s.classList.remove("translate-x-6"))),d.provider==="google"&&((i=document.getElementById("editProfileChangePassword"))==null||i.classList.add("hidden"),(o=document.getElementById("editProfile2FA"))==null||o.classList.add("hidden"))}catch(a){console.error("Error loading profile:",a)}}const pt={render(t){return`
    ...
    </div>`},showMessage(t,e){const n=t.querySelector(".twofa-message");n.textContent=e},showError(t,e){const n=t.querySelector("#twofaError");n.textContent=e,n.classList.remove("hidden")},clearError(t){const e=t.querySelector("#twofaError");e.textContent="",e.classList.add("hidden")},setButtonState(t,e){const n=t.querySelector("#verifyBtn");n.disabled=e,n.innerHTML=e?'<span class="spinner"></span> Verifying...':"Verify"}},W={async requestCode(t){const e=await fetch("/api/2fa/request",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t}),credentials:"include"});if(!e.ok){const n=await e.json().catch(()=>({}));throw new Error(n.message||"Failed to send verification code")}},async verifyCode(t,e){const n=await fetch("/api/2fa/verify",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:t,token:e}),credentials:"include"}),s=await n.json();return n.ok?s:{...s,success:!1}}};class te{constructor(e,n,s,i,o){l(this,"attempts",0);l(this,"maxAttempts",3);l(this,"email");l(this,"onSuccess");l(this,"container");l(this,"onFailure");l(this,"viewRender");this.email=e,this.onSuccess=n,this.container=s,this.onFailure=i,this.viewRender=o||pt}init(){const e=document.createElement("div");if(e.innerHTML=this.viewRender.render(this.email),!e.innerHTML.includes("twofaForm"))throw console.error("Template rendering failed!",{templateOutput:this.viewRender.render(this.email),container:this.container}),new Error("2FA template error");return this.container=e,this.setupEventListeners(e),console.log("[TwoFAController] init() setupEventListener done"),this.sendInitialCode(),e}async sendInitialCode(){console.log("Requesting initial 2FA code for:",this.email);try{await W.requestCode(this.email),console.log("Initial 2FA code sent")}catch(e){console.error("Failed to send initial 2FA code:",e),this.showError("Could not send verification code")}}setupEventListeners(e){e.querySelector("#twofaForm").addEventListener("submit",async i=>{i.preventDefault();const o=e.querySelector("#twofaCode");await this.verifyCode(o.value.trim())}),e.querySelector("#resendBtn").addEventListener("click",()=>this.resendCode())}async verifyCode(e){if(!/^\d{6}$/.test(e)){this.showError("Please enter a valid 6-digit code");return}this.attempts++,console.log(`Attempt ${this.attempts}/${this.maxAttempts}`);try{const n=await W.verifyCode(this.email,e);n.success?this.onSuccess():await this.handleFailedAttempt(n)}catch(n){console.error("Verification error:",n),await this.handleFailedAttempt()}}async handleFailedAttempt(e){const n=this.maxAttempts-this.attempts,s=n<=0;let i="Verification failed";if(e)try{i=e.message||i,console.log("Failure details:",e)}catch(o){console.error("Failed to parse error response:",o)}i+=s?". Maximum attempts reached.":` (${n} ${n===1?"attempt":"attempts"} remaining)`,console.log(`Attempt failed. Message: ${i}`),this.showError(`Attempt failed. Message: ${i}`),this.onFailure&&this.onFailure(i,s)}async resendCode(){console.log("Resending 2FA code to:",this.email);try{await W.requestCode(this.email),this.showError("New code sent successfully")}catch(e){console.error("Resend failed:",e),this.showError("Failed to resend code")}}showError(e){console.log("Displaying error:",e);const n=this.container.querySelector("#twofaError");n&&(n.textContent=e,n.classList.remove("hidden"))}}async function bt(){try{const t=await fetch("/api/auth/me",{credentials:"include"});if(!t.ok)return console.error("Error fetching user info:",t.status);const e=await t.json();console.log("in reloadUserInfo, data = ",e),console.log(`reloadUserInfo
			id: ${e.user.id},
			login: ${e.user.login},
			email: ${e.user.mail},
			profile_picture: ${e.user.profile_picture}
		`),U(e.user),document.getElementById("mailInProfileSubmenu").textContent=e.user.mail}catch(t){console.error("Network error:",t)}}function yt(){const t=document.getElementById("loginEditProfile"),e=document.getElementById("changeMailEditProfile"),n=document.getElementById("2FAtoggleSwitch"),s=document.getElementById("anonymousToggleSwitch"),i=document.getElementById("currentPasswordEditProfile"),o=document.getElementById("changePasswordEditProfile"),a=document.getElementById("repeatPasswordEditProfile");return{login:(t==null?void 0:t.value)??"",mail:(e==null?void 0:e.value)??"",is_2fa_activated:n!=null&&n.classList.contains("bg-green-500")?1:0,GDPR_activated:s!=null&&s.classList.contains("bg-green-500")?1:0,currentPassword:(i==null?void 0:i.value)??"",changePassword:(o==null?void 0:o.value)??"",repeatPassword:(a==null?void 0:a.value)??""}}async function vt(){const t=oe();if(!t)return g("Current user not loaded.","popup");const e=yt();if(!e.login||!e.mail)return g("Login and mail cannot be empty.","popup");if((e.currentPassword||e.changePassword||e.repeatPassword)&&e.changePassword!==e.repeatPassword)return g("The new passwords are not the same.","popup");if(e.currentPassword&&!e.changePassword)return g("You have to insert a new password.","popup");if(e.mail&&!Ve(e.mail))return g("The mail format is not valid.","popup");const n={};let s=!1,i=!1;if(e.login!==t.login&&(n.login=e.login),t.provider!=="google"&&e.mail!==t.mail&&(n.mail=e.mail,i=!0),e.is_2fa_activated!==t.is_2fa_activated&&(n.is_2fa_activated=e.is_2fa_activated,e.is_2fa_activated===1&&(s=!0)),e.GDPR_activated!==t.GDPR_activated&&(n.GDPR_activated=e.GDPR_activated),e.currentPassword&&e.changePassword&&(n.currentPassword=e.currentPassword,n.changePassword=e.changePassword),Object.keys(n).length===0)return g("No changes detected.","popup");if(s)return wt(t.mail,n);i&&console.log("A confirmation email will be sent to your new address."),await De(n)}let F=null,A=null;function wt(t,e){if(F=document.getElementById("editProfileFormContainer"),A=document.getElementById("twofa-container"),!F||!A){console.error("Missing containers for 2FA flow");return}A.innerHTML="",F.classList.add("hidden"),A.classList.remove("hidden");const n=new Date(Date.now()+5*60*1e3).toUTCString();if(document.cookie=`pending_2fa_edit=true; path=/; Expires=${n}; SameSite=Strict`,A.querySelector("*")===null){const i=new te(t,async()=>{console.log("2FA success, saving profile..."),document.cookie="pending2FAEdit=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;",await De(e),s()},A,(o,a)=>{g(o,"popup"),a&&(document.getElementById("currentPasswordEditProfile").value="",document.getElementById("changePasswordEditProfile").value="",document.cookie="pending2FAEdit=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;",s())},ft);A.appendChild(i.init())}function s(){A==null||A.classList.add("hidden"),F==null||F.classList.remove("hidden")}}async function De(t){try{const e=await fetch("/api/auth/me",{method:"PUT",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),n=await e.json();if(e.status===409)g(n.error,"popup");else if(e.status===400)g(n.error,"popup");else if(!e.ok)g(n.error||"Unexpected error","popup");else{j(n.message,3500,"popup");const s=oe();s&&U({...s,...t}),bt()}}catch(e){console.error(e),g("Unexpected error while saving profile.","popup")}}async function xt(t){console.log(`in checkFriendHasGDPRActivated friendId = ${t}`);const e=await fetch(`/api/auth/friends/${t}/GDPR`,{credentials:"include"}),n=await e.json();return e.status===409&&g(n.error,"popup"),n.GDPR_activated}async function Et(){const t=await fetch("/api/auth/users/count",{method:"GET",credentials:"include"}),{total:e}=await t.json();return e}async function Ae(t){return await fetch(`/api/auth/friends/${t}`,{method:"GET",credentials:"include"}).then(n=>n.json()).then(n=>n)}async function Lt(t){fetch("/api/auth/friends",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({toUserId:t.id}),credentials:"include"})}async function ce(){const t=await fetch("/api/auth/randomEligibleOtherUser",{method:"GET",credentials:"include"}).then(e=>e.status===204?null:e.json()).then(e=>e);return t||null}async function Te(){return await fetch("/api/auth/requestFriendExists",{credentials:"include"}).then(e=>e.json()).then(async e=>e.length)}async function Me(t){const e=await fetch("/api/auth/requestFriendExists",{credentials:"include"}).then(n=>n.json()).then(async n=>n);return await Ae(e[t].from_user_id)}async function ue(t,e,n){fetch("/api/auth/updateFriendshipStatus",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({currentUser:t,otherUser:e,status:n}),credentials:"include"})}async function Se(){return(await fetch("/api/auth/getFriends",{method:"GET",credentials:"include"}).then(e=>e.json())).length}async function Pt(t){const e=oe();if(!e)throw new Error("Current user not set");const n=await fetch("/api/auth/getFriends",{method:"GET",credentials:"include"}).then(i=>i.json());if(!n||t<0||t>=n.length)throw new Error("Invalid index || no friends found");const s=n[t].user_a_id===e.id?n[t].user_b_id:n[t].user_a_id;return await Ae(s)}async function It(t){return(await(await fetch(`/api/auth/friends/${t}/online`,{method:"GET",credentials:"include"})).json()).success}async function me(){const t=await Te();let e=0;for(;e<t;){const i=await Me(e);await _e(i),e++}const n=await Se();let s=0;for(;s<n;)Oe(s),s++}async function Bt(){const t=document.getElementById("uploadPictureBtnEditProfile"),e=document.getElementById("uploadProfilePictureInput"),n=document.getElementById("previewProfilePicture"),s=document.getElementById("previewProfilePictureEditProfile"),i=document.getElementById("uploadIcon");return new Promise((o,a)=>{t.addEventListener("click",()=>{e.click()}),e.addEventListener("change",async()=>{var d;const r=(d=e.files)==null?void 0:d[0];if(!r){a();return}if(r.type.startsWith("image/")){const m=new FileReader;m.onload=u=>{const p=u.target.result;n.src=p,n.classList.remove("hidden"),s.src=p,s.classList.remove("hidden"),i.classList.add("hidden")},m.readAsDataURL(r)}await je(r),o()})})}async function kt(){const t=document.getElementById("previewProfilePicture"),e=document.getElementById("previewProfilePictureEditProfile"),n=document.getElementById("uploadIcon"),s=document.getElementById("uploadPictureProfileSubmenu"),i=document.getElementById("uploadIconEditProfile"),o=document.getElementById("uploadPictureBtnEditProfile");try{const a=await fetch("/api/auth/me",{credentials:"include"});if(!a.ok)return;const r=await a.json();console.log(`data.user.provider = ${r.user.provider}`),r&&r.user&&r.user.profile_picture&&r.user.provider!=="google"?(console.log("provider not google"),t.src=`https://localhost:4443/${r.user.profile_picture}`,t.classList.remove("hidden"),e.src=`https://localhost:4443/${r.user.profile_picture}`,e.classList.remove("hidden"),n.classList.add("hidden")):(await K(t,r.user.profile_picture),await K(e,r.user.profile_picture),n.classList.add("hidden"),s.classList.remove("bg-black"),i.classList.add("hidden"),o.classList.remove("bg-black"))}catch(a){console.warn("Error: No image to load:",a)}}async function K(t,e){try{await new Promise((n,s)=>{t.onload=()=>n(),t.onerror=()=>s(new Error("Failed to load Google avatar")),t.src=e}),t.classList.remove("hidden")}catch(n){console.warn("Impossible to load Google default image",n),t.src="/basicGoogleImage.png",t.classList.remove("hidden")}}const Y={render(t){return`
  ...
  `},async init(t){const e=document.getElementById(`othersUsersUsername_${t.id}`);e&&(e.textContent=t.login);const n=document.getElementById(`othersUsersPhoto_${t.id}`);t.profile_picture&&t.profile_picture.startsWith("https://lh3.googleusercontent.com")?await K(n,t.profile_picture):n.src=`https://localhost:4443/${t.profile_picture}`;const s=document.getElementById(`addFriendBtn_${t.id}`),i=document.getElementById(`othersUsers_${t.id}_card`);s==null||s.addEventListener("click",async()=>{Q(i),j("Invitation sent",3500,"popup"),Lt(t)})}};function Ct(){return`
	...
	`}function Q(t,e="duration-750"){if(!t)return;t.classList.remove("hidden","opacity-0"),t.classList.add("opacity-100","transition-opacity","duration-1000","ease-out"),t.offsetWidth,t.classList.remove("opacity-100"),t.classList.add("opacity-0"),setTimeout(()=>t.remove(),(e==="duration-1000"?1e3:300)+20)}async function _e(t){var s;const e=document.getElementById("friendRequestDiv"),n=document.getElementById(`newRequestsFrom_${t.id}`);if(t)e==null||e.classList.remove("hidden"),n?await Y.init(t):((s=document.getElementById("friendRequestCard"))==null||s.insertAdjacentHTML("beforeend",Y.render(t)),await Y.init(t));else{e==null||e.classList.remove("hidden");const i=document.getElementById("friendRequest");i.textContent="No Friend Request"}}const ne=(()=>{let t=0;async function e(){const s=await Te();for(;t<s;){const i=await Me(t);await _e(i),t++}}function n(){t=0}return{main:e,reset:n}})();async function Oe(t){var s;const e=document.getElementById("friendsListDiv"),n=await Pt(t);e&&(e.classList.remove("hidden"),document.getElementById(`friendBox_${n.id}`)?await Z.init(n):((s=document.getElementById("friendsCard"))==null||s.insertAdjacentHTML("beforeend",Z.render(n)),await Z.init(n)))}const se=(()=>{let t=0;async function e(){const s=await Se();for(;t<s;)Oe(t),t++}function n(){t=0}return{main:e,reset:n}})(),ie=(()=>{let t=0,e=0;async function n(){const i=document.getElementById("othersUsersDiv");i==null||i.classList.remove("hidden");const o=await Et();if(o>1){let a=o-1>2?2:o-1;console.log(`max user is ${a}`);let r,d=[],m=0;for(;t<a;){if(r=await ce(),r&&d.push(r),t>0)for(;r&&d[0].id===d[1].id;)d.pop(),r=await ce(),r&&d.push(r),e>=o&&(r=null),e++;const u=document.getElementById("othersUsersCard"),p=document.getElementById("othersUsersP");if(r&&u){let v=`othersUsers_${r.id}_card`,E=r.id.toString();u.insertAdjacentHTML("beforeend",ge.render(v,E)),ge.init(r),p.textContent="Others Users",m++}else m==0&&(p.textContent="No others users to connect with");t++}}else{const a=document.getElementById("othersUsersP");a.textContent="You are the only player registered in the database. You can't connect with no one."}}function s(){t=0,e=0}return{main:n,reset:s}})();async function Dt(){ne.main(),se.main(),ie.main()}function At(t,e,n,s){const i=document.getElementById("backBtnFriendsSubmenu");i==null||i.addEventListener("click",()=>{R(t),V("profileSubmenu",t)}),e==null||e.classList.add("hidden"),n==null||n.classList.add("hidden"),s==null||s.classList.remove("hidden"),M("largeSubmenu"),M("friendsSubmenu"),Dt()}async function Tt(){ne.reset(),se.reset(),ie.reset(),await fetch("/api/auth/me",{method:"DELETE",credentials:"include"})}function Mt(){const t=document.getElementById("saveBtnEditProfile");t==null||t.addEventListener("click",()=>{vt()}),St(),_t(),Ot()}function St(){const t=document.getElementById("2FAtoggleSwitch"),e=t.querySelector("span");t.addEventListener("click",()=>{const s=!t.classList.contains("bg-green-500");Fe(t,e,s)})}function _t(){const t=document.getElementById("anonymousToggleSwitch"),e=t.querySelector("span");t.addEventListener("click",async()=>{const s=!t.classList.contains("bg-green-500");Fe(t,e,s)})}function Fe(t,e,n){n?(t.classList.remove("bg-gray-400"),t.classList.add("bg-green-500"),e.classList.add("translate-x-6")):(t.classList.remove("bg-green-500"),t.classList.add("bg-gray-400"),e.classList.remove("translate-x-6"))}function Ot(){const t=document.getElementById("eraseAccountBtn"),e=document.getElementById("confirmPopup");t==null||t.addEventListener("click",()=>{e==null||e.classList.remove("hidden")});const n=document.getElementById("popupNo");n==null||n.addEventListener("click",()=>{e==null||e.classList.add("hidden")});const s=document.getElementById("popupYes");s==null||s.addEventListener("click",async()=>{await Tt(),await N(),y.navigate("home"),j("You have been disconnected and your account has been deleted",3500,"popup")})}const Ft=()=>B.iaDifficulty==="Easy"?1e3:B.iaDifficulty==="Medium"?100:1,B={iaDifficulty:"Easy",scoreLimit:"5"};function Rt(){const t=document.getElementById("iaDifficultySliderInput"),e=document.getElementById("iaDifficultyValue"),n=document.getElementById("scoreLimitSliderInput"),s=document.getElementById("scoreLimitValue");B.iaDifficulty=pe(parseInt(t.value)),e.textContent=B.iaDifficulty,B.scoreLimit=he(parseInt(n.value)),s.textContent=B.scoreLimit,t.addEventListener("input",i=>{const o=parseInt(i.target.value);B.iaDifficulty=pe(o),e.textContent=B.iaDifficulty}),n.addEventListener("input",i=>{const o=parseInt(i.target.value);B.scoreLimit=he(o),s.textContent=B.scoreLimit})}function he(t){return t==1?"3":t==2?"5":"11"}function pe(t){return t==1?"Easy":t==2?"Medium":"Hard"}function Gt(t){const e=document.getElementById("dashboard-container");if(e){if(e.innerHTML=`
    ...
    `,!document.getElementById("dashboard-custom-style")){const n=document.createElement("style");n.id="dashboard-custom-style",n.innerHTML=`
      ...
      `,document.head.appendChild(n)}if(window.d3)fe(t);else{const n=document.createElement("script");n.src="https://d3js.org/d3.v7.min.js",n.onload=()=>fe(t),document.head.appendChild(n)}}}function fe(t){document.getElementById("username").textContent=t.username,document.getElementById("total-won").textContent=String(t.stats.won),document.getElementById("total-lost").textContent=String(t.stats.lost),document.getElementById("total-scores").textContent=String(t.stats.scores),document.getElementById("total-friends").textContent=String(t.stats.friends);const e=[{label:"Received",value:t.points.received},{label:"Scored",value:t.points.scored}];$t(e);const n=t.stats.won+t.stats.lost,s=n>0?Math.round(t.stats.won/n*100):0,i=100-s;Ht([{label:"Won",value:s},{label:"Lost",value:i}]),document.getElementById("won-percentage").textContent=`Won ${s}%`,document.getElementById("lost-percentage").textContent=`Lost ${i}%`}function $t(t){const e=window.d3;e.select("#bar-chart").html("");const n={top:20,right:20,bottom:20,left:40},s=300-n.left-n.right,i=150-n.top-n.bottom,o=e.select("#bar-chart").append("svg").attr("viewBox",`0 0 ${s+n.left+n.right} ${i+n.top+n.bottom}`).append("g").attr("transform",`translate(${n.left},${n.top})`),a=e.scaleLinear().domain([0,e.max(t,u=>u.value)*1.1]).range([i,0]),r=e.scaleBand().domain(t.map(u=>u.label)).range([0,s]).padding(.5),d=e.axisLeft(a).tickSize(-s).tickFormat(()=>"").ticks(3);o.append("g").attr("class","y-axis-grid").call(d).selectAll("line").attr("stroke","#4A5568"),o.selectAll(".domain").remove();const m=e.axisLeft(a).ticks(3);o.append("g").call(m).attr("color","#A0AEC0").selectAll(".domain, .tick line").remove(),o.selectAll(".bar").data(t).enter().append("rect").attr("class","bar").attr("x",u=>r(u.label)).attr("y",u=>a(u.value)).attr("width",r.bandwidth()).attr("height",u=>i-a(u.value)).attr("fill",u=>u.label==="Scored"?"#EDD24E":"#D9D9D9").attr("rx",6).attr("ry",6)}function Ht(t){const e=window.d3;e.select("#donut-chart").html("");const n=200,s=200,i=Math.min(n,s)/2,o=30,a=e.scaleOrdinal().domain(t.map(u=>u.label)).range(["#EDD24E","#D9D9D9"]),r=e.select("#donut-chart").append("svg").attr("viewBox",`0 0 ${n} ${s}`).append("g").attr("transform",`translate(${n/2},${s/2})`),d=e.arc().innerRadius(i-o).outerRadius(i).cornerRadius(10),m=e.pie().value(u=>u.value).sort(null);r.selectAll("path").data(m(t)).enter().append("path").attr("d",d).attr("fill",u=>a(u.data.label))}let Re=null;function U(t){Re={...t}}function oe(){return Re}function ae(t){return`
  ...
  `}function V(t,e){e.forEach(n=>{n.id===t?(n.classList.toggle("max-h-0"),n.classList.toggle("max-h-screen")):(n.classList.add("max-h-0"),n.classList.remove("max-h-screen"))})}function M(t){const e=document.getElementById(t);e&&(e.classList.remove("max-h-0"),e.classList.add("max-h-screen"))}function R(t){t.forEach(e=>{e.classList.add("max-h-0"),e.classList.remove("max-h-screen")})}const Vt={username:"PlayerOne",stats:{won:12,lost:8,scores:230,friends:5},points:{scored:150,received:180}};function jt(){Wt();const t=document.querySelectorAll(".submenu"),e=document.getElementById("friendsSubmenu"),n=document.getElementById("dashboardSubmenu"),s=document.getElementById("gameHistorySubmenu"),i=document.getElementById("DashboardBtn");i==null||i.addEventListener("click",()=>{e==null||e.classList.add("hidden"),s==null||s.classList.add("hidden"),n==null||n.classList.remove("hidden"),M("largeSubmenu"),M("dashboardSubmenu"),Gt(Vt);const r=document.getElementById("backBtnDasboardSubmenu");r==null||r.addEventListener("click",()=>{R(t),V("profileSubmenu",t)})});const o=document.getElementById("friendsListBtn");o==null||o.addEventListener("click",()=>{At(t,n,s,e)});const a=document.getElementById("gameHistoryBtn");a==null||a.addEventListener("click",()=>{n==null||n.classList.add("hidden"),e==null||e.classList.add("hidden"),s==null||s.classList.remove("hidden"),M("largeSubmenu"),M("gameHistorySubmenu");const r=document.getElementById("backBtnGameHistorySubmenu");r==null||r.addEventListener("click",()=>{R(t),V("profileSubmenu",t)})}),Ut(),Mt()}function Ut(){const t=document.getElementById("profileSubmenu"),e=document.getElementById("editProfileSubmenu"),n=document.getElementById("profileSidebarBtn"),s=document.getElementById("editProfileBtn"),i=document.querySelectorAll(".submenu"),o=document.getElementById("backBtnEditProfileSubmenu");s==null||s.addEventListener("click",()=>{ht(),e==null||e.classList.add("max-h-screen"),e==null||e.classList.remove("max-h-0"),e==null||e.classList.remove("hidden"),o==null||o.addEventListener("click",()=>{e==null||e.classList.add("max-h-0"),e==null||e.classList.remove("max-h-screen")})}),n==null||n.addEventListener("click",()=>{const a=t==null?void 0:t.classList.contains("max-h-screen"),r=e==null?void 0:e.classList.contains("max-h-screen");a||r?i.forEach(d=>{d.classList.remove("max-h-screen"),d.classList.add("max-h-0")}):(V("profileSubmenu",i),e==null||e.classList.add("max-h-0"),e==null||e.classList.remove("max-h-screen"))})}function Nt(){const t=document.querySelectorAll(".submenu"),e=document.getElementById("settingsSidebarBtn"),n=document.getElementById("largeSubmenu"),s=document.getElementById("settingsSubmenu");e==null||e.addEventListener("click",()=>{s!=null&&s.classList.contains("max-h-screen")?(n==null||n.classList.add("max-h-0"),n==null||n.classList.remove("max-h-screen"),s.classList.add("max-h-0"),s.classList.remove("max-h-screen")):(R(t),M("largeSubmenu"),M("settingsSubmenu"))})}function qt(){ut(),jt(),Nt(),Rt()}async function zt(){const e=await(await fetch("/api/auth/me/status",{method:"GET",credentials:"include"})).json();return console.log("data.authenticated = ",e.authenticated),e.authenticated===!0}async function Wt(){const e=await(await fetch("/api/auth/me",{method:"GET",credentials:"include"})).json();U(e.user);const n=document.getElementById("profileName");n&&(n.textContent=e.user.login||"Profile Name");const s=document.getElementById("mailInProfileSubmenu");s&&(s.textContent=e.user.mail||"contact@mail.com");const i=document.getElementById("playerNameDashboard");i&&(i.textContent=e.user.login||"Username")}function Yt(){const t=document.getElementById("logoutSidebarBtn");if(!t){console.error("Logout button not found");return}t.addEventListener("click",async e=>{e.preventDefault();try{const n=await fetch("/api/auth/me/sessions",{method:"DELETE",credentials:"include"});if(!n.ok)throw new Error(`Logout failed: ${n.statusText}`);localStorage.removeItem("userState"),sessionStorage.clear(),ne.reset(),se.reset(),ie.reset(),y.navigate("home"),g("You have been disconnected","popup")}catch(n){console.error("Logout error:",n),y.navigate("home")}})}function Zt(){return`
	...
	`}const be={currentUser:null,render(){return`
	...
	<div class="flex flex-col mt-auto items-center space-y-2 pb-6">
	 ...
	 `},init(){document.getElementById("loginBtn").addEventListener("click",()=>{y.navigate("login")}),document.getElementById("registerBtn").addEventListener("click",()=>{y.navigate("register")})}},ye={currentUser:null,isLogin:!0,render(){return`
	<img src="/pong-logo.png" alt="PONG Logo" class="h-auto w-auto pl-2 pr-2 pt-2"/>
	...
	${Xt()}
  `},init(){qt();const t=document.getElementById("tournamentBtn");t==null||t.addEventListener("click",()=>{y.navigate("tournament")})}};async function N(){const t=await zt(),e=document.getElementById("sidebar");t?(console.log("✅ Connected"),e.innerHTML=ye.render(),ye.init(),Yt(),Bt(),kt()):(e.innerHTML=be.render(),be.init(),console.log("❌ Not connected"))}class re{render(){return`
...
winner is===`,i),s&&e.winner){s.innerHTML=`            
                ...
                `,s.classList.remove("hidden"),s.style.display="block";const o=document.getElementById("reset-btn");o==null||o.addEventListener("click",()=>{y.navigate("home")})}}playGame(e){return new Promise(async()=>{if(b.isCreatingGame){console.log("🚫 Game creation already in progress, skipping...");return}b.isCreatingGame=!0,console.log("🔒 Locking game creation");try{b.currentGame&&(console.log("🛑 Found existing game in playGame, stopping it"),b.currentGame.stopGame(),b.currentGame=null,await new Promise(s=>setTimeout(s,50))),await N(),this.renderGameCanvas(),await new Promise(s=>setTimeout(s,100));const n=new Ie({leftPlayer:e.player1.alias,rightPlayer:e.player2.alias,maxScore:parseInt(B.scoreLimit),gameMode:b.gameType,aiDifficulty:Ft(),onFinish:(s,i,o)=>{if(console.log(i,o),e.player1.score=i,e.player2.score=o,e.winner=e.player1.alias===s?e.player1:e.player2,console.log("entra en onMatchEnd"),b.noWinner&&window.location.pathname==="/game")if(e.winner.alias&&e.winner.alias!==void 0){this.showWinner(e,o>i);let a=document.getElementById("winner-screen");a==null||a.classList.remove("hidden"),b.noWinner=!1}else window.location.pathname==="/game"&&y.navigate("home");else window.location.pathname==="/game"&&y.navigate("home");b.currentGame=null,n.resetGame()}});b.currentGame=n,console.log("🎮 New game instance stored in ShowGame.currentGame"),n.resetGame(),n.setGameOn(),n.start()}finally{b.isCreatingGame=!1,console.log("🔓 Unlocking game creation")}})}static async cleanup(){for(console.log("🧹 ShowGame.cleanup() called");b.isCreatingGame;)console.log("⏳ Waiting for game creation to complete..."),await new Promise(e=>setTimeout(e,10));b.currentGame&&(console.log("🛑 Found existing game, stopping it"),b.currentGame.stopGame(),b.currentGame=null),b.noWinner=!0,b.inGame=!1}};l(b,"gameType","p-vs-p"),l(b,"getAIDifficulty"),l(b,"getMaxScore"),l(b,"inGame",!1),l(b,"noWinner",!0),l(b,"gameController",!0),l(b,"otherPlayer","Erik"),l(b,"currentGame",null),l(b,"isCreatingGame",!1);let h=b;const ve={currentUser:null,isLogin:!0,render(){return`
	...
	`},async init(){const t=document.getElementById("playBtn");t==null||t.addEventListener("click",()=>{h.gameType="p-vs-p",h.inGame=!0,y.navigate("game")})}};function Ge(){return`
	...
	`}const nn={currentUser:null,isLogin:!0,render(){return`
	...
	`}const on={currentUser:null,isLogin:!0,render(){return`
	...
	`},init(){Ce()}},we={currentUser:null,isLogin:!0,render(){return`
  ...
  `},async init(){await N(),ve.init()}};async function an(){if(console.log("1 - Login service initialized"),(await fetch("/api/auth/me/status",{credentials:"include"}).then(n=>n.json())).authenticated){y.navigate("home"),g("You are already connected. You can't access the login page.","popup");return}const e=document.getElementById("connectionBtn");e.addEventListener("click",async()=>{const n=document.getElementById("login").value.trim(),s=document.getElementById("password").value;e.disabled=!0;try{const i=await fetch("/api/auth/users/check",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({login:n,password:s}),credentials:"include"}),o=await i.json();if(console.log("login info:",{loginData:o}),!i.ok||o.success===!1){g(o.error||"Login failed","popup");return}if(o.requires2FA){const a=document.getElementById("loginCredentials"),r=document.getElementById("twofa-container");if(a&&r&&(r.innerHTML="",a.classList.add("hidden"),r.classList.remove("hidden"),r.querySelector("*")===null)){console.log("Attempting TwoFAController creation");const m=new te(o.mail,async()=>{console.log("2FA Success callback triggered"),a.classList.add("hidden"),r.classList.add("hidden"),ee(o.login,o.userId)},r,(u,p)=>{console.log(`2FA Error: ${u}`,p),g(u,"popup"),p&&(document.cookie="auth_phase=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;",document.cookie="auth_token=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;",sessionStorage.setItem("loginError",u),document.getElementById("password").value="",a&&a.classList.remove("hidden"),r&&r.classList.add("hidden"))}).init();r.appendChild(m)}}else ee(n,o.userId)}catch(i){g("Network error during login","popup"),console.error("Login error:",i)}finally{e.disabled=!1}})}async function ee(t,e){try{const n=await fetch("/api/auth/users/sessions",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({userId:e})});if(!n.ok)throw new Error("Token generation failed");localStorage.setItem("login",t),console.log(`in loginService tokenRes = ${n}`),y.navigate("home"),j("You are logged in",3500,"popup")}catch(n){console.error("Login completion error:",n),g("Login complete but couldn't load session","popup"),y.navigate("home")}}const xe={render:()=>`
  	<div class="w-screen h-screen flex bg-[#fbd11b] overflow-hidden">
  ...
  `,async init(){await N(),X("password","togglePasswordLogin","eyeIconClosedLogin","eyeIconOpenedLogin"),an(),rn(),document.getElementById("backToRegister").addEventListener("click",()=>y.navigate("register"))}};function rn(){google.accounts.id.initialize({client_id:"11816073281-ka847kttjiaqlci012l9p7kpip87kocr.apps.googleusercontent.com",callback:ln}),google.accounts.id.renderButton(document.getElementById("googleConnectionBtn"),{theme:"outline",size:"large",text:"signin_with",shape:"rectangular",width:315})}async function ln(t){console.log("ID Google Token:",t.credential);const n=await(await fetch("/api/auth/google",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({id_token:t.credential})})).json();console.log("Internal JWT:",n.success),console.log(`Gprovider = ${n.provider}`),n.success||g("Google SignIn failed","popup"),dn()}async function dn(){const t=await fetch("/api/auth/googleSession",{method:"POST",credentials:"include"});if(t.status===401){console.log("Not authenticated");return}const e=await t.json();console.log(`data = ${e}`),console.log(`data.provider = ${e.provider}`),t.status===201&&(console.log(`data.name = ${e.login}, data.userId = ${e.userId}`),ee(e.login,e.userId)),console.log("Protected data:",e)}async function cn(){if(console.log("1 - Registration service initialized"),(await fetch("/api/auth/me/status",{credentials:"include"}).then(i=>i.json())).authenticated){y.navigate("home"),g("You are already connected. You can't access the register page.","popup");return}const e=document.getElementById("anonymizedCheckbox");let n=!1;e.addEventListener("change",()=>{n=e.checked,console.log("Anonymisation enabled:",n)});const s=document.getElementById("createAccountBtn");s.addEventListener("click",async()=>{const i=document.getElementById("newUsername").value.trim(),o=document.getElementById("newMail").value,a=document.getElementById("newPassword").value,r=document.getElementById("confirmPassword").value;if(!i){g("Username is required","popup");return}if(!o){g("Email is required","popup");return}if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(o)){g("Please enter a valid email address","popup");return}if(!a){g("Password is required","popup");return}if(!r){g("Please confirm your password","popup");return}if(a!==r){g("Passwords do not match","popup");return}s.disabled=!0,console.log(`in initRegistrationService => anonymisationEnabled = ${n}`);try{const m=await fetch("/api/auth/users/verify",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({login:i,mail:o,anonymisationEnabled:n}),credentials:"include"}),u=await m.json();if(!m.ok||u.success===!1){g(u.error||"Registration failed","popup");return}if(u.requires2FA){const p=document.getElementById("registerForm"),v=document.getElementById("twofa-container");if(console.log("Pre-Check:",{regFormExists:!!p,twofaContainerExists:!!v,regData:u}),!p||!v){g(u.error||"Registration form problem","popup");return}if(v.innerHTML="",p.classList.add("hidden"),v.classList.remove("hidden"),v.querySelector("*")===null){const w=new te(o,async()=>{p.classList.add("hidden"),v.classList.add("hidden"),Ee(i,a,n)},v,(x,I)=>{g(x,"popup"),I&&(document.cookie="auth_phase=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;",document.cookie="auth_token=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;",sessionStorage.setItem("registerError",x),document.getElementById("newPassword").value="",p&&p.classList.remove("hidden"),v&&v.classList.add("hidden"))}).init();v.appendChild(w)}}else Ee(i,a,n)}catch(m){g("Network error during registration","popup"),console.error("Registration error:",m)}finally{s.disabled=!1}})}async function Ee(t,e,n){try{if(!(await fetch("/api/auth/users",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({password:e,anonymisationEnabled:n})})).ok)throw new Error("Token generation failed");localStorage.setItem("login",t),j("Account created successfully",3500,"popup"),y.navigate("login")}catch(s){console.error("Registration completion error:",s),g("Account created but session could not be loaded","popup"),y.navigate("home")}}const Le={render:()=>`
    <div class="w-screen h-screen flex bg-[#fbd11b] overflow-hidden">
  ...
  `,async init(){await N(),X("newPassword","togglePassword","eyeIconClosed","eyeIconOpened"),X("confirmPassword","toggleConfirmPassword","confirmEyeIconClosed","confirmEyeIconOpened"),cn(),document.body.insertAdjacentHTML("beforeend",un()),mn(),document.getElementById("backToLogin").addEventListener("click",()=>{y.navigate("login")})}};function un(){return`
	...
	`}function mn(){const t=document.getElementById("policiesPopup"),e=document.getElementById("showPoliciesBtn"),n=document.getElementById("closePoliciesBtn");!t||!e||!n||(e.addEventListener("click",()=>t.classList.remove("hidden")),n.addEventListener("click",()=>t.classList.add("hidden")),t.addEventListener("click",s=>{s.target===t&&t.classList.add("hidden")}))}function gn(){const t=document.getElementById("app");t&&(t.innerHTML=`
    <div class="not-found">
      <h1>404 - Page Not Found</h1>
      <p>The page you are looking for doesn’t exist.</p>
      <a href="/">Go Home</a>
    </div>
  `)}const O=class O{static navigate(e,n=!0){if(!this.app){console.error("App container not found");return}switch(e){case"home":h.cleanup(),h.gameController=!1,this.app.innerHTML=we.render(),we.init();break;case"login":h.cleanup(),this.app.innerHTML=xe.render(),xe.init();break;case"register":h.cleanup(),this.app.innerHTML=Le.render(),Le.init();break;case"game":if(!h.inGame){O.navigate("home"),h.inGame=!1;return}const s=document.getElementById("player1"),i=document.getElementById("player2"),o=document.getElementById("player1VSAI");let a=i;h.gameType==="p-vs-ai"&&(a=o,h.otherPlayer=a.value),!a&&!s?new h().initGame({player1:{alias:"User 1"},player2:{alias:"User 2"},winner:null}):new h().initGame({player1:{alias:s.value},player2:{alias:a.value},winner:null});break;case"notfound":gn();break;case"tournament":const r=document.getElementById("tournamentArea");let d=document.getElementById("gameCanvasContainer");if(!d&&(r!=null&&r.parentNode)&&(d=document.createElement("div"),d.id="gameCanvasContainer",d.className="hidden content bg-[#fbd11b] h-full",r.appendChild(d)),d&&z&&z.partidoActivo){const m=document.getElementById("gameArea");m==null||m.classList.add("hidden");const u=new re().render();d.innerHTML=u}else window.location.pathname==="/tournament"&&(console.log("no hay partido activo, se muestra torneo"),O.navigate("home"));break}n&&e!=="notfound"&&history.pushState({},"",e==="home"?"/":`/${e}`)}static resolveRoute(e){return e.includes("login")?"login":e.includes("register")?"register":e.includes("game")?"game":e.includes("tournament")?"tournament":e==="/"||e===""?"home":"notfound"}static init(){window.addEventListener("load",()=>{const e=this.resolveRoute(window.location.pathname);this.navigate(e,!1)}),window.addEventListener("popstate",()=>{const e=this.resolveRoute(window.location.pathname);this.navigate(e,!1)}),window.addEventListener("popstate",e=>{console.log("History changed:",e.state)}),window.addEventListener("beforeunload",()=>{window.location.pathname==="/tournament"&&O.navigate("home"),h.cleanup()})}};l(O,"app",document.getElementById("app")),l(O,"currentUser");let y=O;y.init();window.addEventListener("load",()=>{const t=window.location.pathname;y.navigate(t.includes("login")?"login":t.includes("register")?"register":t.includes("game")?"game":t.includes("tournament")?"tournament":"home",!1)});window.addEventListener("popstate",()=>{const t=window.location.pathname;y.navigate(t.includes("login")?"login":t.includes("register")?"register":t.includes("game")?"game":t.includes("tournament")?"tournament":"home",!1)});
