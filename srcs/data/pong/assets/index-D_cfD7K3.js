...
<div id="game-overlay" class="absolute inset-0 bg-black/80 flex-col items-center justify-center hidden z-50">
      ...
      `},init(){const t=document.getElementById("playtournamentBtn");let e=localStorage.getItem("login");const n=document.querySelector("#alias1");n&&(n.value=e||""),t==null||t.addEventListener("click",()=>{let s=document.getElementById("alias1").value,i=document.getElementById("alias2").value,o=document.getElementById("alias3").value,a=document.getElementById("alias4").value;i.trim()||(i="user2"),o.trim()||(o="user3"),a.trim()||(a="user4");const r=document.getElementById("alias2"),d=document.getElementById("alias3"),h=document.getElementById("alias4");if(r&&(r.value=i),d&&(d.value=o),h&&(h.value=a),!Ae()){const L=new et;L.addPlayer(s),L.addPlayer(i),L.addPlayer(o),L.addPlayer(a),tt(L)}st()||nt({player1:s,player2:i,partidoActivo:!0,onMatchEnd:(L,B,b)=>{console.log(`Match ended. Winner: ${L}, Scores: ${B} - ${b}`)}}),t.classList.add("hidden"),new gt().iniciarTorneo();const x=document.getElementById("tournamentArea");let E=document.getElementById("gameCanvasContainer");if(!E&&(x!=null&&x.parentNode)&&(E=document.createElement("div"),E.id="gameCanvasContainer",E.className="hidden content bg-[#fbd11b] h-full",x.appendChild(E)),E&&F&&F.partidoActivo){const L=document.getElementById("gameArea");L==null||L.classList.add("hidden");const B=new U().render();E.innerHTML=B}const P=document.querySelectorAll(".submenu");R(P)})}};function pt(t,e){const n=document.getElementById(t),s=document.getElementById(e);if(n&&s){const i=n.value;n.value=s.value,s.value=i}}function ft(t,e){const n=document.getElementById(t),s=document.getElementById(e);if(!n||!s)return;const i=n.parentNode,o=n.nextSibling,a=s.nextSibling;o===s?i.insertBefore(s,n):a===n?i.insertBefore(n,s):(i.insertBefore(n,a),i.insertBefore(s,o))}function bt(){var e;(e=document.getElementById("swapBtn"))==null||e.addEventListener("click",()=>{pt("player1","player2")}),document.getElementById("playOneVsOneBtn").addEventListener("click",()=>{console.log("clic 1");const n=document.getElementById("player1"),s=document.getElementById("player2");if(!n.value.trim()||!s.value.trim()){m("You need 2 players to play.","oneVsOneAreaPopup");return}console.log("clic 2"),new v().initGame({player1:{alias:n.value},player2:{alias:s.value},winner:null})})}function yt(){var e;(e=document.getElementById("swapAIBtn"))==null||e.addEventListener("click",()=>{ft("player1VSAI","AIPlayer")}),document.getElementById("playOneVsAIBtn").addEventListener("click",()=>{const n=document.getElementById("player1VSAI");if(!n.value.trim()){m("You need 1 player to play.","oneVsAIAreaPopup");return}new v().initGame({player1:{alias:n.value},player2:{alias:"chatGPT"},winner:null})})}function vt(){const t=document.querySelectorAll(".submenu"),e=document.getElementById("playSidebarBtn");e==null||e.addEventListener("click",()=>{N("playSubmenu",t)})}function wt(){return`
...
winner is===`,i),s&&e.winner){s.innerHTML=`            
                ...
                `,s.classList.remove("hidden"),s.style.display="block";const o=document.getElementById("reset-btn");o==null||o.addEventListener("click",()=>{w.navigate("home")})}}playGame(e){return new Promise(async()=>{if(!y.isCreatingGame){y.isCreatingGame=!0;try{y.currentGame&&(y.currentGame.stopGame(),y.currentGame=null,await new Promise(s=>setTimeout(s,50))),this.renderGameCanvas(),await new Promise(s=>setTimeout(s,100));const n=new Me({leftPlayer:e.player1.alias,rightPlayer:e.player2.alias,maxScore:parseInt(C.scoreLimit),gameMode:y.gameType,aiDifficulty:it(),onFinish:(s,i,o)=>{if(console.log(i,o),e.player1.score=i,e.player2.score=o,e.winner=e.player1.alias===s?e.player1:e.player2,console.log("entra en onMatchEnd"),Ve(y.gameType,e),y.noWinner&&(window.location.pathname.includes("/game")||window.location.pathname.includes("/gameai")))if(e.winner.alias&&e.winner.alias!==void 0){this.showWinner(e,o>i);let a=document.getElementById("winner-screen");a==null||a.classList.remove("hidden"),y.noWinner=!1}else(window.location.pathname.includes("/game")||window.location.pathname.includes("/gameai"))&&w.navigate("home");else(window.location.pathname.includes("/game")||window.location.pathname.includes("/gameai"))&&w.navigate("home");y.currentGame=null,n.resetGame()}});y.currentGame=n,n.resetGame(),n.setGameOn(),n.start()}finally{y.isCreatingGame=!1}}})}static async cleanup(){for(;y.isCreatingGame;)await new Promise(e=>setTimeout(e,10));y.currentGame&&(y.currentGame.stopGame(),y.currentGame=null),y.noWinner=!0,y.inGame=!1}};l(y,"gameType","p-vs-p"),l(y,"getAIDifficulty"),l(y,"getMaxScore"),l(y,"inGame",!1),l(y,"noWinner",!0),l(y,"gameController",!0),l(y,"otherPlayer","Erik"),l(y,"currentGame",null),l(y,"isCreatingGame",!1);let v=y;const Ee={currentUser:null,isLogin:!0,render(){return`
