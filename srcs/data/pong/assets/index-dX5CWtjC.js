var B=Object.defineProperty;var C=(i,e,t)=>e in i?B(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var a=(i,e,t)=>C(i,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const l of n)if(l.type==="childList")for(const r of l.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(n){const l={};return n.integrity&&(l.integrity=n.integrity),n.referrerPolicy&&(l.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?l.credentials="include":n.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function s(n){if(n.ep)return;n.ep=!0;const l=t(n);fetch(n.href,l)}})();const o={BASE_WIDTH:1024,BASE_HEIGHT:768,BALL_SPEED:2,MAX_BALL_SPEED:10,PADDLE_WIDTH:10,PADDLE_HEIGHT:80,PADDLE_SPEED:5,PADDLE_OFFSET:30,DEFLECTION_ANGLES:[-45,-30,-15,0,0,15,30,45]};class S{constructor(){a(this,"physicalWidth",0);a(this,"physicalHeight",0);a(this,"scaleFactor",1);a(this,"baseWidth",o.BASE_WIDTH);a(this,"baseHeight",o.BASE_HEIGHT)}update(e,t){this.physicalWidth=e,this.physicalHeight=t;const s=e/this.baseWidth,n=t/this.baseHeight;this.scaleFactor=Math.min(s,n)}toPhysicalX(e){return e*this.scaleFactor}toPhysicalY(e){return e*this.scaleFactor}toPhysicalSize(e){return e*this.scaleFactor}get currentVirtualWidth(){return this.baseWidth}get currentVirtualHeight(){return this.baseHeight}getPhysicalDimensions(){return{width:this.physicalWidth,height:this.physicalHeight}}}class I{constructor(){a(this,"x");a(this,"y");a(this,"radius");a(this,"dx");a(this,"dy");a(this,"speed");a(this,"color");this.x=o.BASE_WIDTH/2,this.y=o.BASE_HEIGHT/2,this.radius=10,this.speed=o.BALL_SPEED,this.dx=2*(Math.random()>.5?1:-1),this.dy=2*(Math.random()>.5?1:-1),this.color="white"}reset(){this.x=o.BASE_WIDTH/2,this.y=o.BASE_HEIGHT/2,this.radius=10,this.speed=o.BALL_SPEED,this.dx=2*(Math.random()>.5?1:-1),this.dy=2*(Math.random()>.5?1:-1),this.color="white"}move(){this.x+=this.dx,this.y+=this.dy}checkWallCollision(){const e=this.x-this.radius<=0,t=this.x+this.radius>=o.BASE_WIDTH,s=this.y-this.radius<=0,n=this.y+this.radius>=o.BASE_HEIGHT;return e||t?(this.dx=-this.dx,!0):s||n?(this.dy=-this.dy,!0):!1}handlePaddleCollision(e,t){this.dx=Math.cos(e)*this.speed*(t?-1:1),this.dy=Math.sin(e)*this.speed,this.speed=Math.min(this.speed*1.05,o.MAX_BALL_SPEED)}}class w{constructor(e){a(this,"x");a(this,"y");a(this,"width");a(this,"height");a(this,"speed");a(this,"targetY");this.width=o.PADDLE_WIDTH,this.height=o.PADDLE_HEIGHT,this.speed=o.PADDLE_SPEED,this.targetY=o.BASE_HEIGHT/2-this.height/2,this.x=e?o.PADDLE_OFFSET:o.BASE_WIDTH-o.PADDLE_OFFSET-this.width,this.y=this.targetY}move(e){const t=e*this.speed;this.targetY=Math.max(0,Math.min(o.BASE_HEIGHT-this.height,this.targetY+t)),this.y=this.targetY}update(e){const t=this.targetY-this.y,s=this.speed*e;this.y+=Math.sign(t)*Math.min(s,Math.abs(t))}reset(){this.y=o.BASE_HEIGHT/2-this.height/2,this.targetY=this.y}checkBallCollision(e,t,s){if(e+s<this.x||e-s>this.x+this.width||t+s<this.y||t-s>this.y+this.height)return 0;const n=this.height/8,l=t-this.y;let r=Math.floor(l/n)+1;return r=Math.max(1,Math.min(8,r)),r}getDeflectionAngle(e){return o.DEFLECTION_ANGLES[e-1]*(Math.PI/180)}}class h{static init(){this.ctx||(this.ctx=new(window.AudioContext||window.webkitAudioContext))}static play(e){this.init(),this.nodes[e]&&this.nodes[e].stop();const t=this.ctx.createOscillator(),s=this.ctx.createGain();switch(e){case"paddle":t.type="sine",t.frequency.value=220,s.gain.value=.3;break;case"wall":t.type="square",t.frequency.value=440,s.gain.value=.2;break;case"score":t.type="sawtooth",t.frequency.value=110,s.gain.value=.4;break}t.connect(s),s.connect(this.ctx.destination);const n=e==="score"?.5:.05;t.start(),t.stop(this.ctx.currentTime+n),this.nodes[e]=t}}a(h,"ctx"),a(h,"nodes",{});class L{constructor(){a(this,"canvas");a(this,"ctx");a(this,"virtualCanvas",new S);a(this,"ball",new I);a(this,"leftPaddle",new w(!0));a(this,"rightPaddle",new w(!1));a(this,"animationFrameId",0);a(this,"scorePlayer1",0);a(this,"scorePlayer2",0);a(this,"keysPressed",{});a(this,"showCollisionZones",!1)}init(){this.canvas=document.getElementById("game-canvas"),this.ctx=this.canvas.getContext("2d"),this.resizeCanvas(),h.init(),window.addEventListener("resize",()=>this.resizeCanvas()),this.startLoop()}resizeCanvas(){const e=this.canvas.parentElement,t=window.getComputedStyle(e),s=e.clientWidth-(parseFloat(t.paddingLeft)+parseFloat(t.paddingRight)),n=e.clientHeight-(parseFloat(t.paddingTop)+parseFloat(t.paddingBottom));this.virtualCanvas.update(s,n),this.canvas.width=s,this.canvas.height=n,this.canvas.style.width=`${s}px`,this.canvas.style.height=`${n}px`}startLoop(){const e=()=>{this.update(),this.draw(),this.animationFrameId=requestAnimationFrame(e)};e()}update(){this.ball.move(),this.ball.checkWallCollision()&&h.play("wall"),this.checkPaddleCollision(this.leftPaddle),this.checkPaddleCollision(this.rightPaddle),this.checkGoal(),this.keysPressed.w&&this.leftPaddle.move(-1),this.keysPressed.s&&this.leftPaddle.move(1),this.keysPressed.ArrowUp&&this.rightPaddle.move(-1),this.keysPressed.ArrowDown&&this.rightPaddle.move(1)}checkPaddleCollision(e){const t=e.checkBallCollision(this.ball.x,this.ball.y,this.ball.radius);if(t>0){const s=e.getDeflectionAngle(t);h.play("paddle"),this.ball.handlePaddleCollision(s,e===this.rightPaddle),this.showCollisionZones=!0,setTimeout(()=>this.showCollisionZones=!1,100)}}checkGoal(){this.ball.x-this.ball.radius<=0?(this.scorePlayer2++,this.resetRound()):this.ball.x+this.ball.radius>=o.BASE_WIDTH&&(this.scorePlayer1++,this.resetRound()),(this.scorePlayer1>=21||this.scorePlayer2>=21)&&(this.scorePlayer1=0,this.scorePlayer2=0)}resetRound(){h.play("score"),this.ball.reset()}draw(){this.drawBackground(),this.drawCenterLine(),this.drawPaddle(this.leftPaddle),this.drawPaddle(this.rightPaddle),this.drawBall(),this.drawScore()}drawBackground(){this.ctx.fillStyle="black",this.ctx.fillRect(0,0,this.canvas.width,this.canvas.height)}drawCenterLine(){this.ctx.strokeStyle="rgba(255, 255, 255, 0.5)",this.ctx.lineWidth=this.virtualCanvas.toPhysicalSize(4),this.ctx.setLineDash([this.virtualCanvas.toPhysicalSize(20),this.virtualCanvas.toPhysicalSize(15)]),this.ctx.beginPath(),this.ctx.moveTo(this.canvas.width/2,0),this.ctx.lineTo(this.canvas.width/2,this.canvas.height),this.ctx.stroke(),this.ctx.setLineDash([])}drawPaddle(e){if(this.ctx.fillStyle="white",this.ctx.fillRect(this.virtualCanvas.toPhysicalX(e.x),this.virtualCanvas.toPhysicalY(e.y),this.virtualCanvas.toPhysicalSize(e.width),this.virtualCanvas.toPhysicalSize(e.height)),this.showCollisionZones){const t=e.height/8;for(let s=0;s<8;s++)this.ctx.fillStyle=`rgba(255, 0, 0, ${.2+s*.1})`,this.ctx.fillRect(this.virtualCanvas.toPhysicalX(e.x),this.virtualCanvas.toPhysicalY(e.y+s*t),this.virtualCanvas.toPhysicalSize(e.width),this.virtualCanvas.toPhysicalSize(t))}}drawBall(){this.ctx.fillStyle="white",this.ctx.beginPath(),this.ctx.arc(this.virtualCanvas.toPhysicalX(this.ball.x),this.virtualCanvas.toPhysicalY(this.ball.y),this.virtualCanvas.toPhysicalSize(this.ball.radius),0,Math.PI*2),this.ctx.fill()}drawScore(){const e=this.virtualCanvas.toPhysicalSize(48);this.ctx.font=`${e}px 'DSEG7ClassicMini', monospace`,this.ctx.textAlign="center",this.ctx.fillStyle="white",this.ctx.fillText(this.scorePlayer1.toString().padStart(2,"0"),this.virtualCanvas.toPhysicalX(o.BASE_WIDTH/4),this.virtualCanvas.toPhysicalY(60)),this.ctx.fillText(this.scorePlayer2.toString().padStart(2,"0"),this.virtualCanvas.toPhysicalX(o.BASE_WIDTH*3/4),this.virtualCanvas.toPhysicalY(60))}setKey(e,t){this.keysPressed[e]=t}setBallSpeed(e){this.ball.speed=e}stop(){cancelAnimationFrame(this.animationFrameId)}render(){return`
	...
	</div>`}static init(){M();const e=localStorage.getItem("login")||"",t=localStorage.getItem("alias")||"";console.log("current login in localStorage:",e),console.log("current alias in localStorage:",t);const s=document.getElementById("current-login"),n=document.getElementById("current-alias"),l=document.getElementById("new-login"),r=document.getElementById("new-alias");s&&(s.innerText=`Current login: ${e} - Change it to:`),n&&(n.innerText=`Current alias: ${t} - Change it to:`),l&&(l.value=e),r&&(r.value=t),G()}}class y{static navigate(e){if(!this.app){console.error("App container not found");return}switch(this.app.innerHTML="",e){case"home":this.app.innerHTML=v.render(),v.init();break;case"login":this.app.innerHTML=x.render(),x.init();break;case"info":this.app.innerHTML=E.render(),E.init();break}history.pushState({},"",e==="home"?"/":`/${e}`)}static init(){window.addEventListener("load",()=>{const e=window.location.pathname;this.navigate(e.includes("login")?"login":e.includes("info")?"info":"home")}),window.addEventListener("popstate",()=>{const e=window.location.pathname;this.navigate(e.includes("login")?"login":e.includes("info")?"info":"home")})}}a(y,"app",document.getElementById("app"));y.init();window.addEventListener("load",()=>{const i=window.location.pathname;y.navigate(i.includes("login")?"login":i.includes("info")?"info":"home")});window.addEventListener("popstate",()=>{const i=window.location.pathname;y.navigate(i.includes("login")?"login":i.includes("info")?"info":"home")});
