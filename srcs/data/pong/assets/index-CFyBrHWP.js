...
<div id="game-overlay" class="absolute inset-0 bg-black/80 flex-col items-center justify-center hidden z-50">
  ...
  `}function q(t,e){e.forEach(n=>{n.id===t?(n.classList.toggle("max-h-0"),n.classList.toggle("max-h-screen")):(n.classList.add("max-h-0"),n.classList.remove("max-h-screen"))})}function T(t){const e=document.getElementById(t);e&&(e.classList.remove("max-h-0"),e.classList.add("max-h-screen"))}function G(t){t.forEach(e=>{e.classList.add("max-h-0"),e.classList.remove("max-h-screen")})}const Zt={username:"PlayerOne",stats:{won:12,lost:8,scores:230,friends:5},points:{scored:150,received:180}};function Xt(){tn();const t=document.querySelectorAll(".submenu"),e=document.getElementById("friendsSubmenu"),n=document.getElementById("dashboardSubmenu"),s=document.getElementById("gameHistorySubmenu"),i=document.getElementById("DashboardBtn");i==null||i.addEventListener("click",()=>{e==null||e.classList.add("hidden"),s==null||s.classList.add("hidden"),n==null||n.classList.remove("hidden"),T("largeSubmenu"),T("dashboardSubmenu"),zt(Zt);const d=document.getElementById("backBtnDasboardSubmenu");d==null||d.addEventListener("click",()=>{G(t),q("profileSubmenu",t)})});const o=document.getElementById("friendsListBtn");o==null||o.addEventListener("click",()=>{$t(t,n,s,e)});const a=document.getElementById("gameHistoryBtn"),r=document.getElementById("backBtnGameHistorySubmenu");r==null||r.addEventListener("click",()=>{console.log("clicked"),G(t),q("profileSubmenu",t)}),a==null||a.addEventListener("click",()=>{n==null||n.classList.add("hidden"),e==null||e.classList.add("hidden"),s==null||s.classList.remove("hidden"),T("largeSubmenu"),T("gameHistorySubmenu"),ae.main()}),Jt(),Ht()}function Jt(){const t=document.getElementById("profileSubmenu"),e=document.getElementById("editProfileSubmenu"),n=document.getElementById("profileSidebarBtn"),s=document.getElementById("editProfileBtn"),i=document.querySelectorAll(".submenu"),o=document.getElementById("backBtnEditProfileSubmenu");s==null||s.addEventListener("click",()=>{Et(),e==null||e.classList.add("max-h-screen"),e==null||e.classList.remove("max-h-0"),e==null||e.classList.remove("hidden"),o==null||o.addEventListener("click",()=>{e==null||e.classList.add("max-h-0"),e==null||e.classList.remove("max-h-screen")})}),n==null||n.addEventListener("click",()=>{const a=t==null?void 0:t.classList.contains("max-h-screen"),r=e==null?void 0:e.classList.contains("max-h-screen");a||r?i.forEach(d=>{d.classList.remove("max-h-screen"),d.classList.add("max-h-0")}):(q("profileSubmenu",i),e==null||e.classList.add("max-h-0"),e==null||e.classList.remove("max-h-screen"))})}function Kt(){const t=document.querySelectorAll(".submenu"),e=document.getElementById("settingsSidebarBtn"),n=document.getElementById("largeSubmenu"),s=document.getElementById("settingsSubmenu");e==null||e.addEventListener("click",()=>{s!=null&&s.classList.contains("max-h-screen")?(n==null||n.classList.add("max-h-0"),n==null||n.classList.remove("max-h-screen"),s.classList.add("max-h-0"),s.classList.remove("max-h-screen")):(G(t),T("largeSubmenu"),T("settingsSubmenu"))})}function Qt(){vt(),Xt(),Kt(),qt()}async function en(){const e=await(await fetch("/api/auth/me/status",{method:"GET",credentials:"include"})).json();return console.log("data.authenticated = ",e.authenticated),e.authenticated===!0}async function tn(){const e=await(await fetch("/api/auth/me",{method:"GET",credentials:"include"})).json();W(e.user);const n=document.getElementById("profileName");n&&(n.textContent=e.user.login||"Profile Name");const s=document.getElementById("mailInProfileSubmenu");s&&(s.textContent=e.user.mail||"contact@mail.com");const i=document.getElementById("playerNameDashboard");i&&(i.textContent=e.user.login||"Username")}function nn(){const t=document.getElementById("logoutSidebarBtn");if(!t){console.error("Logout button not found");return}t.addEventListener("click",async e=>{e.preventDefault();try{const n=await fetch("/api/auth/me/sessions",{method:"DELETE",credentials:"include"});if(!n.ok)throw new Error(`Logout failed: ${n.statusText}`);localStorage.removeItem("userState"),sessionStorage.clear(),le.reset(),de.reset(),ce.reset(),ae.reset(),w.navigate("home"),m("You have been disconnected","popup")}catch(n){console.error("Logout error:",n),w.navigate("home")}})}function sn(){return`
	...
	<div id="dashboardSubmenu" class="submenu h-screen w-full top-0 bg-[#fbd11b] flex flex-col overflow-auto">
		${ge("backBtnDasboardSubmenu")}
		<div id="dashboard-container" class="flex-1"></div>
	</div>
	`}const Ee={currentUser:null,render(){return`
	...
	<div class="flex flex-col mt-auto items-center space-y-2 pb-6">
	 ...
	 `},init(){document.getElementById("loginBtn").addEventListener("click",()=>{w.navigate("login")}),document.getElementById("registerBtn").addEventListener("click",()=>{w.navigate("register")})}},Le={currentUser:null,isLogin:!0,render(){return`
	<img src="/pong-logo.png" alt="PONG Logo" class="h-auto w-auto pl-2 pr-2 pt-2"/>
...
winner is===`,i),s&&e.winner){s.innerHTML=`            
	...
	`}const se={currentUser:null,isLogin:!0,render(){return`
	...
	`},init(){yt()}},Ie={currentUser:null,isLogin:!0,render(){return`
  ...
  `,async init(){await O(),K("newPassword","togglePassword","eyeIconClosed","eyeIconOpened"),K("confirmPassword","toggleConfirmPassword","confirmEyeIconClosed","confirmEyeIconOpened"),mn(),document.body.insertAdjacentHTML("beforeend",pn()),fn(),document.getElementById("backToLogin").addEventListener("click",()=>{w.navigate("login")})}};function pn(){return`
