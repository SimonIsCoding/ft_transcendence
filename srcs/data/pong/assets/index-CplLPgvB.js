...
<div id="game-overlay" class="absolute inset-0 bg-black/80 flex-col items-center justify-center hidden z-50">
  ...
  `},async init(t){const e=document.getElementById(`othersUsersUsername_${t.id}`);e&&(e.textContent=t.login);const n=document.getElementById(`othersUsersPhoto_${t.id}`);t.profile_picture&&t.profile_picture.startsWith("https://lh3.googleusercontent.com")?await Q(n,t.profile_picture):n.src=`https://localhost:4443/${t.profile_picture}`;const s=document.getElementById(`addFriendBtn_${t.id}`),i=document.getElementById(`othersUsers_${t.id}_card`);s==null||s.addEventListener("click",async()=>{ee(i),N("Invitation sent",3500,"popup"),Dt(t)})}};function _t(){return`
	...
	`}function ee(t,e="duration-750"){if(!t)return;t.classList.remove("hidden","opacity-0"),t.classList.add("opacity-100","transition-opacity","duration-1000","ease-out"),t.offsetWidth,t.classList.remove("opacity-100"),t.classList.add("opacity-0"),setTimeout(()=>t.remove(),(e==="duration-1000"?1e3:300)+20)}async function Fe(t){var s;const e=document.getElementById("friendRequestDiv"),n=document.getElementById(`newRequestsFrom_${t.id}`);if(t)e==null||e.classList.remove("hidden"),n?await Z.init(t):((s=document.getElementById("friendRequestCard"))==null||s.insertAdjacentHTML("beforeend",Z.render(t)),await Z.init(t));else{e==null||e.classList.remove("hidden");const i=document.getElementById("friendRequest");i.textContent="No Friend Request"}}const oe=(()=>{let t=0;async function e(){const s=await Se();for(;t<s;){const i=await _e(t);await Fe(i),t++}}function n(){t=0}return{main:e,reset:n}})();async function Re(t){var s;const e=document.getElementById("friendsListDiv"),n=await At(t);e&&(e.classList.remove("hidden"),document.getElementById(`friendBox_${n.id}`)?await X.init(n):((s=document.getElementById("friendsCard"))==null||s.insertAdjacentHTML("beforeend",X.render(n)),await X.init(n)))}const ae=(()=>{let t=0;async function e(){const s=await Oe();for(;t<s;)Re(t),t++}function n(){t=0}return{main:e,reset:n}})(),re=(()=>{let t=0,e=0;async function n(){const i=document.getElementById("othersUsersDiv");i==null||i.classList.remove("hidden");const o=await Ct();if(o>1){let a=o-1>2?2:o-1;console.log(`max user is ${a}`);let r,d=[],m=0;for(;t<a;){if(r=await me(),r&&d.push(r),t>0)for(;r&&d[0].id===d[1].id;)d.pop(),r=await me(),r&&d.push(r),e>=o&&(r=null),e++;const u=document.getElementById("othersUsersCard"),p=document.getElementById("othersUsersP");if(r&&u){let f=`othersUsers_${r.id}_card`,E=r.id.toString();u.insertAdjacentHTML("beforeend",fe.render(f,E)),fe.init(r),p.textContent="Others Users",m++}else m==0&&(p.textContent="No others users to connect with");t++}}else{const a=document.getElementById("othersUsersP");a.textContent="You are the only player registered in the database. You can't connect with no one."}}function s(){t=0,e=0}return{main:n,reset:s}})();async function Ot(){oe.main(),ae.main(),re.main()}function Ft(t,e,n,s){const i=document.getElementById("backBtnFriendsSubmenu");i==null||i.addEventListener("click",()=>{F(t),U("profileSubmenu",t)}),e==null||e.classList.add("hidden"),n==null||n.classList.add("hidden"),s==null||s.classList.remove("hidden"),T("largeSubmenu"),T("friendsSubmenu"),Ot()}async function Rt(){oe.reset(),ae.reset(),re.reset(),ne.reset(),await fetch("/api/auth/me",{method:"DELETE",credentials:"include"})}function $t(){const t=document.getElementById("saveBtnEditProfile");t==null||t.addEventListener("click",()=>{It()}),Ht(),Gt(),Vt()}function Ht(){const t=document.getElementById("2FAtoggleSwitch"),e=t.querySelector("span");t.addEventListener("click",()=>{const s=!t.classList.contains("bg-green-500");$e(t,e,s)})}function Gt(){const t=document.getElementById("anonymousToggleSwitch"),e=t.querySelector("span");t.addEventListener("click",async()=>{const s=!t.classList.contains("bg-green-500");$e(t,e,s)})}function $e(t,e,n){n?(t.classList.remove("bg-gray-400"),t.classList.add("bg-green-500"),e.classList.add("translate-x-6")):(t.classList.remove("bg-green-500"),t.classList.add("bg-gray-400"),e.classList.remove("translate-x-6"))}function Vt(){const t=document.getElementById("eraseAccountBtn"),e=document.getElementById("confirmPopup");t==null||t.addEventListener("click",()=>{e==null||e.classList.remove("hidden")});const n=document.getElementById("popupNo");n==null||n.addEventListener("click",()=>{e==null||e.classList.add("hidden")});const s=document.getElementById("popupYes");s==null||s.addEventListener("click",async()=>{await Rt(),await R(),v.navigate("home"),N("You have been disconnected and your account has been deleted",3500,"popup")})}const jt=()=>B.iaDifficulty==="Easy"?1e3:B.iaDifficulty==="Medium"?100:1,B={iaDifficulty:"Easy",scoreLimit:"5"};function Ut(){const t=document.getElementById("iaDifficultySliderInput"),e=document.getElementById("iaDifficultyValue"),n=document.getElementById("scoreLimitSliderInput"),s=document.getElementById("scoreLimitValue");B.iaDifficulty=ye(parseInt(t.value)),e.textContent=B.iaDifficulty,B.scoreLimit=be(parseInt(n.value)),s.textContent=B.scoreLimit,t.addEventListener("input",i=>{const o=parseInt(i.target.value);B.iaDifficulty=ye(o),e.textContent=B.iaDifficulty}),n.addEventListener("input",i=>{const o=parseInt(i.target.value);B.scoreLimit=be(o),s.textContent=B.scoreLimit})}function be(t){return t==1?"3":t==2?"5":"11"}function ye(t){return t==1?"Easy":t==2?"Medium":"Hard"}function Nt(t){const e=document.getElementById("dashboard-container");if(e){if(e.innerHTML=`
  ...
  `}function U(t,e){e.forEach(n=>{n.id===t?(n.classList.toggle("max-h-0"),n.classList.toggle("max-h-screen")):(n.classList.add("max-h-0"),n.classList.remove("max-h-screen"))})}function T(t){const e=document.getElementById(t);e&&(e.classList.remove("max-h-0"),e.classList.add("max-h-screen"))}function F(t){t.forEach(e=>{e.classList.add("max-h-0"),e.classList.remove("max-h-screen")})}const Wt={username:"PlayerOne",stats:{won:12,lost:8,scores:230,friends:5},points:{scored:150,received:180}};function Yt(){Qt();const t=document.querySelectorAll(".submenu"),e=document.getElementById("friendsSubmenu"),n=document.getElementById("dashboardSubmenu"),s=document.getElementById("gameHistorySubmenu"),i=document.getElementById("DashboardBtn");i==null||i.addEventListener("click",()=>{e==null||e.classList.add("hidden"),s==null||s.classList.add("hidden"),n==null||n.classList.remove("hidden"),T("largeSubmenu"),T("dashboardSubmenu"),Nt(Wt);const d=document.getElementById("backBtnDasboardSubmenu");d==null||d.addEventListener("click",()=>{F(t),U("profileSubmenu",t)})});const o=document.getElementById("friendsListBtn");o==null||o.addEventListener("click",()=>{Ft(t,n,s,e)});const a=document.getElementById("gameHistoryBtn"),r=document.getElementById("backBtnGameHistorySubmenu");r==null||r.addEventListener("click",()=>{console.log("clicked"),F(t),U("profileSubmenu",t)}),a==null||a.addEventListener("click",()=>{n==null||n.classList.add("hidden"),e==null||e.classList.add("hidden"),s==null||s.classList.remove("hidden"),T("largeSubmenu"),T("gameHistorySubmenu"),ne.main()}),Zt(),$t()}function Zt(){const t=document.getElementById("profileSubmenu"),e=document.getElementById("editProfileSubmenu"),n=document.getElementById("profileSidebarBtn"),s=document.getElementById("editProfileBtn"),i=document.querySelectorAll(".submenu"),o=document.getElementById("backBtnEditProfileSubmenu");s==null||s.addEventListener("click",()=>{wt(),e==null||e.classList.add("max-h-screen"),e==null||e.classList.remove("max-h-0"),e==null||e.classList.remove("hidden"),o==null||o.addEventListener("click",()=>{e==null||e.classList.add("max-h-0"),e==null||e.classList.remove("max-h-screen")})}),n==null||n.addEventListener("click",()=>{const a=t==null?void 0:t.classList.contains("max-h-screen"),r=e==null?void 0:e.classList.contains("max-h-screen");a||r?i.forEach(d=>{d.classList.remove("max-h-screen"),d.classList.add("max-h-0")}):(U("profileSubmenu",i),e==null||e.classList.add("max-h-0"),e==null||e.classList.remove("max-h-screen"))})}function Xt(){const t=document.querySelectorAll(".submenu"),e=document.getElementById("settingsSidebarBtn"),n=document.getElementById("largeSubmenu"),s=document.getElementById("settingsSubmenu");e==null||e.addEventListener("click",()=>{s!=null&&s.classList.contains("max-h-screen")?(n==null||n.classList.add("max-h-0"),n==null||n.classList.remove("max-h-screen"),s.classList.add("max-h-0"),s.classList.remove("max-h-screen")):(F(t),T("largeSubmenu"),T("settingsSubmenu"))})}function Jt(){bt(),Yt(),Xt(),Ut()}async function Kt(){const e=await(await fetch("/api/auth/me/status",{method:"GET",credentials:"include"})).json();return console.log("data.authenticated = ",e.authenticated),e.authenticated===!0}async function Qt(){const e=await(await fetch("/api/auth/me",{method:"GET",credentials:"include"})).json();q(e.user);const n=document.getElementById("profileName");n&&(n.textContent=e.user.login||"Profile Name");const s=document.getElementById("mailInProfileSubmenu");s&&(s.textContent=e.user.mail||"contact@mail.com");const i=document.getElementById("playerNameDashboard");i&&(i.textContent=e.user.login||"Username")}function en(){const t=document.getElementById("logoutSidebarBtn");if(!t){console.error("Logout button not found");return}t.addEventListener("click",async e=>{e.preventDefault();try{const n=await fetch("/api/auth/me/sessions",{method:"DELETE",credentials:"include"});if(!n.ok)throw new Error(`Logout failed: ${n.statusText}`);localStorage.removeItem("userState"),sessionStorage.clear(),oe.reset(),ae.reset(),re.reset(),ne.reset(),v.navigate("home"),h("You have been disconnected","popup")}catch(n){console.error("Logout error:",n),v.navigate("home")}})}function tn(){return`
	...
	${nn()}
  `},init(){Jt();const t=document.getElementById("tournamentBtn");t==null||t.addEventListener("click",()=>{v.navigate("tournament")})}};async function R(){const t=await Kt(),e=document.getElementById("sidebar");t?(console.log("✅ Connected"),e.innerHTML=xe.render(),xe.init(),en(),Tt(),St()):(e.innerHTML=we.render(),we.init(),console.log("❌ Not connected"))}class ce{render(){return`
...
winner is===`,i),s&&e.winner){s.innerHTML=`            
	...
	`}const rn={currentUser:null,isLogin:!0,render(){return`
	...
	`}const dn={currentUser:null,isLogin:!0,render(){return`
	...
	`},init(){ft()}},Le={currentUser:null,isLogin:!0,render(){return`
  ...
  `,async init(){await R(),J("newPassword","togglePassword","eyeIconClosed","eyeIconOpened"),J("confirmPassword","toggleConfirmPassword","confirmEyeIconClosed","confirmEyeIconOpened"),hn(),document.body.insertAdjacentHTML("beforeend",pn()),fn(),document.getElementById("backToLogin").addEventListener("click",()=>{v.navigate("login")})}};function pn(){return`
