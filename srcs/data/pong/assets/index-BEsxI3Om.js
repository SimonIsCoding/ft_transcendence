var A=Object.defineProperty;var T=(i,e,t)=>e in i?A(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var a=(i,e,t)=>T(i,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function t(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(n){if(n.ep)return;n.ep=!0;const o=t(n);fetch(n.href,o)}})();const x="https://localhost:4443/api/auth",g=class g{constructor(){a(this,"listeners",[])}static getInstance(){return g.instance||(g.instance=new g),g.instance}getCurrentUser(){const e=localStorage.getItem("user");return e?JSON.parse(e):null}async login(e,t,s){var n,o,c;try{const d=await fetch(`${x}/login`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e,password:t})}),r=await d.json();if(!d.ok||r.status!=="success")throw new Error(r.error||r.message||"Login failed");if(!((o=(n=r.data)==null?void 0:n.user)!=null&&o.email)||!((c=r.data)!=null&&c.token))throw new Error("Invalid server response format");const h={email:r.data.user.email,token:r.data.token,alias:s||r.data.user.alias||r.data.user.email.split("@")[0]};return this.saveUser(h),h}catch(d){throw console.error("Login error:",d),new Error(d instanceof Error?d.message:"An unknown error occurred")}}async register(e,t,s){var n,o,c;try{const d=await fetch(`${x}/register`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:e,password:t,...s&&{alias:s}})}),r=await d.json();if(!d.ok||r.status!=="success")throw new Error(r.error||r.message||"Registration failed");if(!((o=(n=r.data)==null?void 0:n.user)!=null&&o.email)||!((c=r.data)!=null&&c.token))throw new Error("Invalid server response format");const h={email:r.data.user.email,token:r.data.token,alias:s||r.data.user.alias||r.data.user.email.split("@")[0]};return this.saveUser(h),h}catch(d){throw console.error("Registration error:",d),new Error(d instanceof Error?d.message:"Registration failed")}}logout(){localStorage.removeItem("user"),this.notifyListeners()}updateAlias(e){const t=this.getCurrentUser();t&&(t.alias=e,this.saveUser(t))}onAuthStateChanged(e){this.listeners.push(e)}saveUser(e){localStorage.setItem("user",JSON.stringify(e)),this.notifyListeners()}notifyListeners(){this.listeners.forEach(e=>e())}};a(g,"instance");let v=g;const u=v.getInstance(),b={render(){const i=u.getCurrentUser();return i?this.renderProfile(i.email):this.renderAuthSelector()},renderAuthSelector(){return`
    ...
    `}}const m=new M,f={renderGameCanvas:()=>m.render(),initGameCanvas:()=>m.init(),stop:()=>m.stop(),setBallSpeed:i=>m.setBallSpeed(i),handleKeyDown:i=>m.setKey(i,!0),handleKeyUp:i=>m.setKey(i,!1)},P={renderGameSettings(){return`
      <div class="space-y-4 p-4">
    ...
    `},initSettings(){const i=document.getElementById("ball-speed");i&&i.addEventListener("input",()=>{const e=parseFloat(i.value);f.setBallSpeed(e)})}},_={init(){window.addEventListener("keydown",i=>{["ArrowUp","ArrowDown","w","s"].includes(i.key)&&i.preventDefault(),f.handleKeyDown(i.key)}),window.addEventListener("keyup",i=>{["ArrowUp","ArrowDown","w","s"].includes(i.key)&&i.preventDefault(),f.handleKeyUp(i.key)})}};class W{constructor(){a(this,"isLoginView",!0)}init(){this.render(),this.bindAuthEvents()}render(){const e=document.getElementById("auth-container");if(e){const t=u.getCurrentUser();e.innerHTML=t?b.renderProfile(t.email):b.renderAuthForm(this.isLoginView)}}bindAuthEvents(){document.addEventListener("click",e=>{const t=e.target;t.closest("#login-btn")?(this.isLoginView=!0,this.render()):t.closest("#register-btn")?(this.isLoginView=!1,this.render()):t.closest("#logout-btn")?(u.logout(),this.isLoginView=!0,this.render()):t.closest("#toggle-auth")&&(this.isLoginView=!this.isLoginView,this.render())}),document.addEventListener("submit",async e=>{e.target.id==="auth-form"&&(e.preventDefault(),await this.handleAuthFormSubmit())})}async handleAuthFormSubmit(){const e=document.getElementById("email"),t=document.getElementById("password"),s=document.getElementById("auth-error");if(!e||!t||!s)return;const n=e.value,o=t.value;try{this.isLoginView?await u.login(n,o):await u.register(n,o),this.render()}catch(c){s.textContent=c.message}}}const F=new W,S={currentUser:null,isLogin:!0,render(){return`
    ...
    `},renderAuth(){const i=u.getCurrentUser();return i?b.renderProfile(i.email):b.renderAuthForm(this.isLogin)},init(){this.currentUser=u.getCurrentUser(),f.initGameCanvas(),_.init(),F.init(),P.initSettings(),u.onAuthStateChanged(()=>{this.currentUser=u.getCurrentUser(),document.getElementById("auth-container").innerHTML=this.renderAuth()})}};class U{constructor(){a(this,"currentUser",null);this.initializeUser()}initializeUser(){const e=localStorage.getItem("authToken"),t=localStorage.getItem("userEmail");e&&t?this.currentUser={email:t,token:e}:y.navigate("home")}render(){var e;return`
