...
<div id="game-overlay" class="absolute inset-0 bg-black/80 flex-col items-center justify-center hidden z-50">
  ...
  `},async init(t){const e=document.getElementById(`othersUsersUsername_${t.id}`);e&&(e.textContent=t.login);const n=document.getElementById(`othersUsersPhoto_${t.id}`);t.profile_picture&&t.profile_picture.startsWith("https://lh3.googleusercontent.com")?await Q(n,t.profile_picture):n.src=`https://localhost:4443/${t.profile_picture}`;const s=document.getElementById(`addFriendBtn_${t.id}`),i=document.getElementById(`othersUsers_${t.id}_card`);s==null||s.addEventListener("click",async()=>{ee(i),q("Invitation sent",3500,"popup"),Tt(t)})}};function Ft(){return`
	...
	<div class="flex flex-col mt-auto items-center space-y-2 pb-6">
	 ...
	 `},init(){T(null),document.getElementById("loginBtn").addEventListener("click",()=>{v.navigate("login")}),document.getElementById("registerBtn").addEventListener("click",()=>{v.navigate("register")})}},ye={isLogin:!0,render(){return`
	<img src="/pong-logo.png" alt="PONG Logo" class="h-auto w-auto pl-2 pr-2 pt-2"/>
	...
	${Ut()}
  `},init(){sn();const t=document.getElementById("tournamentBtn");t==null||t.addEventListener("click",()=>{v.navigate("tournament")});const e=document.getElementById("oneVsOneBtn");e==null||e.addEventListener("click",()=>{y.inGame=!0,v.navigate("game")});const n=document.getElementById("oneVsAIBtn");n==null||n.addEventListener("click",()=>{y.inGame=!0,v.navigate("gameai")})}};async function H(){const t=await it(),e=document.getElementById("sidebar");t?(e.innerHTML=ye.render(),ye.init(),Vt(),_t(),Ot()):(e.innerHTML=be.render(),be.init())}function zt(){const t=document.getElementById("saveBtnEditProfile");t==null||t.addEventListener("click",()=>{Ct()}),Wt(),Yt(),Zt()}function Wt(){const t=document.getElementById("2FAtoggleSwitch"),e=t.querySelector("span");t.addEventListener("click",()=>{const s=!t.classList.contains("bg-green-500");Re(t,e,s)})}function Yt(){const t=document.getElementById("anonymousToggleSwitch"),e=t.querySelector("span");t.addEventListener("click",async()=>{const s=!t.classList.contains("bg-green-500");Re(t,e,s)})}function Re(t,e,n){n?(t.classList.remove("bg-gray-400"),t.classList.add("bg-green-500"),e.classList.add("translate-x-6")):(t.classList.remove("bg-green-500"),t.classList.add("bg-gray-400"),e.classList.remove("translate-x-6"))}function Zt(){const t=document.getElementById("eraseAccountBtn"),e=document.getElementById("confirmPopup");t==null||t.addEventListener("click",()=>{e==null||e.classList.remove("hidden")});const n=document.getElementById("popupNo");n==null||n.addEventListener("click",()=>{e==null||e.classList.add("hidden")});const s=document.getElementById("popupYes");s==null||s.addEventListener("click",async()=>{await Gt(),await H(),v.navigate("home"),q("You have been disconnected and your account has been deleted",3500,"popup")})}function Xt(t){const e=document.getElementById("dashboard-container");if(e){if(e.innerHTML=`
  ...
  `}async function Ge(t,e){var n;t=="p-vs-ai"&&e.player1.alias==""&&(e.player1.alias=e.player2.alias,e.player2.alias="AI");try{fetch("/api/games/matches",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({player1:e.player1.alias,player2:e.player2.alias,scorePlayer1:e.player1.score??0,scorePlayer2:e.player2.score??0,winner:(n=e.winner)==null?void 0:n.alias,gameMode:t})})}catch(s){console.error("Game Fetch error:",s),m("Error with storing the game in historial.","popup"),v.navigate("home")}}async function Ve(){try{const t=await fetch("/api/games/nbMatchesPlayed",{credentials:"include"}).then(n=>n.json());return{count:t.length,data:t}}catch(t){console.error("gameCurrentUserHasPlayedService error:",t),m("Error with storing the game in historial.","popup"),v.navigate("home")}}const re=(()=>{let t=[];async function e(){const s=await Ve();t=(s==null?void 0:s.data)??[];const i=document.getElementById("gameHistoryContainer");i&&(i.innerHTML=t.map(a=>on(a)).join(""))}function n(){const s=document.getElementById("gameHistoryContainer");s&&(s.innerHTML=""),t=[]}return{main:e,reset:n}})(),g=class g{renderGameCanvas(){console.log("render 1");let e=document.getElementById("gamesArea"),n=document.getElementById("oneVsOneArea"),s=document.getElementById("oneVsAIArea");const i=new N().render();e&&(console.log("render 2"),e.innerHTML=i,s==null||s.classList.add("hidden"),n==null||n.classList.add("hidden"),e.classList.remove("hidden"))}async initGame(e){await g.cleanup();const n=document.getElementById("gameArea");n==null||n.classList.add("hidden"),g.noWinner=!0,await this.playGame(e)}showWinner(e,n){const s=document.getElementById("gamesArea");let i=e.winner?e.winner.alias:"";if(g.gameType==="p-vs-ai"&&n&&(i="ChatGPT"),s&&e.winner){s.innerHTML=`            
	...
	`},async init(){const t=document.getElementById("playBtn");t==null||t.addEventListener("click",()=>{y.gameType="p-vs-p",y.inGame=!0,v.navigate("game")})}},xe={currentUser:null,isLogin:!0,render(){return`
  ...
  `},async init(){await H(),we.init()}};async function rn(){if((await fetch("/api/auth/me/status",{credentials:"include"}).then(n=>n.json())).authenticated){v.navigate("home"),m("You are already connected. You can't access the login page.","popup");return}const e=document.getElementById("connectionBtn");e.addEventListener("click",async()=>{const n=document.getElementById("login").value.trim(),s=document.getElementById("password").value;e.disabled=!0;try{const i=await fetch("/api/auth/users/check",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({login:n,password:s}),credentials:"include"}),a=await i.json();if(!i.ok||a.success===!1){m(a.error||"Login failed","popup");return}if(a.requires2FA){const o=document.getElementById("loginCredentials"),r=document.getElementById("twofa-container");if(o&&r&&(r.innerHTML="",o.classList.add("hidden"),r.classList.remove("hidden"),r.querySelector("*")===null)){const p=new ne(a.mail,async()=>{o.classList.add("hidden"),r.classList.add("hidden"),te(a.login,a.userId)},r,(u,f)=>{m(u,"popup"),f&&(document.cookie="auth_phase=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;",document.cookie="auth_token=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;",sessionStorage.setItem("loginError",u),document.getElementById("password").value="",o&&o.classList.remove("hidden"),r&&r.classList.add("hidden"))}).init();r.appendChild(p)}}else te(n,a.userId)}catch{m("Network error during login","popup")}finally{e.disabled=!1}})}async function te(t,e){try{if(!(await fetch("/api/auth/users/sessions",{method:"POST",credentials:"include",headers:{"Content-Type":"application/json"},body:JSON.stringify({userId:e})})).ok)throw new Error("Token generation failed");localStorage.setItem("login",t),U("login_initiated",{login_id:"login-"+Date.now(),player_username:t}),v.navigate("home"),q("You are logged in",3500,"popup")}catch{m("Login complete but couldn't load session","popup"),v.navigate("home")}}const Ee={render:()=>`
  	<div class="w-screen h-screen flex bg-[#fbd11b] overflow-hidden">
  ...
  `},async init(){await H();const t=z();if(console.log(t),!t){v.navigate("home"),m("Not logged. You can't access this game.","popup");return}const e=document.getElementById("tournamentArea"),n=document.getElementById("esquemaTorneo");let s=document.getElementById("gameCanvasContainer");if(!s&&(e!=null&&e.parentNode)&&(console.log("t view 2"),s=document.createElement("div"),s.id="gameCanvasContainer",s.className="hidden content bg-[#fbd11b] h-full",e.appendChild(s)),s&&F&&F.partidoActivo){console.log("t view 3");const i=document.getElementById("gameArea");i==null||i.classList.add("hidden");const a=new N().render();s.innerHTML=a}e==null||e.classList.remove("hidden"),n==null||n.classList.remove("hidden"),he.init()}};function je(){return`
	...
	`}const Be={currentUser:null,isLogin:!0,render(){return`
