	...
	<main id="loginArea" 
      ...
      style="background-image: url('/pongBackgroundPlay.png');">
		...
		<div id="loginCredentials" class="flex flex-col justify-center items-center w-full space-y-10">
			...
			<div class="relative">
				<input id="password" type="password" placeholder="Password" class="w-80 inline-block text-white font-bold text-lg border border-[#fbd11b] rounded-lg p-2.75 pr-10" />
